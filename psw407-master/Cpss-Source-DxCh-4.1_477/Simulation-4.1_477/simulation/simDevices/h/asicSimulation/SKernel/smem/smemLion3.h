...
*
* DESCRIPTION:
*       Lion3 memory mapping implementation: the pipe and the shared memory
*
* DEPENDENCIES:
*       None.
*
...
*
* DESCRIPTION:
*       Init memory module for Lion3 and above devices.
*
* INPUTS:
...
*
* DESCRIPTION:
*       Init memory module for a Lion3 device.
*
* INPUTS:
...
#define SMEM_LION3_TTI_DEFAULT_EPORT_ENTRY_FIELD_GET(_devObjPtr,_descrPtr,fieldName)       \
    snetFieldFromEntry_GT_U32_Get(_devObjPtr,                               \
        _descrPtr->eArchExtInfo.ttiPreTtiLookupIngressEPortTablePtr,        \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_TTI_DEFAULT_EPORT_E].formatNamePtr, \
        _descrPtr->eArchExtInfo.defaultSrcEPort,/* the default eport */    \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_TTI_DEFAULT_EPORT_E].fieldsInfoPtr, \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_TTI_DEFAULT_EPORT_E].fieldsNamePtr, \
        fieldName)
...
#define SMEM_LION3_TTI_PHYSICAL_PORT_ENTRY_FIELD_GET(_devObjPtr,_descrPtr,fieldName)       \
    snetFieldFromEntry_GT_U32_Get(_devObjPtr,                               \
        _descrPtr->eArchExtInfo.ttiPhysicalPortAttributePtr,                \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_TTI_PHYSICAL_PORT_ATTRIBUTE_E].formatNamePtr,                         \
        _descrPtr->localDevSrcPort,/* the physical port */    \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_TTI_PHYSICAL_PORT_ATTRIBUTE_E].fieldsInfoPtr,  \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_TTI_PHYSICAL_PORT_ATTRIBUTE_E].fieldsNamePtr, \
        fieldName)
...
/* macro to shorten the calling code of 'physical port' table fields */
#define SMEM_SIP5_20_TTI_PHYSICAL_PORT_ENTRY_FIELD_GET(_devObjPtr,_descrPtr,fieldName)       \
    snetFieldFromEntry_GT_U32_Get(_devObjPtr,                                \
        _descrPtr->eArchExtInfo.ttiPhysicalPort2AttributePtr,                \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_TTI_PHYSICAL_PORT_2_ATTRIBUTE_E].formatNamePtr, \
        _descrPtr->localDevSrcPort,/* the physical port */    \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_TTI_PHYSICAL_PORT_2_ATTRIBUTE_E].fieldsInfoPtr,  \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_TTI_PHYSICAL_PORT_2_ATTRIBUTE_E].fieldsNamePtr, \
        fieldName)
...
#define SMEM_LION3_TTI_ACTION_ENTRY_FIELD_GET(_devObjPtr,_actionEntryDataPtr,_tableName,_matchIndex,fieldName)       \
    snetFieldFromEntry_GT_U32_Get(_devObjPtr,        \
        _actionEntryDataPtr,                         \
        _tableName,                                  \
        _matchIndex,                                 \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_TTI_ACTION_E].fieldsInfoPtr, \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_TTI_ACTION_E].fieldsNamePtr, \
        fieldName)
...
#define SMEM_LION3_TTI_DEFAULT_PORT_PROTOCOL_EVLAN_AND_QOS_CONFIGURATION_ENTRY_FIELD_GET(_devObjPtr,_descrPtr,fieldName)       \
    snetFieldFromEntry_GT_U32_Get(_devObjPtr,                               \
        _descrPtr->perProtocolInfo.portProtMatchedMemoryPointer,        \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_VLAN_PORT_PROTOCOL_E].formatNamePtr,                         \
        _descrPtr->eArchExtInfo.defaultSrcEPort,/* the default eport */    \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_VLAN_PORT_PROTOCOL_E].fieldsInfoPtr, \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_VLAN_PORT_PROTOCOL_E].fieldsNamePtr, \
        fieldName)
...
#define SMEM_LION3_TTI_EPORT_ATTRIBUTES_ENTRY_FIELD_GET(_devObjPtr,_descrPtr,fieldName)       \
    snetFieldFromEntry_GT_U32_Get(_devObjPtr,                               \
        _descrPtr->eArchExtInfo.ttiPostTtiLookupIngressEPortTablePtr,       \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_TTI_EPORT_ATTRIBUTES_E].formatNamePtr,                      \
        _descrPtr->eArchExtInfo.localDevSrcEPort,/* the eport */            \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_TTI_EPORT_ATTRIBUTES_E].fieldsInfoPtr,\
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_TTI_EPORT_ATTRIBUTES_E].fieldsNamePtr, \
        fieldName)
...
#define SMEM_LION3_L2I_INGRESS_VLAN_ENTRY_FIELD_GET(_devObjPtr,_descrPtr,_entryPtr,_eVid,fieldName)       \
    snetFieldFromEntry_GT_U32_Get(_devObjPtr,                           \
        _entryPtr,                                                      \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_BRIDGE_INGRESS_EVLAN_E].formatNamePtr,                      \
        _eVid,/* the eVid */                                            \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_BRIDGE_INGRESS_EVLAN_E].fieldsInfoPtr, \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_BRIDGE_INGRESS_EVLAN_E].fieldsNamePtr, \
        fieldName)
...
#define SMEM_LION3_L2I_EPORT_ENTRY_FIELD_GET(_devObjPtr,_descrPtr,fieldName)       \
    snetFieldFromEntry_GT_U32_Get(_devObjPtr,                           \
        _descrPtr->eArchExtInfo.bridgeIngressEPortTablePtr,             \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_BRIDGE_INGRESS_EPORT_E].formatNamePtr,                            \
        _descrPtr->eArchExtInfo.localDevSrcEPort,/* the eport */        \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_BRIDGE_INGRESS_EPORT_E].fieldsInfoPtr, \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_BRIDGE_INGRESS_EPORT_E].fieldsNamePtr,   \
        fieldName)
...
#define SMEM_LION3_L2_MLL_ENTRY_FIELD_GET(_devObjPtr,_memPtr,_index,fieldName)       \
    snetFieldFromEntry_GT_U32_Get(_devObjPtr,                               \
        _memPtr,                                                            \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_L2_MLL_E].formatNamePtr, \
        _index,                                                             \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_L2_MLL_E].fieldsInfoPtr, \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_L2_MLL_E].fieldsNamePtr,  \
        fieldName)
...
#define SMEM_LION3_IP_MLL_ENTRY_FIELD_GET(_devObjPtr,_memPtr,_index,fieldName)       \
    snetFieldFromEntry_GT_U32_Get(_devObjPtr,                               \
        _memPtr,                                                            \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_IP_MLL_E].formatNamePtr,  \
        _index,                                                             \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_IP_MLL_E].fieldsInfoPtr, \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_IP_MLL_E].fieldsNamePtr, \
        fieldName)
...
#define SMEM_LION3_PLR_METERING_ENTRY_FIELD_GET(_devObjPtr,_memPtr,_index,fieldName)       \
    snetFieldFromEntry_GT_U32_Get(_devObjPtr,                               \
        _memPtr,                                                            \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_PLR_METERING_E].formatNamePtr, \
        _index,                                                             \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_PLR_METERING_E].fieldsInfoPtr, \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_PLR_METERING_E].fieldsNamePtr, \
        fieldName)
...
#define SMEM_SIP5_15_PLR_METERING_CONFIG_ENTRY_FIELD_GET(_devObjPtr,_memPtr,_index,fieldName)       \
    snetFieldFromEntry_GT_U32_Get(_devObjPtr,                               \
        _memPtr,                                                            \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_PLR_METERING_CONFIG_E].formatNamePtr, \
        _index,                                                             \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_PLR_METERING_CONFIG_E].fieldsInfoPtr, \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_PLR_METERING_CONFIG_E].fieldsNamePtr, \
        fieldName)
...
#define SMEM_LION3_PLR_E_ATTRIBUTES_ENTRY_FIELD_GET(_devObjPtr,_memPtr,_index,fieldName)       \
    snetFieldFromEntry_GT_U32_Get(_devObjPtr,                               \
        _memPtr,                                                            \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_PLR_E_ATTRIBUTES_E].formatNamePtr,                          \
        _index,                                                             \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_PLR_E_ATTRIBUTES_E].fieldsInfoPtr, \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_PLR_E_ATTRIBUTES_E].fieldsNamePtr, \
        fieldName)
...
#define SMEM_LION3_PLR_HIERARCHIAL_ENTRY_FIELD_GET(_devObjPtr,_memPtr,_index,fieldName)       \
    snetFieldFromEntry_GT_U32_Get(_devObjPtr,                               \
        _memPtr,                                                            \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_PLR_HIERARCHICAL_E].formatNamePtr,                          \
        _index,                                                             \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_PLR_HIERARCHICAL_E].fieldsInfoPtr, \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_PLR_HIERARCHICAL_E].fieldsNamePtr, \
        fieldName)
...
#define SMEM_LION3_HA_PHYSICAL_PORT_1_ENTRY_FIELD_GET(_devObjPtr,_memPtr,_index,fieldName) \
    snetFieldFromEntry_GT_U32_Get(_devObjPtr,                                       \
        _memPtr,                                                                    \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_HA_PHYSICAL_PORT_1_E].formatNamePtr,                                 \
        _index,/* the physical port */                                              \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_HA_PHYSICAL_PORT_1_E].fieldsInfoPtr, \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_HA_PHYSICAL_PORT_1_E].fieldsNamePtr, \
        fieldName)
...
#define SMEM_LION3_HA_PHYSICAL_PORT_2_ENTRY_FIELD_GET(_devObjPtr,_memPtr,_index,fieldName) \
    snetFieldFromEntry_GT_U32_Get(_devObjPtr,                                       \
        _memPtr,                                                                    \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_HA_PHYSICAL_PORT_2_E].formatNamePtr,                                 \
        _index,/* the physical port */                                              \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_HA_PHYSICAL_PORT_2_E].fieldsInfoPtr, \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_HA_PHYSICAL_PORT_2_E].fieldsNamePtr, \
        fieldName)
...
#define SMEM_LION3_HA_EPORT_1_ENTRY_FIELD_GET(_devObjPtr,_memPtr,_index,fieldName)  \
    snetFieldFromEntry_GT_U32_Get(_devObjPtr,                                       \
        _memPtr,                                                                    \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_HA_EGRESS_EPORT_1_E].formatNamePtr,                                        \
        _index,/* the eport */                                                      \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_HA_EGRESS_EPORT_1_E].fieldsInfoPtr, \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_HA_EGRESS_EPORT_1_E].fieldsNamePtr,               \
        fieldName)
...
#define SMEM_LION3_HA_EPORT_2_ENTRY_FIELD_GET(_devObjPtr,_memPtr,_index,fieldName)  \
    snetFieldFromEntry_GT_U32_Get(_devObjPtr,                                       \
        _memPtr,                                                                    \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_HA_EGRESS_EPORT_2_E].formatNamePtr,                                        \
        _index,/* the eport */                                                      \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_HA_EGRESS_EPORT_2_E].fieldsInfoPtr, \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_HA_EGRESS_EPORT_2_E].fieldsNamePtr,               \
        fieldName)
...
#define SMEM_LION3_HA_GENERIC_TS_PROFILE_FIELD_GET(_devObjPtr,_memPtr,_profile,fieldName)  \
    snetFieldFromEntry_GT_U32_Get(_devObjPtr,                                       \
        _memPtr,                                                                    \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_HA_GENERIC_TS_PROFILE_E].formatNamePtr,                              \
        _profile,/* the TS profile pointer */                                       \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_HA_GENERIC_TS_PROFILE_E].fieldsInfoPtr, \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_HA_GENERIC_TS_PROFILE_E].fieldsNamePtr, \
        fieldName)
...
#define SMEM_SIP5_IPVX_NEXT_HOP_FIELD_GET(_devObjPtr,_memPtr,_index,fieldName)  \
    snetFieldFromEntry_GT_U32_Get(_devObjPtr,                                       \
        _memPtr,                                                                    \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_IPVX_ROUTER_NEXT_HOP_E].formatNamePtr, \
        _index,/* the Next Hop index */                                       \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_IPVX_ROUTER_NEXT_HOP_E].fieldsInfoPtr, \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_IPVX_ROUTER_NEXT_HOP_E].fieldsNamePtr, \
        fieldName)
...
#define SMEM_SIP5_20_EGF_QAG_PORT_TARGET_FIELD_GET(_devObjPtr,_memPtr,_index,fieldName)  \
    snetFieldFromEntry_GT_U32_Get(_devObjPtr,                                       \
        _memPtr,                                                                    \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_EGF_QAG_PORT_TARGET_ATTRIBUTES_E].formatNamePtr, \
        _index,/* the target physical port (0..511)*/                                \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_EGF_QAG_PORT_TARGET_ATTRIBUTES_E].fieldsInfoPtr, \
        _devObjPtr->tableFormatInfo[SKERNEL_TABLE_FORMAT_EGF_QAG_PORT_TARGET_ATTRIBUTES_E].fieldsNamePtr, \
        fieldName)
