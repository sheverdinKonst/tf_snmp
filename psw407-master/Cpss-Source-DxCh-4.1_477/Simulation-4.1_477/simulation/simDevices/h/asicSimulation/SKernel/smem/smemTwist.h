...
#define TWIST_SFLOW_FIFO_SIZE       32
/***********************************************************************
...
***********************************************************************/
/*
 * Typedef: struct TWIST_GLOBAL_MEM
 *
 * Description:
...
/*
 * Typedef: struct TWIST_BRDG_MNG_MEM
 *
 * Description:
...
/*
 * Typedef: struct TWIST_LX_UNIT_MEM
 *
 * Description:
 *      LX unit Registers.
 *
...
/*
 * Typedef: struct TWIST_BUF_MNG_MEM
 * Description:
...
typedef struct {
    ...
    GT_U32                  sflowFifo[TWIST_SFLOW_FIFO_SIZE];
}TWIST_MAC_MEM;

/*
 * Typedef: struct TWIST_MAC_FDB_MEM
 *
 * Description:
...
/*
 * Typedef: struct TWIST_VLAN_TBL_MEM
 *
 * Description:
 *      Describe a device's Bridge registers and FDB.
 *
...
/*
 * Typedef: struct TWIST_WSRAM_MEM
 *
 * Description:
...
/*
 * Typedef: enum TWIST_NARROW_SRAM_ENT
 *
...
typedef enum
{
    TWIST_NSRAM_ONE_FOUR_INTERNAL_E = 0,
    TWIST_NSRAM_ALL_EXTERNAL_E = 1,
    TWIST_NSRAM_ONE_TWO_INTERNAL_E = 2,
    TWIST_NSRAM_THREE_FOUR_INTERNAL_E = 3,
    TWIST_NSRAM_ALL_INTERNAL_E = 6
}TWIST_NSRAM_MODE_ENT;
...
typedef enum
{
    TWIST_NSRAM_E = 0x30000000,
    TWIST_NSRAM_INTERNAL_0_E = 0x20000000,
    TWIST_NSRAM_INTERNAL_1_E = 0x28000000,
    TWIST_NSRAM_EXTERNAL_0_E = 0x30000000,
    TWIST_NSRAM_EXTERNAL_1_E = 0x38000000
}SMEM_NSRAM_BASE_ADDR_ENT;


/*
 * Typedef: struct TWIST_NSRAM_MEM
 *
 * Description:
...
/*
 * Typedef: struct TWIST_FDRAM_MEM
 *
 * Description:
...
/*
 * Typedef: struct TWIST_DEV_MEM_INFO
 *
 * Description:
...
typedef struct {
    ...
    TWIST_GLOBAL_MEM            globalMem;
    TWIST_BUF_MNG_MEM           bufMngMem;
    TWIST_MAC_MEM               macMem;
    TWIST_PORT_MEM              portMem;
    TWIST_BRDG_MNG_MEM          bridgeMngMem;
    TWIST_EGR_MEM               egressMem;
    TWIST_LX_UNIT_MEM           lxMem;
    TWIST_MAC_FDB_MEM           macFbdMem;
    TWIST_VLAN_TBL_MEM          vlanTblMem;
    /* External memory */
    TWIST_WSRAM_MEM             wsramMem;
    TWIST_FDRAM_MEM             fdramMem;

    /* Narrow srams */
    TWIST_NSRAM_MEM             nsramsMem[4];

    /* Address Update messages */
    TWIST_AUQ_MEM               auqMem;
    /* PCI registers */
    TWIST_PCI_MEM               pciMem;
    /* PHY related registers */
    TWIST_PHY_MEM               phyMem;
}TWIST_DEV_MEM_INFO;
