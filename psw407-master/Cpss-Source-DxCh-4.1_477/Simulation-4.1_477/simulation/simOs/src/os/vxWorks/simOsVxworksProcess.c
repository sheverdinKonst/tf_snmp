...
********************************************************************************
* simOsVxworksProcess.c
*
* DESCRIPTION:
*       vxWorks Operating System Simulation. Process facility implementation.
*
...
{
    FUNCTION_NOT_SUPPORTED(simOsSharedMemGet);
...
{
    FUNCTION_NOT_SUPPORTED(simOsSharedMemAttach);
...
{
    FUNCTION_NOT_SUPPORTED(simOsProcessIdGet);
...
{
    FUNCTION_NOT_SUPPORTED(simOsProcessNotify);
...
{
    FUNCTION_NOT_SUPPORTED(simOsProcessHandler);
