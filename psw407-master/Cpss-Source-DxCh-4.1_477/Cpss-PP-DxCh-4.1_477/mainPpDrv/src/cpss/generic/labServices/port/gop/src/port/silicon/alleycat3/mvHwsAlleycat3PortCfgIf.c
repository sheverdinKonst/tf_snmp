...
)
{
	...
	{
		return mvHwsAlleycat3PortRxAutoTuneSetExt(devNum, portGroup, phyPortNum, portMode,
								portMode, portTuningMode, results);
	}
	else
	{
		return mvHwsAlleycat3PortTxAutoTuneSetExt(devNum, portGroup, phyPortNum, portMode,
