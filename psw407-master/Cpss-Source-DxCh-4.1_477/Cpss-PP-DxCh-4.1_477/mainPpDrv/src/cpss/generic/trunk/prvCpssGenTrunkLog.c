...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TRUNK_MEMBER_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TRUNK_WEIGHTED_MEMBER_STC_PTR(contextLib, logType, namePtr, paramVal);
}
