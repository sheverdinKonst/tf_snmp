...
)
{
    ...
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, ports, CPSS_MAX_PORTS_BMP_NUM_CNS, GT_U32);
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_INTERFACE_INFO_STC_PTR(contextLib, logType, namePtr, &paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_GT_IPADDR_PTR(contextLib, logType, namePtr, &paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_PORTS_BMP_STC_PTR(contextLib, logType, namePtr, &paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_GT_ETHERADDR_PTR(contextLib, logType, namePtr, &paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_GT_IPV6ADDR_PTR(contextLib, logType, namePtr, &paramVal);
}
