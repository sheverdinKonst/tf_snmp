...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_PORT_TX_Q_TAIL_DROP_PROF_TC_PARAMS_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_PORT_ATTRIBUTES_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_PORT_MAC_COUNTER_SET_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_PORT_MODE_SPEED_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_PORT_MAC_STATUS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_PORT_EGRESS_CNTR_STC_PTR(contextLib, logType, namePtr, paramVal);
}
