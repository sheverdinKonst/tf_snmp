...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_BRG_SECUR_BREACH_MSG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_BRIDGE_INGRESS_CNTR_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_MAC_UPDATE_MSG_EXT_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_MAC_UPDATE_MSG_EXT_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_BRG_SECUR_BREACH_DROP_COUNT_CFG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_MAC_ENTRY_EXT_KEY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_MAC_ENTRY_EXT_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_PROT_CLASS_ENCAP_STC_PTR(contextLib, logType, namePtr, paramVal);
}
