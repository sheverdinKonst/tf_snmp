...
)
{
    ...
    {
        /* emulate Lion2 , as the HWservices not supports lion3 yet ... */
        isLion2 = GT_TRUE;
        /* due to the revision of this device we will be 'Lion2A0' */
    }
    else if(CPSS_PP_FAMILY_DXCH_LION2_E == devFamily)
    {
        isLion2 = GT_TRUE;
    }
    else
