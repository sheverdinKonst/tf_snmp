...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_LED_GROUP_CONF_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_LED_CLASS_MANIPULATION_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_LED_CONF_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_REG_VALUE_INFO_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_REG_VALUE_INFO_STC_PTR(contextLib, logType, namePtr, paramVal);
}
