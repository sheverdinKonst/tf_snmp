...
)
{
    ...
    core_params.wred_profile_ref = (uint8_t)qParamsPtr->dropProfileInd;
...
)
{
    ...
    core_params.wred_profile_ref = (uint8_t)aParamsPtr->dropProfileInd;
...
)
{
    ...
    core_params.wred_profile_ref = (uint8_t)bParamsPtr->dropProfileInd;
