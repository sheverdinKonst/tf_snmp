...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TM_A_NODE_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TM2TM_DELTA_RANGE_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    PRV_CPSS_LOG_ENUM_MAC(namePtr, *paramVal, CPSS_TM_SCHD_MODE_ENT);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TM_LIB_INIT_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TM_PORT_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TM_TREE_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TM2TM_CNTRL_PKT_STRUCT_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TM_QMR_PKT_STATISTICS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TM_QUEUE_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TM_TREE_CHANGE_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TM_RCB_PKT_STATISTICS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TM_SHAPING_PROFILE_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TM_B_NODE_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TM_ELIG_PRIO_FUNC_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TM_C_NODE_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TM_QUANTUM_LIMITS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TM_PORT_STATUS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TM_DROP_PROFILE_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TM2TM_EXTERNAL_HDR_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TM_NODE_STATUS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TM_LEVEL_PERIODIC_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_TM_PORT_DROP_PER_COS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
PRV_CPSS_LOG_FUNC_PARAM_STC IN_GT_U16_PTR_quantumArrPtr = {
     "quantumArrPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U16)
};
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChTmLogLibDb[] = {
    ...
    {"cpssTm2TmEgressDropAqmModeSet", 4, cpssTm2TmEgressDropAqmModeSet_PARAMS, NULL},
    ...
    {"cpssTmDropWredCurveCreate", 5, cpssTmDropWredCurveCreate_PARAMS, NULL},
    ...
    {"cpssTmDropProfileAgingBlockCreate", 3, cpssTmDropProfileAgingBlockCreate_PARAMS, NULL},
    ...
    {"cpssTmEligPrioFuncQueueConfig", 3, cpssTmEligPrioFuncQueueConfig_PARAMS, NULL},
    {"cpssTmEligPrioFuncNodeConfig", 4, cpssTmEligPrioFuncNodeConfig_PARAMS, NULL},
    {"cpssTmEligPrioFuncConfigAllLevels", 3, cpssTmEligPrioFuncConfigAllLevels_PARAMS, NULL},
    ...
    {"cpssTmTreeDwrrPrioSet", 2, cpssTmTreeDwrrPrioSet_PARAMS, NULL},
    ...
    {"cpssTmPortSchedulingUpdate", 5, cpssTmPortSchedulingUpdate_PARAMS, NULL},
