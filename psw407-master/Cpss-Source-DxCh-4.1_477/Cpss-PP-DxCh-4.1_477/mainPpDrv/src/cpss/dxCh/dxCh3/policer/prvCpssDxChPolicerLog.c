...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_POLICER_QOS_PARAM_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_POLICER_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_POLICER_TB_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_POLICER_TRIGGER_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_POLICER_BILLING_INDEX_CFG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_POLICER_COUNTERS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_POLICER_BUCKETS_STATE_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_POLICER_HIERARCHICAL_TABLE_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH3_POLICER_METERING_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH3_POLICER_METER_TB_PARAMS_UNT_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH3_POLICER_MNG_CNTR_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH3_POLICER_BILLING_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChPolicerLogLibDb[] = {
    ...
    {"cpssDxCh3PolicerMeteringEntrySet", 5, cpssDxCh3PolicerMeteringEntrySet_PARAMS, NULL},
    {"cpssDxCh3PolicerMeteringEntryGet", 4, cpssDxCh3PolicerMeteringEntryGet_PARAMS, NULL},
    {"cpssDxCh3PolicerEntryMeterParamsCalculate", 5, cpssDxCh3PolicerEntryMeterParamsCalculate_PARAMS, NULL},
    ...
    {"cpssDxChPolicerPortGroupMeteringEntrySet", 6, cpssDxChPolicerPortGroupMeteringEntrySet_PARAMS, NULL},
    ...
    {"cpssDxChPolicerMeteringEntryEnvelopeSet", 7, cpssDxChPolicerMeteringEntryEnvelopeSet_PARAMS, NULL},
    {"cpssDxChPolicerMeteringEntryEnvelopeGet", 7, cpssDxChPolicerMeteringEntryEnvelopeGet_PARAMS, NULL},
