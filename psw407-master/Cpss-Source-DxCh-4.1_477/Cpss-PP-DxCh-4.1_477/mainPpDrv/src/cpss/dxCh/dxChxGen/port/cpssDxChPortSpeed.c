...
static GT_STATUS bcat2SpeedSet
(
    IN  GT_U8                devNum,
    IN  GT_PHYSICAL_PORT_NUM portNum,
    IN  CPSS_PORT_SPEED_ENT  speed
...
)
{
    ...
    switch (speed)
    {
        ...
        default:
            ...
            if(rc != GT_OK)
                return rc;
            return GT_NOT_SUPPORTED; /* GT_BAD_PARAM; */
    }
        ...
        case QSGMII:
            {
                ...
                if ((value & 0x1) == 0)
                {
                    *speedPtr = ((value >> 1) == 1) ? CPSS_PORT_SPEED_100_E:
                        CPSS_PORT_SPEED_10_E;
                }
            }
...
)
{
    ...
    *speedPtr = CPSS_PORT_SPEED_NA_E;
    ...
    {
        PRV_CPSS_DXCH_PORT_STATUS_CTRL_REG_MAC(devNum,portMacMap,&regAddr);
    ...
    switch(PRV_CPSS_PP_MAC(devNum)->devFamily)
    {
        ...
        case CPSS_PP_FAMILY_DXCH_BOBCAT3_E:
            rc = prvCpssDxChLion2PortSpeedHwGet(devNum,portMacMap,speedPtr);
            break;
