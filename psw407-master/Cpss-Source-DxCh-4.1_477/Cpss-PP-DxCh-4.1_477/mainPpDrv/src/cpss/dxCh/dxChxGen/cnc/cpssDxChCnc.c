...
*                         different indexes.
*                         For Lion3 and Bobcat2 (APPLICABLE RANGES: 0..1K, 1K..2K-1,  ,63K..64K-1).
*
* OUTPUTS:
*       None.
*
...
*
* NOT APPLICABLE DEVICES:
*        DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; xCat3; Lion; xCat2; Lion2; Lion3, Bobcat3.
*
* INPUTS:
*       devNum             - device number
*       indexMode          - index calculation mode
