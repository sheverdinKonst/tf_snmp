...
/* Lion3, bobcat2 IPCL LOOKUP NOT IP */
...
/* Lion3, bobcat2 IPCL LOOKUP IPV4 */
...
/* Lion3, bobcat2 IPCL LOOKUP IPV6 */
...
/* Lion3, bobcat2 EPCL LOOKUP NOT IP */
...
/* Lion3, bobcat2 EPCL LOOKUP IPV4 */
...
/* Lion3, bobcat2 EPCL LOOKUP IPV6 */
...
*       For Bobcat2 and Lion3 that use INDEX interface type
...
)
{
    ...
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, bitPos, 1, &hwValue);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    rc = prvCpssDrvHwPpReadRegBitMask(
                        devNum, regAddr, ((1 << 8) | 1) /*mask*/, &hwValue);
    if(GT_OK != rc)
    {
        return rc;
...
)
{
    ...
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, bitNum, 2, &hwValue);
    if(GT_OK != rc)
    {
        return rc;
    }
...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, bitIndex, 1, hwValue);
}
...
)
{
    ...
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, bitIndex, 1, &hwValue);
    if(GT_OK != rc)
    {
        return rc;
    }
...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, bitNum, 1, data);
}
...
)
{
    ...
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, bitNum, 1, &data);
    if (rc != GT_OK)
    {
        return rc;
    }
    ...
    switch (udbOverrideType)
    {
        ...
        case CPSS_DXCH_PCL_UDB_OVERRIDE_TYPE_TAG1_INFO_E:
            ...
            *regAddrPtr =
            ...
            break;
        case CPSS_DXCH_PCL_UDB_OVERRIDE_TYPE_FLOW_ID_E:
            if (PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_ENABLED_MAC(devNum)
                == GT_FALSE)
            {
                return GT_BAD_PARAM;
...
)
{
    ...
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, bitOffset, 1, &hwData);
    if (rc == GT_OK)
    {
...
)
{
    ...
    regAddr =
        PRV_DXCH_REG1_UNIT_PCL_MAC(devNum).OAMConfigs.channelTypeOAMOpcode[channelTypeProfile];

    hwData = opcode;

    rc = prvCpssDrvHwPpSetRegField(devNum, regAddr, 0, 8, hwData);
    if (rc != GT_OK)
    {
        return rc;
    }
    ...
    rc = prvCpssDrvHwPpSetRegField(devNum, regAddr, channelTypeProfile, 1, hwData);
    if (rc != GT_OK)
    {
        return rc;
    }
    ...
    rc = prvCpssDrvHwPpSetRegField(devNum, regAddr, offset, 9, hwData);
...
)
{
    ...
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, offset, 9, &hwData);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    rc = prvCpssDrvHwPpSetRegField(devNum, regAddr, offset, 2, hwData);
...
)
{
    ...
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, offset, 2, &hwData);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, 0, 13, &hwData);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, 20, 1, hwData);
}
...
)
{
    ...
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, 20, 1, &hwData);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, 21, 1, hwData);
}
...
)
{
    ...
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, 21, 1, &hwData);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, 0, 12, mask);
}
...
)
{
    ...
    return prvCpssDrvHwPpGetRegField(devNum, regAddr, 0, 12, maskPtr);
}
...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, 12, 14, ipPayloadMinSize);
}
...
)
{
    ...
    return prvCpssDrvHwPpGetRegField(devNum, regAddr, 12, 14, ipPayloadMinSizePtr);
}
