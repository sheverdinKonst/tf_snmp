...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, startBit , 1, data);
...
)
{
    ...
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, startBit, 1, &value);
...
)
{
    ...
    if(PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_SUPPORTED_MAC(devNum) == GT_TRUE)
    {
        ...
        rc = prvCpssDrvHwPpSetRegField(devNum,regAddr,0,6,additionToLength);
    }
    else
    {
        /* write register value */
...
)
{
    ...
    if(PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_SUPPORTED_MAC(devNum) == GT_TRUE)
    {
        /* write register value */
        regAddr = PRV_DXCH_REG1_UNIT_HA_MAC(devNum).IPLengthOffset;
        rc = prvCpssDrvHwPpGetRegField(devNum,regAddr,0,6,additionToLengthPtr);
    }
    else
    {
        /* read register value */
...
)
{
    ...
    if (PRV_CPSS_DXCH_PP_HW_INFO_VPLS_MODE_SUPPORTED_MAC(devNum)== GT_TRUE)
    {
        ...
        return prvCpssDrvHwPpSetRegField(devNum, regAddr, 0, 32, value);
    }
    ...
    return prvCpssDrvHwPpWriteRegister(devNum, regAddr, value);
}
...
)
{
    ...
    if (PRV_CPSS_DXCH_PP_HW_INFO_VPLS_MODE_SUPPORTED_MAC(devNum)== GT_TRUE)
    {
        ...
        return prvCpssDrvHwPpGetRegField(devNum, regAddr, 0, 32, valuePtr);
    ...
    return prvCpssDrvHwPpReadRegister(devNum, regAddr, valuePtr);
}
