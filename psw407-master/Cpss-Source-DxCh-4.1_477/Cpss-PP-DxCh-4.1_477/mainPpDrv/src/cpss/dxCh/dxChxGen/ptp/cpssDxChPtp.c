...
#define PRV_CPSS_DXCH_PTP_PORT_NUM_CHECK_AND_MAC_NUM_GET_MAC(_dev, _port, _portMacNum)              \
    {                                                                                               \
        GT_STATUS __rc;                                                                             \
        PRV_CPSS_DXCH_PORT_MAP_SHADOW_STC *_portMapShadowPtr;                                       \
...
)
{
    ...
    /* temporary for Lion3 the same that for Bobcat2 */
            ...
            switch (taiIdPtr->taiInstance)
            {
                ...
                case CPSS_DXCH_PTP_TAI_INSTANCE_GLOBAL_E:
                    ...
                    if (PRV_CPSS_IS_MULTI_PORT_GROUPS_DEVICE_MAC(devNum))
                    {
                        ...
                        if (bmp == 0)
                        {
                            return GT_FAIL; /* must not occure */
                        }
...
)
{
    ...
    {
        /* Lion3 or BobCat2 and above devices */
        ...
        switch (hwValue)
        {
            ...
            case 7:
                *functionPtr = CPSS_DXCH_PTP_TOD_COUNTER_FUNC_NOP_E;
                break;
            default: return GT_FAIL; /*never occurs*/
        }
        return GT_OK;
    }
    ...
    if (entryPtr->tsMode == CPSS_DXCH_PTP_TS_TIMESTAMPING_MODE_DO_ACTION_E)
    {
        ...
        switch (hwData)
        {
            ...
            case 7:
                ...
                break;
            default: return GT_BAD_STATE; /* on reseved value 7 */
        }
        ...
        switch (hwData)
        {
            ...
            case 2:
                ...
                break;
            default: return GT_BAD_STATE; /* on reserved value 3 */
        }
    }
    if(PRV_CPSS_SIP_5_10_CHECK_MAC(devNum))
    {
...
)
{
    ...
    portFactor = PRV_CPSS_SIP_5_20_CHECK_MAC(devNum) ?
            512 :
            (1+PRV_CPSS_DXCH_PP_HW_MAX_VALUE_OF_PHY_PORT_MAC(devNum));/*128/256*/
