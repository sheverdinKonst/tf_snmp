...
{
     /*-------------------------------------------------------------------------------------------------------------------------------------------*
      * ppType,                     {numberOfSmiIf,                 activeInterfaceList,                    oytoPollingList                   } } *                 
      *-------------------------------------------------------------------------------------------------------------------------------------------*/
...
PRV_CPSS_DRV_FLD_INIT_STC           prv_SmiUnitFldInitStc[] =
{
    /*------------------------------------------------------------------------------------------------------------------------------------------*/
    /* fld id                                      {          reg off in reg struct,           fld-offs,len }, {min/maxValue},   name           */
    /*------------------------------------------------------------------------------------------------------------------------------------------*/
...
PRV_CPSS_DRV_FLD_INIT_STC   prv_dxChLMSflFldInitStc[PRV_CPSS_SMI_FLD_MAX];
PRV_CPSS_DXCH_SMI_DRV_STC   prv_dxChLMS;


PRV_CPSS_DRV_FLD_INIT_STC   prv_dxChSMIflFldInitStc[PRV_CPSS_SMI_FLD_MAX];
PRV_CPSS_DXCH_SMI_DRV_STC   prv_dxChSMI;
...
)
{
    ...
    {
        intSeqPtr = &prv_SmiUnitFldInitStc[0];
        rc = prvCpssDrvInit(/*INOUT*/&prv_dxChSMI.genDrv
                                        ,&prv_dxChSMI.fldDefList[0]
                                        ,intSeqPtr
