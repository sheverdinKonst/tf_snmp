...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TUNNEL_START_GEN_IP_PROFILE_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TUNNEL_START_CONFIG_UNT_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TUNNEL_TERM_CONFIG_UNT_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TUNNEL_TERM_ACTION_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChTunnelLogLibDb[] = {
    {"cpssDxChTunnelStartEntrySet", 4, cpssDxChTunnelStartEntrySet_PARAMS, NULL},
    ...
    {"cpssDxChTunnelStartEntryGet", 4, cpssDxChTunnelStartEntryGet_PARAMS, NULL},
    {"cpssDxChTunnelStartPortGroupEntrySet", 5, cpssDxChTunnelStartPortGroupEntrySet_PARAMS, NULL},
    {"cpssDxChTunnelStartPortGroupEntryGet", 5, cpssDxChTunnelStartPortGroupEntryGet_PARAMS, NULL},
    ...
    {"cpssDxChTunnelTermEntrySet", 6, cpssDxChTunnelTermEntrySet_PARAMS, NULL},
    {"cpssDxChTunnelTermEntryGet", 7, cpssDxChTunnelTermEntryGet_PARAMS, NULL},
