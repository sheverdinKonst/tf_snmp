...
)
{
    ...
    else if (devPtr->devFamily == CPSS_PP_FAMILY_DXCH_LION3_E) {
        /* do nothing for lion3*/
        return GT_OK;
    }
    return GT_FAIL;
}
...
)
{
    ...
    if (devPtr->devFamily >= CPSS_PP_FAMILY_DXCH_LION3_E) /* &&      CPSS_PP_FAMILY_DXCH_BOBCAT2_E, */
    {
...
)
{
    ...
    else if (devPtr->devFamily >= CPSS_PP_FAMILY_DXCH_LION3_E) /* &&      CPSS_PP_FAMILY_DXCH_BOBCAT2_E, */
    {
