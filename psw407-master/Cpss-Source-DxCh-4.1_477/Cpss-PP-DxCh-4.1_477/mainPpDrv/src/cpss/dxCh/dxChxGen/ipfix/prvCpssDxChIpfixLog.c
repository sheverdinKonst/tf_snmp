...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_IPFIX_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_IPFIX_WRAPAROUND_CFG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_IPFIX_TIMER_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_IPFIX_TIMESTAMP_UPLOAD_CONF_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChIpfixLogLibDb[] = {
    ...
    {"cpssDxChIpfixAlarmEventsGet", 4, cpssDxChIpfixAlarmEventsGet_PARAMS, NULL},
    ...
    {"cpssDxChIpfixPortGroupAlarmEventsGet", 5, cpssDxChIpfixPortGroupAlarmEventsGet_PARAMS, NULL},
