...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_IP_TCAM_LPM_MANGER_CAPCITY_CFG_STC_PTR(contextLib, logType, namePtr, &paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_IP_TCAM_LPM_MANGER_CHEETAH2_VR_SUPPORT_CFG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_IP_LPM_IPV6_UC_PREFIX_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_IP_TCAM_LPM_MANGER_INDEX_RANGE_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_IP_LPM_VR_CONFIG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_IP_LPM_IPV4_UC_PREFIX_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_IP_TCAM_ROUTE_ENTRY_INFO_UNT_PTR(contextLib, logType, namePtr, paramVal);
}
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChIpLpmPolicyBasedRoutingDefaultMcGet_PARAMS[] =  {
    ...
    &OUT_GT_U32_PTR_defaultIpv4RuleIndexArray,
    &INOUT_GT_U32_PTR_defaultIpv4RuleIndexArrayLenPtr,
    &OUT_GT_U32_PTR_defaultIpv6RuleIndexArray,
    &INOUT_GT_U32_PTR_defaultIpv6RuleIndexArrayLenPtr,
    &OUT_GT_U32_PTR_pclIdArray,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChIpLpmTcamLinesReserve_PARAMS[] =  {
    &IN_GT_U32_lpmDBId,
    &IN_GT_U32_PTR_linesToReserveArray,
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChIpLpmEngineLogLibDb[] = {
    ...
    {"cpssDxChIpLpmDBDevListAdd", 3, cpssDxChIpLpmDBDevListAdd_PARAMS, NULL},
    {"cpssDxChIpLpmDBDevsListRemove", 3, cpssDxChIpLpmDBDevListAdd_PARAMS, NULL},
    {"cpssDxChIpLpmDBDevListGet", 3, cpssDxChIpLpmDBDevListGet_PARAMS, NULL},
    {"cpssDxChIpLpmTcamLinesReserve", 4, cpssDxChIpLpmTcamLinesReserve_PARAMS, NULL},
    {"cpssDxChIpLpmPolicyBasedRoutingDefaultMcSet", 3, cpssDxChIpLpmPolicyBasedRoutingDefaultMcSet_PARAMS, NULL},
    {"cpssDxChIpLpmPolicyBasedRoutingDefaultMcGet", 9, cpssDxChIpLpmPolicyBasedRoutingDefaultMcGet_PARAMS, NULL},
    {"cpssDxChIpLpmVirtualRouterAdd", 3, cpssDxChIpLpmVirtualRouterAdd_PARAMS, NULL},
    {"cpssDxChIpLpmVirtualRouterSharedAdd", 3, cpssDxChIpLpmVirtualRouterAdd_PARAMS, NULL},
    {"cpssDxChIpLpmVirtualRouterGet", 3, cpssDxChIpLpmVirtualRouterGet_PARAMS, NULL},
    {"cpssDxChIpLpmVirtualRouterDel", 2, cpssDxChIpLpmVirtualRouterDel_PARAMS, NULL},
    {"cpssDxChIpLpmIpv4UcPrefixAdd", 6, cpssDxChIpLpmIpv4UcPrefixAdd_PARAMS, NULL},
    {"cpssDxChIpLpmIpv4UcPrefixAddBulk", 3, cpssDxChIpLpmIpv4UcPrefixAddBulk_PARAMS, NULL},
    {"cpssDxChIpLpmIpv4UcPrefixDel", 4, cpssDxChIpLpmIpv4UcPrefixDel_PARAMS, NULL},
    {"cpssDxChIpLpmIpv4UcPrefixDelBulk", 3, cpssDxChIpLpmIpv4UcPrefixAddBulk_PARAMS, NULL},
    {"cpssDxChIpLpmIpv4UcPrefixesFlush", 2, cpssDxChIpLpmVirtualRouterDel_PARAMS, NULL},
    {"cpssDxChIpLpmIpv4UcPrefixSearch", 7, cpssDxChIpLpmIpv4UcPrefixSearch_PARAMS, NULL},
    {"cpssDxChIpLpmIpv4UcPrefixGetNext", 7, cpssDxChIpLpmIpv4UcPrefixGetNext_PARAMS, NULL},
    {"cpssDxChIpLpmIpv4UcPrefixGet", 7, cpssDxChIpLpmIpv4UcPrefixGet_PARAMS, NULL},
    ...
    {"cpssDxChIpLpmIpv6UcPrefixAdd", 7, cpssDxChIpLpmIpv6UcPrefixAdd_PARAMS, NULL},
    {"cpssDxChIpLpmIpv6UcPrefixAddBulk", 4, cpssDxChIpLpmIpv6UcPrefixAddBulk_PARAMS, NULL},
    {"cpssDxChIpLpmIpv6UcPrefixDel", 4, cpssDxChIpLpmIpv6UcPrefixDel_PARAMS, NULL},
    {"cpssDxChIpLpmIpv6UcPrefixDelBulk", 3, cpssDxChIpLpmIpv6UcPrefixDelBulk_PARAMS, NULL},
    {"cpssDxChIpLpmIpv6UcPrefixesFlush", 2, cpssDxChIpLpmVirtualRouterDel_PARAMS, NULL},
    {"cpssDxChIpLpmIpv6UcPrefixSearch", 7, cpssDxChIpLpmIpv6UcPrefixSearch_PARAMS, NULL},
    {"cpssDxChIpLpmIpv6UcPrefixGetNext", 7, cpssDxChIpLpmIpv6UcPrefixGetNext_PARAMS, NULL},
    {"cpssDxChIpLpmIpv6UcPrefixGet", 7, cpssDxChIpLpmIpv6UcPrefixGet_PARAMS, NULL},
