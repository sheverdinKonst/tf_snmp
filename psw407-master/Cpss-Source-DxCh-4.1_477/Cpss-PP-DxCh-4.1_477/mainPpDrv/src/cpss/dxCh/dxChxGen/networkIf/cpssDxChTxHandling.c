    ...
    if(!PRV_CPSS_DXCH_CHECK_SDMA_PACKETS_FROM_CPU_CORRUPT_WA_MAC(devNum))
    {
        ...
        */
        ...
        if (txDescListUpdated == GT_TRUE)
        {
            ...
            rc1 = prvCpssDrvHwPpPortGroupWriteRegister(devNum,portGroupId,regsAddr->sdmaRegs.txDmaCdp[txQueue],(GT_U32)phyNext2Feed);
            if(rc1 != GT_OK)
                return rc1;
        }
    }
...
)
{
        ...
        !PRV_CPSS_DXCH_CHECK_SDMA_PACKETS_FROM_CPU_CORRUPT_WA_MAC(devNum))
    {
        ...
        */
        ...
        rc = prvCpssDrvHwPpPortGroupReadRegister (devNum, portGroupId,regAddr, &hwValue);
