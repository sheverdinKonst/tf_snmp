...
)
{
    ...
    {
         numOfSerdes = PRV_CPSS_XCAT3_SERDES_NUM_CNS;
    }
    ...
    {
        numOfSerdes = PRV_CPSS_BOBCAT2_SERDES_NUM_CNS;
    }
    ...
    {
CPSS_TBD_BOOKMARK_EARCH/* fix for Lion3 needed */
        numOfSerdes = PRV_CPSS_LION2_SERDES_NUM_CNS;
    }
    else
    {
...
)
{
    ...
    /* Lion2 and Lion3 - 4 and less active port groups - the numOfPorts should include the CPU port 0x3f */
...
)
{
    ...
    if ((PRV_CPSS_PP_MAC(devNum)->devFamily == CPSS_PP_FAMILY_DXCH_LION_E)||
        ...
        (PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_SUPPORTED_MAC(devNum) == GT_TRUE))
    {
        /* for Lion3,bobcat2 those base addresses are aligned by convertOldRegDbToNewUnitsBaseAddr(...) */
...
)
{
    ...
    lionMiscellaneousRegsInit(regsAddrPtr);
...
*
* DESCRIPTION:
*       This function initializes the registers struct for DxCh Lion3 devices.
*
* APPLICABLE DEVICES:
*        Bobcat2; Caelum; Bobcat3.
*
