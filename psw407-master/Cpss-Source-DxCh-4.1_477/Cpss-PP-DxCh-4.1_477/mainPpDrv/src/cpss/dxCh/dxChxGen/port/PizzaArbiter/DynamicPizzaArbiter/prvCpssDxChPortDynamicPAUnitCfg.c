...
)
{
    ...
    *highSpeedPortNumPtr = 0;
    highSpeedPortArr = highSpeedPortArr;
...
int TestConfig(void)
{
    ...
    rc = BuildPizzaDistribution(portsConfigArrayPtr,MAX_PORTS_NUM_CNS,maxPipeSize,1000,
                                /*OUT*/2000,&pizzaArray[0], &numberOfSlices, 
    ...
    int ProcessFile(char * fileName)
    {
        ...
        static GT_U32  highSpeedPortArr[PRV_CPSS_DXCH_PORT_HIGH_SPEED_PORT_NUM_CNS];
