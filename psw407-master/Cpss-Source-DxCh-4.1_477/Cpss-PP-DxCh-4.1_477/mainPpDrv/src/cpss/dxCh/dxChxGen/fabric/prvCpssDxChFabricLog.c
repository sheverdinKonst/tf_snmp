...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_FABRIC_HGL_RX_ERROR_CNTRS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_FABRIC_HGL_RX_DSA_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_FABRIC_HGL_FC_RX_LINK_LAYER_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_FABRIC_HGL_FC_RX_E2E_HEADER_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChFabricLogLibDb[] = {
    ...
    {"cpssDxChFabricHGLinkPcsRxStatusGet", 3, cpssDxChFabricHGLinkPcsRxStatusGet_PARAMS, NULL},
    {"cpssDxChFabricHGLinkRxErrorCntrGet", 3, cpssDxChFabricHGLinkRxErrorCntrGet_PARAMS, NULL},
