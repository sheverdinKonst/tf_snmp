...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PCL_UDB_SELECT_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PCL_LOOKUP_CFG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PCL_CFG_TBL_ACCESS_MODE_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PCL_ACTION_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPclPortGroupRuleGet_PARAMS[] =  {
    ...
    &IN_CPSS_PCL_RULE_SIZE_ENT_ruleSize,
    &IN_GT_U32_ruleIndex,
    &OUT_GT_U32_PTR_maskArr,
    &OUT_GT_U32_PTR_patternArr,
    &OUT_GT_U32_PTR_actionArr
};
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChPclLogLibDb[] = {
    ...
    {"cpssDxChPclRuleParsedGet", 8, cpssDxChPclRuleParsedGet_PARAMS, NULL},
    ...
    {"cpssDxChPclRuleGet", 6, cpssDxChPclRuleGet_PARAMS, NULL},
    ...
    {"cpssDxChPclPortGroupRuleSet", 8, cpssDxChPclPortGroupRuleSet_PARAMS, NULL},
    {"cpssDxChPclPortGroupRuleParsedGet", 9, cpssDxChPclPortGroupRuleParsedGet_PARAMS, NULL},
    ...
    {"cpssDxChPclPortGroupRuleGet", 7, cpssDxChPclPortGroupRuleGet_PARAMS, NULL},
