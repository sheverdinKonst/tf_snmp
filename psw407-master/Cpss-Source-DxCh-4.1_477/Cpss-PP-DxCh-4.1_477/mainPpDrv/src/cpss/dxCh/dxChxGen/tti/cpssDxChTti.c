...
/* the index (byte index) in the legacy key of Lion3 that should represent the mac SA/DA */
...
)
{
    ...
    else /* xCat; xCat3; Lion; xCat2; Lion2; Bobcat2; Caelum; Bobcat3 */
    {
        if(PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_SUPPORTED_MAC(devNum) == GT_TRUE)
        {
            ...
            rc = prvCpssDrvHwPpSetRegField(devNum,regAddr,2,1,value);
        }
        else
        {
...
)
{
    ...
    if (PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_SUPPORTED_MAC(devNum) == GT_TRUE)
    {
        ...
        case CPSS_DXCH_TTI_EXCEPTION_TRILL_IS_IS_ADJACENCY_E:
            *offsetPtr = 0;
            *regAddressPtr = PRV_DXCH_REG1_UNIT_TTI_MAC(devNum).TRILLConfigs.TRILLGlobalConfigs0;
            break;
        ...
        case CPSS_DXCH_TTI_EXCEPTION_TRILL_OUTER_UC_INNER_MC_E:
            *offsetPtr = 0;
            *regAddressPtr = PRV_DXCH_REG1_UNIT_TTI_MAC(devNum).TRILLConfigs.TRILLGlobalConfigs1;
            break;
...
)
{
    ...
    /* write command value */
    rc = prvCpssDrvHwPpSetRegField(devNum,regAddr,offset,len,value);
...
)
{
    ...
    /* read command value */
    rc = prvCpssDrvHwPpGetRegField(devNum,regAddr,offset,len,&value);
    if (rc != GT_OK)
        return rc;
...
)
{
    ...
    rc = prvCpssDrvHwPpSetRegField(devNum, regAddr, offset, 8, (GT_U32)dsaCpuCode);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, offset, 8, &value);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    rc = prvCpssDrvHwPpSetRegField(devNum, regAddr, 18, 1, value);
...
)
{
   ...
   if (GT_FALSE == PRV_CPSS_DXCH_XCAT_B1_ONLY_CHECK_MAC(devNum))
    ...
    regAddr = PRV_CPSS_DXCH_DEV_REGS_MAC(devNum)->ttiRegs.ttiMetalFix;
    rc = prvCpssDrvHwPpGetRegField(devNum,regAddr,18,1,&value);
...
)
{
    ...
    case CPSS_IP_PROTOCOL_IPV4_E:
        rc = prvCpssDrvHwPpSetRegField(devNum,regAddr,0,6,value);
        break;

    case CPSS_IP_PROTOCOL_IPV6_E:
        rc = prvCpssDrvHwPpSetRegField(devNum,regAddr,6,6,value);
        break;
...
)
{
    ...
    {
    case CPSS_IP_PROTOCOL_IPV4_E:
        rc = prvCpssDrvHwPpGetRegField(devNum,regAddr,0,6,&hwData);
        break;

    case CPSS_IP_PROTOCOL_IPV6_E:
        rc = prvCpssDrvHwPpGetRegField(devNum,regAddr,6,6,&hwData);
        break;
...
)
{
    ...
    case CPSS_TUNNEL_ETHERTYPE_TYPE_IPV4_GRE1_E:
        ...
        if (! PRV_CPSS_DXCH_XCAT_FAMILY_CHECK_MAC(devNum))
        {
            ...
            rc = prvCpssDrvHwPpSetRegField(devNum,regAddr,offset,16,ethertype);
        }
        else /* xCat; xCat3; Lion; xCat2; Lion2; Bobcat2; Caelum; Bobcat3 */
        {
            /* write value */
    ...
    case CPSS_TUNNEL_ETHERTYPE_TYPE_MIM_E:
        ...
        else
        {
            ...
            rc = prvCpssDrvHwPpSetRegField(devNum,regAddr,16,16,ethertype);
            if(rc != GT_OK)
                return rc;
        }
...
)
{
    ...
    return prvCpssDrvHwPpGetRegField(devNum,regAddr,offset,16,ethertypePtr);
}
...
)
{
    ...
    rc = prvCpssDrvHwPpSetRegField(devNum,regAddr,18,8,cpuCodeBase);
...
)
{
    ...
    /* read value */
    regAddr = PRV_DXCH_REG1_UNIT_TTI_MAC(devNum).TRILLConfigs.TRILLGlobalConfigs0;
    return prvCpssDrvHwPpGetRegField(devNum,regAddr,18,8,cpuCodeBasePtr);
...
)
{
    ...
    /* write value */
    regAddr = PRV_DXCH_REG1_UNIT_TTI_MAC(devNum).TRILLConfigs.TRILLGlobalConfigs0;
    rc = prvCpssDrvHwPpSetRegField(devNum,regAddr,16,2,maxTrillVersion);
...
)
{
    ...
    /* read value */
    regAddr = PRV_DXCH_REG1_UNIT_TTI_MAC(devNum).TRILLConfigs.TRILLGlobalConfigs0;
    return prvCpssDrvHwPpGetRegField(devNum,regAddr,16,2,maxTrillVersionPtr);
}
...
)
{
    ...
    rc = ttiActionHw2LogicFormat(devNum,hwTtiActionArray,actionType,actionPtr);
...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, 16 * (entryIndex % 2) + 10, 2, entrySize);
...
)
{
    ...
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, (16 * (entryIndex % 2)) + 10, 2, &entrySize);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, startBit, numOfBits, value);
}
...
)
{
    ...
    rc =  prvCpssDrvHwPpGetRegField(devNum, regAddr, startBit, numOfBits, &value);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, 0, 16, (GT_U32)udpPort);
}
...
)
{
    ...
    rc = prvCpssDrvHwPpSetRegField(devNum, regAddr, 0, 24, hwData);
    if (rc != GT_OK)
    {
        return rc;
    }
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, 0, 24, hwData);
}
...
)
{
    ...
    regAddr = PRV_DXCH_REG1_UNIT_TTI_MAC(devNum).duplicationConfigs.MPLSMCDALow;
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, 0, 24, &hwData);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    PRV_CPSS_CONVERT_PACKET_CMD_TO_HW_VAL_MAC(value,command);
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, offset, 3, value);
}
...
)
{
    ...
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, offset, 3, &value);
    if (rc == GT_OK)
    {
        PRV_CPSS_CONVERT_HW_VAL_TO_PACKET_CMD_MAC(*commandPtr,value);
    }
...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, 15, 8, cpuCodeBase);
}
...
)
{
    ...
    return prvCpssDrvHwPpGetRegField(devNum, regAddr, 15, 8, cpuCodeBasePtr);
}
...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum,regAddr,23,1,(BOOL2BIT_MAC(enable)));
...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, offset, 8, extensionHeaderValue);
}
...
)
{
    ...
    return prvCpssDrvHwPpGetRegField(devNum, regAddr, offset, 8, extensionHeaderValuePtr);
}
...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, (lookup%2)*12, 12, overrideBitmap);
}
...
)
{
    ...
    return prvCpssDrvHwPpGetRegField(devNum, regAddr, (lookup%2)*12, 12, overrideBitmapPtr);
}
...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, 25, 1, hwData);
}
...
)
{
    ...
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, 25, 1, &hwData);
    if (rc == GT_OK)
    {
