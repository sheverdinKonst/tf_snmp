...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, 17, 8, (GT_U32)dsaCpuCode);
}
...
)
{
    ...
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, 17, 8, &value);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    regAddr = PRV_DXCH_REG1_UNIT_OAM_MAC(devNum,stage).OAMGlobalCtrl1;
    /* Aging Bitmap Update Mode  */
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, 1, 1, &value);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, 0, 10, value);
}
...
)
{
    ...
    regAddr = PRV_DXCH_REG1_UNIT_OAM_MAC(devNum,stage).hashBitsSelection;
    /* Hash first and hash last bits */
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, 0, 10, &value);
    if (rc != GT_OK)
    {
        return rc;
    }
