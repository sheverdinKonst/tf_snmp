...
)
{
    ...
    if(fid16BitHashEn == 0)
    {
        dataPtr[5] = ((vlanId & BIT_MASK_MAC(numBits-12)) << 12) |/*additional bits*/
                      (vlanId & BIT_MASK_MAC(12));                /*12 bits*/
        dataPtr[6] = 0 ;
    }
    else
    {
...
{
    GT_STATUS   rc;
    GT_U32  isSip5_10;   /*flag of supporting SIP 5 10 devices*/
    ...
    hashParams.useZeroInitValueForCrcHash = PRV_CPSS_SIP_5_CHECK_MAC(devNum);
