...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PTP_TSU_TX_TIMESTAMP_QUEUE_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PTP_TS_INGRESS_TIMESTAMP_QUEUE_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PTP_TS_LOCAL_ACTION_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PTP_TS_UDP_CHECKSUM_UPDATE_MODE_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PTP_TS_TAG_GLOBAL_CFG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PTP_TS_TAG_PORT_CFG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PTP_EGRESS_EXCEPTION_COUNTERS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PTP_TOD_COUNT_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PTP_TAI_ID_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PTP_TAI_TOD_STEP_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PTP_TSU_CONTROL_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PTP_EGRESS_EXCEPTION_CFG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PTP_EGRESS_DOMAIN_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PTP_TS_CFG_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PTP_TIMESTAMP_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PTP_INGRESS_EXCEPTION_CFG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PTP_TS_EGRESS_TIMESTAMP_QUEUE_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChPtpLogLibDb[] = {
    ...
    {"cpssDxChPtpDomainV1IdSet", 3, cpssDxChPtpDomainV1IdSet_PARAMS, NULL},
    {"cpssDxChPtpDomainV1IdGet", 3, cpssDxChPtpDomainV1IdGet_PARAMS, NULL},
