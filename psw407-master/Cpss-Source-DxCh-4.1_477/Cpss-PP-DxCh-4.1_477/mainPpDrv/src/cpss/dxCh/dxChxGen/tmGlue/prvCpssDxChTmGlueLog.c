...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TM_AGING_AND_DELAY_STATISTICS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TM_AGING_AND_DELAY_PROFILE_THRESHOLDS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TM_GLUE_DROP_MASK_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TM_GLUE_QUEUE_MAP_BIT_SELECT_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TM_GLUE_DRAM_ALGORITHM_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TM_GLUE_QUEUE_MAP_L1_PACKET_LENGTH_OFFSET_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TM_GLUE_DRAM_CFG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChTmGlueLogLibDb[] = {
    ...
    {"cpssDxChTmGlueFlowControlEgressEnableSet", 2, prvCpssLogGenDevNumEnable_PARAMS, NULL},
    {"cpssDxChTmGlueFlowControlEgressEnableGet", 2, prvCpssLogGenDevNumEnablePtr_PARAMS, NULL},
    ...
    {"cpssDxChTmGluePfcResponseModeSet", 2, cpssDxChTmGluePfcResponseModeSet_PARAMS, NULL},
    {"cpssDxChTmGluePfcResponseModeGet", 2, cpssDxChTmGluePfcResponseModeGet_PARAMS, NULL},
