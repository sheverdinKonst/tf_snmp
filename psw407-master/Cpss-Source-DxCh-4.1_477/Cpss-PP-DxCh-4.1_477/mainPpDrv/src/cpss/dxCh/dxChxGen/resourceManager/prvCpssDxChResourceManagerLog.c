...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TCAM_MANAGER_RANGE_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TCAM_MANAGER_CLIENT_FUNC_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TCAM_MANAGER_TCAM_LOCATION_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TCAM_MANAGER_ENTRY_AMOUNT_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChTcamManagerUsageGet_PARAMS[] =  {
    ...
    &OUT_CPSS_DXCH_TCAM_MANAGER_ENTRY_AMOUNT_STC_PTR_allocatedEntriesArray,
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChResourceManagerLogLibDb[] = {
    ...
    {"cpssDxChTcamManagerEntriesReservationSet", 6, cpssDxChTcamManagerEntriesReservationSet_PARAMS, NULL},
    {"cpssDxChTcamManagerEntriesReservationGet", 6, cpssDxChTcamManagerEntriesReservationGet_PARAMS, NULL},
    {"cpssDxChTcamManagerUsageGet", 7, cpssDxChTcamManagerUsageGet_PARAMS, NULL},
    ...
    {"cpssDxChTcamManagerAvailableEntriesCheck", 4, cpssDxChTcamManagerAvailableEntriesCheck_PARAMS, NULL},
