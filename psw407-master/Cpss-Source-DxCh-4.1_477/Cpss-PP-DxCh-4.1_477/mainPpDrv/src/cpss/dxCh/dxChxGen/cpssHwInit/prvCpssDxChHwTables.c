...
/* indication that the number in the lower 31 bits is 'fraction' (1/x) and not (x) */
...
/* Lion3 direct table information */
static PRV_CPSS_DXCH_TABLES_INFO_DIRECT_UNIT_STC directAccessLion3TableInfo[] =
{
    /* the FDB is not accessible directly from CPU */
    {PRV_CPSS_DXCH_TABLE_FDB_E,  PRV_CPSS_DXCH_UNIT_FDB_E,
    {NO_DIRECT_ACCESS_FROM_CPU_TO_ADDRESS_CNS, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_FDB_FDB_BITS_SIZE_CNS) , PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_TABLE_VLAN_E, PRV_CPSS_DXCH_UNIT_LAST_E,
    /* PRV_DXCH_XCAT_TABLE_VLAN_E */
    {  TABLES_INFO_DIRECT_NOT_EXISTS_CNS }}, /* see ingress/egress tables instead */

    {PRV_CPSS_DXCH3_TABLE_VRF_ID_E, PRV_CPSS_DXCH_UNIT_LAST_E,
    /* PRV_DXCH_XCAT_TABLE_VRF_ID_E */
    {  TABLES_INFO_DIRECT_NOT_EXISTS_CNS }}, /* the field is in ingress vlan entry */

    {PRV_CPSS_DXCH_TABLE_PORT_VLAN_QOS_E, PRV_CPSS_DXCH_UNIT_LAST_E,
    /* PRV_DXCH_XCAT_TABLE_PORT_VLAN_QOS_E */
    {TABLES_INFO_DIRECT_NOT_MODIFIED_CNS}},

    {PRV_CPSS_DXCH_TABLE_STATISTICAL_RATE_LIMIT_E, PRV_CPSS_DXCH_UNIT_EQ_E,
    {0x00100000, 4 , PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_TABLE_CPU_CODE_E, PRV_CPSS_DXCH_UNIT_EQ_E,
    {0x00120000, 4 , PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_TABLE_QOS_PROFILE_E, PRV_CPSS_DXCH_UNIT_EQ_E,
    {0x00110000, 4 , PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_XCAT_TABLE_LOGICAL_TARGET_MAPPING_E, PRV_CPSS_DXCH_UNIT_EQ_E,
    {0x00140000, 4 , PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_TABLE_STG_E, PRV_CPSS_DXCH_UNIT_LAST_E,
    /* PRV_CPSS_DXCH_TABLE_STG_E */
    {TABLES_INFO_DIRECT_NOT_EXISTS_CNS }}, /* see ingress/egress tables instead */

    {PRV_CPSS_DXCH3_LTT_TT_ACTION_E, PRV_CPSS_DXCH_UNIT_LAST_E,
    /* PRV_DXCH_XCAT_LTT_TT_ACTION_E */
    {0x0D8C0000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TTI_ACTION_BITS_SIZE_CNS) , PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_TABLE_ROUTE_HA_ARP_DA_E, PRV_CPSS_DXCH_UNIT_LAST_E,
    /*PRV_CPSS_XCAT_TABLE_ROUTE_HA_ARP_DA_E,         */
    {  TABLES_INFO_DIRECT_NOT_EXISTS_CNS }}, /* this is CH1 only table */

    {PRV_CPSS_DXCH3_TABLE_INGRESS_VLAN_TRANSLATION_E, PRV_CPSS_DXCH_UNIT_TTI_E,
    /* PRV_DXCH_XCAT_TABLE_INGRESS_TRANSLATION_E */
    {0x00014000, 0x4, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_XCAT_TABLE_INGRESS_PCL_UDB_CONFIG_E, PRV_CPSS_DXCH_UNIT_TTI_E,
    /* PRV_DXCH_XCAT_TABLE_IPCL_UDB_CFG_E */
    {0x00020000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TTI_PCL_UDB_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_TABLE_VLAN_PORT_PROTOCOL_E, PRV_CPSS_DXCH_UNIT_TTI_E,
    /* PRV_DXCH_XCAT_TABLE_VLAN_PORT_PROTOCOL_E */
    {0x00008000, 0x4, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH3_TABLE_MAC2ME_E, PRV_CPSS_DXCH_UNIT_TTI_E,
    /* PRV_CPSS_XCAT_TABLE_MAC2ME_E */
    {0x00001600, 0x20, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_XCAT_TABLE_BCN_PROFILES_E, PRV_CPSS_DXCH_UNIT_LAST_E,
    /*PRV_DXCH_XCAT_TABLE_BCN_PROFILE_E,             */
    {TABLES_INFO_DIRECT_NOT_EXISTS_CNS}},

    {PRV_CPSS_DXCH_LION_TABLE_VLAN_INGRESS_E, PRV_CPSS_DXCH_UNIT_L2I_E,
    {0x002C0000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_L2I_INGRESS_VLAN_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_INGRESS_BRIDGE_PORT_MEMBERS_E, PRV_CPSS_DXCH_UNIT_L2I_E,
    {0x00280000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_L2I_INGRESS_BRIDGE_PORT_MEMBERS_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_INGRESS_SPAN_STATE_GROUP_INDEX_E, PRV_CPSS_DXCH_UNIT_L2I_E,
    {0x002E0000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_L2I_INGRESS_SPAN_STATE_GROUP_INDEX_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION_TABLE_STG_INGRESS_E, PRV_CPSS_DXCH_UNIT_L2I_E,
    /* PRV_DXCH_LION_TABLE_STG_INGRESS_E             */
    {0x00240000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_L2I_INGRESS_STP_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION_TABLE_TXQ_SHAPER_PER_PORT_PER_PRIO_TOKEN_BUCKET_CONFIG_E, PRV_CPSS_DXCH_UNIT_TXQ_DQ_E,
    /*PRV_CPSS_LION_TABLE_TXQ_SHAPER_PER_PORT_PER_PRIO_TOKEN_BUCKET_CONFIG_E*/
    {0x00006000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_PRIO_TOKEN_BUCKET_CONFIGURATION_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION_TABLE_TXQ_SHAPER_PER_PORT_TOKEN_BUCKET_CONFIG_E, PRV_CPSS_DXCH_UNIT_TXQ_DQ_E,
    /*PRV_CPSS_LION_TABLE_TXQ_SHAPER_PER_PORT_TOKEN_BUCKET_CONFIG_E*/
    {0x0000A000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_PORT_TOKEN_BUCKET_CONFIGURATION_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION_TABLE_TXQ_EGRESS_STC_E, PRV_CPSS_DXCH_UNIT_TXQ_DQ_E,
    /*PRV_CPSS_LION_TABLE_TXQ_EGRESS_STC_E*/
    {0x0000D800, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_EGRESS_STC_TABLE_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION_TABLE_ROUTER_VLAN_URPF_STC_E, PRV_CPSS_DXCH_UNIT_LAST_E,
    /*PRV_CPSS_DXCH_LION_TABLE_ROUTER_VLAN_URPF_STC_E*/
    {TABLES_INFO_DIRECT_NOT_MODIFIED_CNS}},

    {PRV_CPSS_DXCH_LION_TABLE_TRUNK_HASH_MASK_CRC_E, PRV_CPSS_DXCH_UNIT_PCL_E,
    /*PRV_CPSS_LION_TABLE_TRUNK_HASH_MASK_CRC_E*/
    {0x00001000 , 0x10, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},
    /* Lion3 start new tables */
    /* TTI tables */
    {PRV_CPSS_DXCH_LION3_TABLE_TTI_PHYSICAL_PORT_ATTRIBUTE_E, PRV_CPSS_DXCH_UNIT_TTI_E,
    {0x00100000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TTI_PHYSICAL_PORT_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_PRE_TTI_LOOKUP_INGRESS_EPORT_E, PRV_CPSS_DXCH_UNIT_TTI_E,
    {0x00210000 , BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TTI_DEFAULT_PORT_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_POST_TTI_LOOKUP_INGRESS_EPORT_E, PRV_CPSS_DXCH_UNIT_TTI_E,
    {0x00230000 , 0x4, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    /* Bridge Tables */
    {PRV_CPSS_DXCH_LION3_TABLE_BRIDGE_INGRESS_EPORT_E, PRV_CPSS_DXCH_UNIT_L2I_E,
    {0x00220000 , BITS_TO_BYTES_ALIGNMENT_MAC(LION3_L2I_EPORT_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_BRIDGE_INGRESS_EPORT_LEARN_PRIO_E, PRV_CPSS_DXCH_UNIT_L2I_E,
    {0x00210000 , BITS_TO_BYTES_ALIGNMENT_MAC(LION3_L2I_EPORT_LEARN_PRIO_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_BRIDGE_SOURCE_TRUNK_ATTRIBUTE_E, PRV_CPSS_DXCH_UNIT_L2I_E,
    {0x00202000 , BITS_TO_BYTES_ALIGNMENT_MAC(LION3_L2I_SOURCE_TRUNK_ATTRIBUTE_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_BRIDGE_PHYSICAL_PORT_E, PRV_CPSS_DXCH_UNIT_L2I_E,
    {0x00200000 , BITS_TO_BYTES_ALIGNMENT_MAC(LION3_L2I_PHYSICAL_PORT_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_BRIDGE_PHYSICAL_PORT_RATE_LIMIT_COUNTERS_E, PRV_CPSS_DXCH_UNIT_L2I_E,
    {0x00201000 , BITS_TO_BYTES_ALIGNMENT_MAC(LION3_L2I_PHYSICAL_PORT_RATE_LIMIT_COUNTERS_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

     /* EQ Tables */
    {PRV_CPSS_DXCH_LION3_TABLE_EQ_INGRESS_EPORT_E, PRV_CPSS_DXCH_UNIT_EQ_E,
    {0x00700000, 4, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},
    ...
    {0x00800000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_EGF_QAG_EGRESS_EPORT_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_QAG_EGRESS_VLAN_E, PRV_CPSS_DXCH_UNIT_EGF_QAG_E,
    {0x00000000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_EGF_QAG_EGRESS_EVLAN_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_QAG_TARGET_PORT_MAPPER_E, PRV_CPSS_DXCH_UNIT_EGF_QAG_E,
    {0x00900000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_EGF_QAG_TARGET_PORT_MAPPER_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_QAG_CPU_CODE_TO_LOOPBACK_MAPPER_E, PRV_CPSS_DXCH_UNIT_EGF_QAG_E,
    {0x00900400, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_EGF_QAG_CPU_CODE_TO_LOOPBACK_MAPPER_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_QAG_FWD_FROM_CPU_TO_LOOPBACK_MAPPER_E, PRV_CPSS_DXCH_UNIT_EGF_QAG_E,
    {0x00900800, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_EGF_QAG_FWD_FROM_CPU_TO_LOOPBACK_MAPPER_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    /* EGF_SHT Tables */
    {PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_SHT_EGRESS_EPORT_E, PRV_CPSS_DXCH_UNIT_EGF_SHT_E,
    {0x02200000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_EGF_SHT_EGRESS_EPORT_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_SHT_DEVICE_MAP_TABLE_E, PRV_CPSS_DXCH_UNIT_EGF_SHT_E,
    {0x02100000, 0x4, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION_TABLE_VLAN_EGRESS_E, PRV_CPSS_DXCH_UNIT_EGF_SHT_E,
    {0x03000000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_EGF_SHT_EGRESS_VLAN_BITS_SIZE_CNS) , PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_SHT_VLAN_ATTRIBUTES_E, PRV_CPSS_DXCH_UNIT_EGF_SHT_E,
    {0x03400000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_EGF_SHT_EGRESS_VLAN_ATTRIBUTES_BITS_SIZE_CNS) , PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_SHT_VLAN_SPANNING_E, PRV_CPSS_DXCH_UNIT_EGF_SHT_E,
    {0x03440000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_EGF_SHT_EGRESS_VLAN_SPANNING_BITS_SIZE_CNS) , PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_SHT_VLAN_MAPPER_E, PRV_CPSS_DXCH_UNIT_EGF_SHT_E,
    {0x02110000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_EGF_SHT_EGRESS_VLAN_MAPPER_BITS_SIZE_CNS) , PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_TABLE_MULTICAST_E, PRV_CPSS_DXCH_UNIT_EGF_SHT_E,
    {0x020C0000, BITS_TO_BYTES_ALIGNMENT_MAC(BMP_256_PORTS_CNS) , PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION_TABLE_STG_EGRESS_E, PRV_CPSS_DXCH_UNIT_EGF_SHT_E,
    {0x02040000, BITS_TO_BYTES_ALIGNMENT_MAC(BMP_256_PORTS_CNS) , PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION_TABLE_PORT_ISOLATION_L2_E, PRV_CPSS_DXCH_UNIT_EGF_SHT_E,
    {0x00000000, BITS_TO_BYTES_ALIGNMENT_MAC(BMP_256_PORTS_CNS) , PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION_TABLE_PORT_ISOLATION_L3_E, PRV_CPSS_DXCH_UNIT_EGF_SHT_E,
    {0x04000000, BITS_TO_BYTES_ALIGNMENT_MAC(BMP_256_PORTS_CNS) , PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION_TABLE_TXQ_SOURCE_ID_MEMBERS_E, PRV_CPSS_DXCH_UNIT_EGF_SHT_E,
    {0x02080000, BITS_TO_BYTES_ALIGNMENT_MAC(BMP_256_PORTS_CNS) , PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION_TABLE_TXQ_NON_TRUNK_MEMBERS_E, PRV_CPSS_DXCH_UNIT_EGF_SHT_E,
    {0x020E0000, BITS_TO_BYTES_ALIGNMENT_MAC(BMP_256_PORTS_CNS) , PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_SHT_NON_TRUNK_MEMBERS2_E, PRV_CPSS_DXCH_UNIT_EGF_SHT_E,
    {0x02060000, BITS_TO_BYTES_ALIGNMENT_MAC(BMP_256_PORTS_CNS) , PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_SHT_EPORT_FILTER_E, PRV_CPSS_DXCH_UNIT_EGF_SHT_E,
    {0x020A0000, BITS_TO_BYTES_ALIGNMENT_MAC(BMP_256_PORTS_CNS) , PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION_TABLE_TXQ_DESIGNATED_PORT_E, PRV_CPSS_DXCH_UNIT_EGF_SHT_E,
    {0x02120000, BITS_TO_BYTES_ALIGNMENT_MAC(BMP_256_PORTS_CNS) , PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    /* HA Tables */
    {PRV_CPSS_DXCH_LION3_TABLE_HA_EGRESS_EPORT_1_E, PRV_CPSS_DXCH_UNIT_HA_E,
    {0x00100000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_HA_EGRESS_EPORT_1_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_HA_EGRESS_EPORT_2_E, PRV_CPSS_DXCH_UNIT_HA_E,
    {0x00030000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_HA_EGRESS_EPORT_2_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_HA_PHYSICAL_PORT_1_E, PRV_CPSS_DXCH_UNIT_HA_E,
    {0x00001000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_HA_EGRESS_PHYSICAL_PORT_1_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_HA_PHYSICAL_PORT_2_E, PRV_CPSS_DXCH_UNIT_HA_E,
    {0x00002000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_HA_EGRESS_PHYSICAL_PORT_2_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_HA_QOS_PROFILE_TO_EXP_E, PRV_CPSS_DXCH_UNIT_HA_E,
    {0x00004000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_HA_QOS_PROFILE_TO_EXP_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_HA_EPCL_UDB_CONFIG_E, PRV_CPSS_DXCH_UNIT_HA_E,
    {0x00060000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_HA_EPCL_UDB_CONFIG_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_HA_PTP_DOMAIN_E, PRV_CPSS_DXCH_UNIT_HA_E,
    {0x00040000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_HA_PTP_DOMAIN_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_HA_GENERIC_TS_PROFILE_E, PRV_CPSS_DXCH_UNIT_HA_E,
    {0x00050000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_HA_GEN_TS_PROFILE_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_HA_GLOBAL_MAC_SA_E, PRV_CPSS_DXCH_UNIT_HA_E,
    {0x00003000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_HA_GLOBAL_MAC_SA_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH2_TABLE_TUNNEL_START_CONFIG_E, PRV_CPSS_DXCH_UNIT_HA_E,
    {0x00200000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_HA_TUNNEL_START_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH3_TABLE_EGRESS_VLAN_TRANSLATION_E, PRV_CPSS_DXCH_UNIT_HA_E,
    {0x00010000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_HA_EGRESS_VLAN_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_TABLE_ROUTE_HA_MAC_SA_E, PRV_CPSS_DXCH_UNIT_HA_E,
    {0x00020000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_HA_EGRESS_VLAN_MAC_SA_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},


    /* MLL Tables */
    {PRV_CPSS_DXCH_LION3_TABLE_IP_MLL_E, PRV_CPSS_DXCH_UNIT_MLL_E,
    {0x00080000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_MLL_ENTRY_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},
    ...
    {0x00040000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_L2_MLL_LTT_ENTRY_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    /*IPCL tables */
    {PRV_CPSS_DXCH_TABLE_PCL_CONFIG_E, PRV_CPSS_DXCH_UNIT_PCL_E ,/* table for first lookup */
    {0x00010000,BITS_TO_BYTES_ALIGNMENT_MAC(LION3_PCL_PCL_CONFIG_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_XCAT2_TABLE_INGRESS_PCL_LOOKUP01_CONFIG_E, PRV_CPSS_DXCH_UNIT_PCL_E ,  /* table for second lookup  */
    {0x00020000,BITS_TO_BYTES_ALIGNMENT_MAC(LION3_PCL_PCL_CONFIG_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_XCAT_TABLE_INGRESS_PCL_LOOKUP1_CONFIG_E, PRV_CPSS_DXCH_UNIT_PCL_E ,  /* table for third lookup */
    {0x00030000,BITS_TO_BYTES_ALIGNMENT_MAC(LION3_PCL_PCL_CONFIG_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION_TABLE_TRUNK_HASH_MASK_CRC_E, PRV_CPSS_DXCH_UNIT_PCL_E ,
    {0x00000C00 , BITS_TO_BYTES_ALIGNMENT_MAC(LION3_PCL_TRUNK_HASH_MASK_CRC_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_IPCL0_UDB_SELECT_E, PRV_CPSS_DXCH_UNIT_PCL_E ,
    {0x00040000 , BITS_TO_BYTES_ALIGNMENT_MAC(LION3_IPCL_UDB_SELECT_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_IPCL1_UDB_SELECT_E, PRV_CPSS_DXCH_UNIT_PCL_E ,
    {0x00042000 , BITS_TO_BYTES_ALIGNMENT_MAC(LION3_IPCL_UDB_SELECT_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_IPCL2_UDB_SELECT_E, PRV_CPSS_DXCH_UNIT_PCL_E ,
    {0x00044000 , BITS_TO_BYTES_ALIGNMENT_MAC(LION3_IPCL_UDB_SELECT_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TCAM_PCL_TTI_ACTION_E, PRV_CPSS_DXCH_UNIT_TCAM_E ,
    {0x00200000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TCAM_PCL_TTI_ACTION_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_ERMRK_TIMESTAMP_CFG_E, PRV_CPSS_DXCH_UNIT_ERMRK_E ,
    {0x00005000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_ERMRK_TIMESTAMP_CFG_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_ERMRK_PTP_LOCAL_ACTION_E, PRV_CPSS_DXCH_UNIT_ERMRK_E ,
    {0x00100000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_ERMRK_PTP_LOCAL_ACTION_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_ERMRK_PTP_TARGET_PORT_E, PRV_CPSS_DXCH_UNIT_ERMRK_E ,
    {0x00200000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_ERMRK_PTP_TARGET_PORT_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_ERMRK_PTP_SOURCE_PORT_E, PRV_CPSS_DXCH_UNIT_ERMRK_E ,
    {0x00300000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_ERMRK_PTP_SOURCE_PORT_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_ERMRK_QOS_DSCP_MAP_E, PRV_CPSS_DXCH_UNIT_ERMRK_E ,
    {0x00003000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_ERMRK_QOS_DSCP_MAP_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_ERMRK_QOS_TC_DP_MAP_E, PRV_CPSS_DXCH_UNIT_ERMRK_E ,
    {0x00003300, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_ERMRK_QOS_TC_DP_MAP_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},


    {PRV_CPSS_DXCH_LION3_TABLE_TCAM_E, PRV_CPSS_DXCH_UNIT_TCAM_E ,
    {0x00000000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TCAM_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    /* TRILL Tables */
    {PRV_CPSS_DXCH_LION3_TABLE_ADJACENCY_E, PRV_CPSS_DXCH_UNIT_TTI_E,
    /* PRV_CPSS_DXCH_LION3_TABLE_ADJACENCY_E */
    {0x00290000, 0x20, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_RBID_E, PRV_CPSS_DXCH_UNIT_TTI_E,
    {0x00080000, 0x4, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    /* Policer Tables */
    {PRV_CPSS_DXCH_LION3_TABLE_INGRESS_POLICER_0_E_ATTRIBUTES_E, PRV_CPSS_DXCH_UNIT_IPLR_E,
    {0x10000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_IPVX_POLICER_E_ATTRIBUTES_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_INGRESS_POLICER_0_REMARKING_E, PRV_CPSS_DXCH_UNIT_IPLR_E,
    {0x80000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_IPVX_POLICER_REMARKING_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_INGRESS_POLICER_0_HIERARCHICAL_E, PRV_CPSS_DXCH_UNIT_IPLR_E,
    {0x90000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_IPVX_POLICER_HIERARCHICAL_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_INGRESS_POLICER_0_METERING_E, PRV_CPSS_DXCH_UNIT_IPLR_E,
    {0x100000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_IPVX_POLICER_METERING_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},
    ...
    {0x00200000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_IPVX_ROUTER_EPORT_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_IPVX_EVLAN_E, PRV_CPSS_DXCH_UNIT_IPVX_E,
    /* PRV_CPSS_DXCH_LION3_TABLE_IPVX_EVLAN_E */
    {0x00100000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_IPVX_ROUTER_EVLAN_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_IPVX_ROUTER_NEXTHOP_E, PRV_CPSS_DXCH_UNIT_IPVX_E,
    /* PRV_CPSS_DXCH_LION3_TABLE_IPVX_ROUTER_NEXTHOP_E */
    {0x00400000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_IPVX_ROUTER_NEXTHOP_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},
    ...
    {0x00020000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_IPVX_ROUTER_NEXTHOP_AGE_BITS_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},
    ...
    {0x00060000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_IPVX_ROUTER_ACCESS_MATRIX_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},
    ...
    {0x00010000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_IPVX_ROUTER_QOS_PROFILE_OFFSETS_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_INGRESS_OAM_E, PRV_CPSS_DXCH_UNIT_IOAM_E,
    /* PRV_CPSS_DXCH_LION3_TABLE_INGRESS_OAM_E */
    {0x00070000, 0x10, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},
    ...
    {0x00000C00, 0x4, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},
    ...
    {0x00010000, 0x4, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},
    ...
    {0x00018000, 0x4, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},
    ...
    {0x00020000, 0x4, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},
    ...
    {0x00028000, 0x4, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},
    ...
    {0x00030000, 0x4, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},
    ...
    {0x00038000, 0x4, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},
    ...
    {0x00040000, 0x4, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},
    ...
    {0x00060000, 0x8, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},
    ...
    {0x00002000, 0x4, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TTI_QOS_MAP_DSCP_TO_QOS_PROFILE_E, PRV_CPSS_DXCH_UNIT_TTI_E,
    {0x00000800, 0x80, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TTI_QOS_MAP_UP_CFI_TO_QOS_PROFILE_E, PRV_CPSS_DXCH_UNIT_TTI_E,
    {0x00000E00, 0x20, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TTI_QOS_MAP_EXP_TO_QOS_PROFILE_E, PRV_CPSS_DXCH_UNIT_TTI_E,
    {0x00000700, 0x10, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TTI_QOS_MAP_DSCP_TO_DSCP_E, PRV_CPSS_DXCH_UNIT_TTI_E,
    {0x00000400, 0x40, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TTI_UDB_CONFIG_E, PRV_CPSS_DXCH_UNIT_TTI_E,
    {0x00040000, 0x40, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TTI_PTP_COMMAND_E, PRV_CPSS_DXCH_UNIT_TTI_E,
    {0x00004000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TTI_PTP_COMMAND_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    /* EPCL unit */
    {PRV_CPSS_DXCH2_TABLE_EGRESS_PCL_CONFIG_E, PRV_CPSS_DXCH_UNIT_EPCL_E,
    {0x00008000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_EPCL_PCL_CONFIG_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},


    {PRV_CPSS_DXCH_LION3_TABLE_EPCL_UDB_SELECT_E, PRV_CPSS_DXCH_UNIT_EPCL_E,
    {0x00010000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_EPCL_UDB_SELECT_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    /* BMA unit */
    {PRV_CPSS_DXCH_LION3_TABLE_BMA_PORT_MAPPING_E, PRV_CPSS_DXCH_UNIT_BMA_E,
    {0x0001A000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_BMA_PORT_MAPPING_BIT_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_BMA_MULTICAST_COUNTERS_E, PRV_CPSS_DXCH_UNIT_BMA_E,
    {0x00000000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_BMA_MULTICAST_COUNTERS_BIT_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    /* Tail Drop Tables */
    {PRV_CPSS_DXCH_LION3_TABLE_TAIL_DROP_MAX_QUEUE_LIMITS_E, PRV_CPSS_DXCH_UNIT_TXQ_QUEUE_E,
    {0x000A1000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TAIL_DROP_MAX_QUEUE_LIMITS_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TAIL_DROP_EQ_QUEUE_LIMITS_DP0_E, PRV_CPSS_DXCH_UNIT_TXQ_QUEUE_E,
    {0x000A1800, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TAIL_DROP_EQ_QUEUE_LIMITS_DP0_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TAIL_DROP_DQ_QUEUE_BUF_LIMITS_E, PRV_CPSS_DXCH_UNIT_TXQ_QUEUE_E,
    {0x000A2000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TAIL_DROP_DQ_QUEUE_BUF_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TAIL_DROP_DQ_QUEUE_DESC_LIMITS_E, PRV_CPSS_DXCH_UNIT_TXQ_QUEUE_E,
    {0x000A2800, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TAIL_DROP_DQ_QUEUE_DESC_LIMITS_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TAIL_DROP_EQ_QUEUE_LIMITS_DP1_E, PRV_CPSS_DXCH_UNIT_TXQ_QUEUE_E,
    {0x000A3000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TAIL_DROP_EQ_QUEUE_LIMITS_DP1_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TAIL_DROP_EQ_QUEUE_LIMITS_DP2_E, PRV_CPSS_DXCH_UNIT_TXQ_QUEUE_E,
    {0x000A3400, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TAIL_DROP_EQ_QUEUE_LIMITS_DP2_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TAIL_DROP_COUNTERS_Q_MAIN_BUFF_E, PRV_CPSS_DXCH_UNIT_TXQ_QUEUE_E,
    {0x000A7000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TAIL_DROP_COUNTERS_MAIN_BUFF_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TAIL_DROP_COUNTERS_Q_MAIN_MC_BUFF_E, PRV_CPSS_DXCH_UNIT_TXQ_QUEUE_E,
    {0x000A8000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TAIL_DROP_COUNTERS_MAIN_MC_BUFF_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TXQ_LINK_LIST_COUNTERS_Q_MAIN_DESC_E, PRV_CPSS_DXCH_UNIT_TXQ_LL_E,
    {0x0008C000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TXQ_LINK_LIST_COUNTERS_MAIN_DESC_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_PFC_MODE_PROFILE_TC_XOFF_THRESHOLDS_E, PRV_CPSS_DXCH_UNIT_TXQ_PFC_E,
    {0x00001800, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_PFC_MODE_PROFILE_TC_XOFF_THRESHOLDS_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_PFC_MODE_PROFILE_TC_XON_THRESHOLDS_E, PRV_CPSS_DXCH_UNIT_TXQ_PFC_E,
    {0x00001A00, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_PFC_MODE_PROFILE_TC_XON_THRESHOLDS_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_PFC_LLFC_COUNTERS_E, PRV_CPSS_DXCH_UNIT_TXQ_PFC_E,
    {0x00002000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_PFC_LLFC_COUNTERS_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TM_DROP_DROP_MASKING_E, PRV_CPSS_DXCH_UNIT_TM_DROP_E,
    {0x00001000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TM_DROP_DROP_MASKING_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TM_DROP_QUEUE_PROFILE_ID_E, PRV_CPSS_DXCH_UNIT_TM_DROP_E,
    {0x00010000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TM_DROP_QUEUE_PROFILE_ID_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TM_QMAP_CPU_CODE_TO_TC_E, PRV_CPSS_DXCH_UNIT_TM_QMAP_E,
    {0x00001000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TM_QMAP_CPU_CODE_TO_TC_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TM_QMAP_TARGET_DEV_TO_INDEX_E, PRV_CPSS_DXCH_UNIT_TM_QMAP_E,
    {0x00010000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TM_QMAP_TARGET_DEV_TO_INDEX_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TM_QMAP_POLICING_ENABLE_E, PRV_CPSS_DXCH_UNIT_TM_QMAP_E,
    {0x00020000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TM_QMAP_TM_QMAP_POLICING_ENABLE_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TM_QMAP_QUEUE_ID_SELECTOR_E, PRV_CPSS_DXCH_UNIT_TM_QMAP_E,
    {0x00030000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TM_QMAP_QUEUE_ID_SELECTOR_BITS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TM_INGR_GLUE_L1_PKT_LEN_OFFSET_E, PRV_CPSS_DXCH_UNIT_TM_INGRESS_GLUE_E,
    {0x00001000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TM_INGR_GLUE_L1_PKT_LEN_OFFSET_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TM_EGR_GLUE_AGING_QUEUE_PROFILE_E, PRV_CPSS_DXCH_UNIT_TM_EGRESS_GLUE_E,
    {0x00004000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TM_EGR_GLUE_AGING_QUEUE_PROFILE_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TM_EGR_GLUE_AGING_PROFILE_THESHOLDS_E, PRV_CPSS_DXCH_UNIT_TM_EGRESS_GLUE_E,
    {0x00006000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TM_EGR_GLUE_AGING_PROFILE_THESHOLDS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TM_EGR_GLUE_TARGET_INTERFACE_E, PRV_CPSS_DXCH_UNIT_TM_EGRESS_GLUE_E,
    {0x00006200, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TM_EGR_GLUE_TARGET_INTERFACE_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TM_FCU_ETH_DMA_TO_TM_PORT_MAPPING_E, PRV_CPSS_DXCH_UNIT_TM_FCU_E,
    {0x00000500, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TM_FCU_ETH_DMA_TO_TM_PORT_MAPPING_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TM_FCU_ILK_DMA_TO_TM_PORT_MAPPING_E, PRV_CPSS_DXCH_UNIT_TM_FCU_E,
    {0x00000700, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TM_FCU_ILK_DMA_TO_TM_PORT_MAPPING_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TM_FCU_TC_PORT_TO_CNODE_PORT_MAPPING_E, PRV_CPSS_DXCH_UNIT_TM_FCU_E,
    {0x00001000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TM_FCU_TC_PORT_TO_CNODE_PORT_MAPPING_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TM_FCU_PORT_INGRESS_TIMERS_CONFIG_E, PRV_CPSS_DXCH_UNIT_TM_FCU_E,
    {0x00003000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TM_FCU_PORT_INGRESS_TIMERS_CONFIG_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TM_FCU_INGRESS_TIMERS_E, PRV_CPSS_DXCH_UNIT_TM_FCU_E,
    {0x00008000, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TM_FCU_INGRESS_TIMERS_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},

    {PRV_CPSS_DXCH_LION3_TABLE_TM_FCU_PORT_TO_PHYSICAL_PORT_MAPPING_E, PRV_CPSS_DXCH_UNIT_TM_FCU_E,
    {0x0000100, BITS_TO_BYTES_ALIGNMENT_MAC(LION3_TM_FCU_PORT_TO_PHYSICAL_PORT_MAPPING_SIZE_CNS), PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}}
};
...
static PRV_CPSS_DXCH_TABLES_INFO_DIRECT_UNIT_STC directAccessBobcat2TableInfo[] =
{
    ...
    {PRV_CPSS_DXCH_LION3_TABLE_ADJACENCY_E, PRV_CPSS_DXCH_UNIT_TTI_E,
    /* PRV_CPSS_DXCH_LION3_TABLE_ADJACENCY_E */
    {0x01000000 + 0x00290000, 0x20, PRV_CPSS_DXCH_DEFAULT_NEXT_WORD_OFFSET_CNS}},
...
static GT_U32   directAccessLion3TableInfoNumEntries =
    NUM_ELEMENTS_IN_ARR_MAC(directAccessLion3TableInfo);
...
/* lion  3 table*/
static PRV_CPSS_DXCH_TABLES_INFO_STC lion3TablesInfo[PRV_CPSS_DXCH_LION3_TABLE_LAST_E] =
{
    {0}
    /* in runtime the tables of the lion2 will be copied here ,
       and will be updated by the relevant lion 3 code -->
       see lion3InitTable() */
...
/* lion 3 */
static const GT_U32 lion3TableInfoSize = PRV_CPSS_DXCH_LION3_TABLE_LAST_E;
/* bobcat 2 table*/
...
static TABLE_NUM_ENTRIES_INFO_STC   sip5_20tableNumEntriesInfoArr[] =
{
    ...
    ,{PRV_CPSS_DXCH_LION3_TABLE_BRIDGE_PHYSICAL_PORT_RATE_LIMIT_COUNTERS_E,
        ENTRY_TYPE_PHY_PORT_E,0,0}
    ,{PRV_CPSS_DXCH_LION_TABLE_STG_INGRESS_E,
        ENTRY_TYPE_STG_E,2,0}/*2 STGs per entry (each support 256 ports * 2 bits)*/
    ,{PRV_CPSS_DXCH_LION3_TABLE_INGRESS_SPAN_STATE_GROUP_INDEX_E,
        ENTRY_TYPE_EVLAN_E,0,0}
    ,{PRV_CPSS_DXCH_LION3_TABLE_INGRESS_BRIDGE_PORT_MEMBERS_E,
        ENTRY_TYPE_EVLAN_E,2,0}/*2 vlans per entry*/
    ,{PRV_CPSS_DXCH_LION_TABLE_VLAN_INGRESS_E,
        ENTRY_TYPE_EVLAN_E,0,0}
    ...
    ,{PRV_CPSS_DXCH_LION3_TABLE_HA_PTP_DOMAIN_E,
        CPSS_TBD_BOOKMARK_BOBCAT3/* using (*2) factor because we use '256 physical ports' although table uses 512 ports */
        ENTRY_TYPE_PHY_PORT_E , (FRACTION_INDICATION_CNS | (5 * 2)),0} /* each port with 5 domains */
...
static GT_STATUS lion3InitTable(GT_U8 devNum);
...
)
{
    ...
    if(portGroupId == CPSS_PORT_GROUP_UNAWARE_MODE_CNS)
    {
        ...
        GT_BOOL isAdditionalRegDupNeeded;/*GT_TRUE - the caller need to duplicate the value to additional
                            register in all 'port groups bmp'.
                                GT_FALSE - the caller NOT need to duplicate the value to additional register.*/
        GT_U32  additionalRegDup;/* register address of additional register duplication.
...
)
{
    ...
    else /* Cheetah3 */
    {
        ...
        else if(PRV_CPSS_PP_MAC(devNum)->devFamily == CPSS_PP_FAMILY_DXCH_LION3_E)
        {
            accessTableInfoPtr = lion3TablesInfo;
            accessTableInfoSize = lion3TableInfoSize;
            rc = lion3InitTable(devNum);
            if (rc != GT_OK)
            {
                return rc;
            }
...
*
* DESCRIPTION:
*       init the Bobcat2; Lion3 tables info
*
* INPUTS:
*       devNum  - device number
*
...
*
*******************************************************************************/
static GT_STATUS lion3InitTable
(
     IN GT_U8  devNum
)
{
    ...
    GT_U32  index;
    GT_STATUS rc;
    PRV_CPSS_DXCH_TABLES_INFO_DIRECT_UNIT_STC * currentDirectAccessEntryPtr;
    GT_U32 unitBaseAddr;
    GT_U32 unitIndex;
    GT_U32  *currentAddrPtr;
    GT_U32  numOfIndirectConverts;
    PRV_CPSS_DXCH_TABLES_INFO_INDIRECT_STC *indirectTablePtr[2];
    GT_U32  numOfDirectConverts;
    PRV_CPSS_DXCH_TABLES_INFO_DIRECT_STC * directTablePtr[2];
    static GT_BOOL initLion3TableDone = GT_FALSE;

    static struct FORCE_DIRECT_ACCESS_TABLE_STCT{
        PRV_CPSS_DXCH_TABLE_ENT tableType;
    }forceDirectAccessTablesDb[] = /* tables that are accessed only via DIRECT (no option for indirect !)*/
    {
        /* EQ tables : all are direct access only tables (no option for indirect !)
           oppose to legacy devices that EQ tables needed indirect registers */
         {PRV_CPSS_DXCH_TABLE_STATISTICAL_RATE_LIMIT_E                          }
        ,{PRV_CPSS_DXCH_TABLE_CPU_CODE_E                                         }
        ,{PRV_CPSS_DXCH_TABLE_QOS_PROFILE_E                                      }
        ,{PRV_CPSS_DXCH_XCAT_TABLE_LOGICAL_TARGET_MAPPING_E                      }
    ...
    /* init the static table lion3TablesInfo only once */
    if (initLion3TableDone != GT_FALSE)
    {
        return GT_OK;
    }

    initLion3TableDone = GT_TRUE;
    ...
    /* start by copying the Lion2 info */
    for(ii = 0 ; (ii < lionBTableInfoSize); ii++)
    {
        lion3TablesInfo[ii] = lion2TablesInfo[ii];

        numOfIndirectConverts = 0;
        numOfDirectConverts = 0;

        if(lion3TablesInfo[ii].readAccessType == PRV_CPSS_DXCH_DIRECT_ACCESS_E)
        {
            directTablePtr[numOfDirectConverts] = lion3TablesInfo[ii].readTablePtr;
            numOfDirectConverts++;
        }

        if(lion3TablesInfo[ii].writeAccessType == PRV_CPSS_DXCH_DIRECT_ACCESS_E)
        {
            directTablePtr[numOfDirectConverts] = lion3TablesInfo[ii].writeTablePtr;
            numOfDirectConverts++;
        }

        if(lion3TablesInfo[ii].readAccessType == PRV_CPSS_DXCH_INDIRECT_ACCESS_E)
        {
            indirectTablePtr[numOfIndirectConverts] = lion3TablesInfo[ii].readTablePtr;
            numOfIndirectConverts++;
        }

        if(lion3TablesInfo[ii].writeAccessType == PRV_CPSS_DXCH_INDIRECT_ACCESS_E)
        {
            indirectTablePtr[numOfIndirectConverts] = lion3TablesInfo[ii].writeTablePtr;
            numOfIndirectConverts++;
        }

        if(numOfIndirectConverts == 2 && (indirectTablePtr[0] != indirectTablePtr[1]))
        {
            /* the 'read' and 'write' not refers to the same info.
               so need to convert 2 case */
        }
        else
        if(numOfIndirectConverts > 1)
        {
            /* convert only one : with the first pointer */
            numOfIndirectConverts = 1;
        }

        if(numOfDirectConverts == 2 && (directTablePtr[0] != directTablePtr[1]))
        {
            /* the 'read' and 'write' not refers to the same info.
               so need to convert 2 case */
        }
        else
        if(numOfDirectConverts > 1)
        {
            /* convert only one : with the first pointer */
            numOfDirectConverts = 1;
        }

        for(jj = 0 ; jj < numOfIndirectConverts; jj++)
        {
            rc = convertRegAddrToNewUnitsBaseAddr(devNum,
                &(indirectTablePtr[jj]->controlReg));
            if(rc != GT_OK)
            {
                return rc;
            }
            rc = convertRegAddrToNewUnitsBaseAddr(devNum,
                &(indirectTablePtr[jj]->dataReg));
            if(rc != GT_OK)
            {
                return rc;
            }
        ...
        for(jj = 0 ; jj < numOfDirectConverts; jj++)
        {
            rc = convertRegAddrToNewUnitsBaseAddr(devNum,
                &(directTablePtr[jj]->baseAddress));
            if(rc != GT_OK)
            {
                return rc;
            }
    ...
    /******************************************/
    /* override it with Bobcat2; Caelum; Bobcat3 specific info */
    /******************************************/
    currentDirectAccessEntryPtr = directAccessLion3TableInfo;
    for(ii = 0 ; ii < directAccessLion3TableInfoNumEntries ; ii++,
        currentDirectAccessEntryPtr++)
    {
        if((currentDirectAccessEntryPtr->directAccessInfo.baseAddress ==
            SPECIAL_ADDRESS_NOT_EXISTS_E))
        {
            /* the table not relevant to the device , so need to skip it */
            continue;
        }
        else
        if((currentDirectAccessEntryPtr->directAccessInfo.baseAddress ==
            SPECIAL_ADDRESS_NOT_MODIFIED_E) ||
           (currentDirectAccessEntryPtr->unitIndex == PRV_CPSS_DXCH_UNIT_LAST_E))
        {
            /* no need to modify the entry (same as Lion2 / Lion / xcat2) */

            /* we got Lion2 base address of table ...
               convert it to base address of the current device
            */
            currentAddrPtr = &currentDirectAccessEntryPtr->directAccessInfo.baseAddress;

            rc = convertRegAddrToNewUnitsBaseAddr(devNum,currentAddrPtr);
            if(rc != GT_OK)
            {
                return rc;
            }
        ...
        unitIndex = currentDirectAccessEntryPtr->unitIndex;
        unitBaseAddr =
            prvCpssDxChHwUnitBaseAddrGet(devNum,unitIndex,NULL);

        /* Build absolute unit based address */
        currentDirectAccessEntryPtr->directAccessInfo.baseAddress +=
            unitBaseAddr;

        index = currentDirectAccessEntryPtr->globalIndex;

        lion3TablesInfo[index].readTablePtr =
        lion3TablesInfo[index].writeTablePtr =
            &currentDirectAccessEntryPtr->directAccessInfo;
    }

    /****************************/
    /* update tables for Bobcat2; Caelum; Bobcat3 */
    /****************************/

    /* Tunnel Start and Arp table entry size*/
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH2_TABLE_TUNNEL_START_CONFIG_E];
    tableInfoPtr->maxNumOfEntries = _16K;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_HA_TUNNEL_START_BITS_SIZE_CNS);

    /* update the number of entries in the trunk table */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_TABLE_TRUNK_MEMBERS_E];
    tableInfoPtr->maxNumOfEntries = BIT_11 * 8;/* (11 bits for trunkId) * (8 trunk members) */


    /* update PCL unit - hash mask table (for CRC hashing for trunk) */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_LION_TABLE_TRUNK_HASH_MASK_CRC_E];
    tableInfoPtr->maxNumOfEntries = (BIT_4 + LION3_PCL_NUM_FLOWS_CNS); /* num entries = 4 bit index + 16 'flows' */
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_PCL_TRUNK_HASH_MASK_CRC_BITS_SIZE_CNS);

    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_TABLE_PCL_CONFIG_E];
    tableInfoPtr->maxNumOfEntries = 4352;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_PCL_PCL_CONFIG_BITS_SIZE_CNS);

    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_XCAT2_TABLE_INGRESS_PCL_LOOKUP01_CONFIG_E];
    tableInfoPtr->maxNumOfEntries = 4352;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_PCL_PCL_CONFIG_BITS_SIZE_CNS);

    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_XCAT_TABLE_INGRESS_PCL_LOOKUP1_CONFIG_E];
    tableInfoPtr->maxNumOfEntries = 4352;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_PCL_PCL_CONFIG_BITS_SIZE_CNS);

    /* update EPCL unit */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH2_TABLE_EGRESS_PCL_CONFIG_E];
    tableInfoPtr->maxNumOfEntries = 4352;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_EPCL_PCL_CONFIG_BITS_SIZE_CNS);

    /* update EPCL unit */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_LION3_TABLE_EPCL_UDB_SELECT_E];
    tableInfoPtr->maxNumOfEntries = 96;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_EPCL_UDB_SELECT_BITS_SIZE_CNS);

    /* Update LTT and TT Action table */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH3_LTT_TT_ACTION_E];
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_TTI_ACTION_BITS_SIZE_CNS);/* changed from 5 words to 8 words */

    /* Update ingress VLAN */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_LION_TABLE_VLAN_INGRESS_E];
    tableInfoPtr->maxNumOfEntries = PRV_CPSS_DXCH_PP_HW_MAX_VALUE_OF_VID_MAC(devNum)+1;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_L2I_INGRESS_VLAN_BITS_SIZE_CNS);

    /* Update Ingress Bridge Port Membership table */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_LION3_TABLE_INGRESS_BRIDGE_PORT_MEMBERS_E];
    tableInfoPtr->maxNumOfEntries = PRV_CPSS_DXCH_PP_HW_MAX_VALUE_OF_VID_MAC(devNum)+1;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_L2I_INGRESS_BRIDGE_PORT_MEMBERS_BITS_SIZE_CNS);

    /* Update ingress Span State Group Index Table */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_LION3_TABLE_INGRESS_SPAN_STATE_GROUP_INDEX_E];
    tableInfoPtr->maxNumOfEntries = PRV_CPSS_DXCH_PP_HW_MAX_VALUE_OF_VID_MAC(devNum)+1;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_L2I_INGRESS_SPAN_STATE_GROUP_INDEX_BITS_SIZE_CNS);

    /* Update egress VLAN */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_LION_TABLE_VLAN_EGRESS_E];
    tableInfoPtr->maxNumOfEntries = _8K;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_EGF_SHT_EGRESS_VLAN_BITS_SIZE_CNS);

    /* Update egress VLAN members */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_SHT_VLAN_ATTRIBUTES_E];
    tableInfoPtr->maxNumOfEntries = _8K;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_EGF_SHT_EGRESS_VLAN_ATTRIBUTES_BITS_SIZE_CNS);

    /* Update egress VLAN spanning */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_SHT_VLAN_SPANNING_E];
    tableInfoPtr->maxNumOfEntries = _8K;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_EGF_SHT_EGRESS_VLAN_SPANNING_BITS_SIZE_CNS);

    /* Update egress VLAN mapper */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_SHT_VLAN_MAPPER_E];
    tableInfoPtr->maxNumOfEntries = _8K;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_EGF_SHT_EGRESS_VLAN_MAPPER_BITS_SIZE_CNS);

    /* Update FDB per port group table */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_TABLE_FDB_E];
    tableInfoPtr->maxNumOfEntries = _256K;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_FDB_FDB_BITS_SIZE_CNS);/* changed from 4 words to 5 words */
    /* update the indirect table info */
    ...
    {
        jj = 0;
        indirectTablePtr[jj] = &indirectAccessTableInfo[PRV_CPSS_LION3_FDB_TABLE_INDIRECT_E];
        rc = convertRegAddrToNewUnitsBaseAddr(devNum,
            &(indirectTablePtr[jj]->controlReg));
        if(rc != GT_OK)
        {
    ...
    /* txq non-trunk members table */
    /* this table used only for cascade trunks :
        1. to select target local port when destination is 'byond' the cascade trunk
        2. to source filter the cascade trunk members from flood back to those ports */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_LION_TABLE_TXQ_NON_TRUNK_MEMBERS_E];
    tableInfoPtr->maxNumOfEntries = 256;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(BMP_256_PORTS_CNS);

    /* txq non-trunk members2 table */
    /* this table used for 'regular' trunks (non cascade) to do source filter of
       members to not flood back to the src trunk */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_SHT_NON_TRUNK_MEMBERS2_E];
    tableInfoPtr->maxNumOfEntries = _4K;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(BMP_256_PORTS_CNS);

    /* txq ePort filter table */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_SHT_EPORT_FILTER_E];
    tableInfoPtr->maxNumOfEntries = _4K;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(BMP_256_PORTS_CNS);

   /* txq designated members table */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_LION_TABLE_TXQ_DESIGNATED_PORT_E];
    tableInfoPtr->maxNumOfEntries = 128;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(BMP_256_PORTS_CNS);

     /* txq sourceId members table */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_LION_TABLE_TXQ_SOURCE_ID_MEMBERS_E];
    tableInfoPtr->maxNumOfEntries = _4K;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(BMP_256_PORTS_CNS);

    /* txq DQ unit tables */
    /* txq STC table */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_LION_TABLE_TXQ_EGRESS_STC_E];
    tableInfoPtr->maxNumOfEntries =
                (PRV_CPSS_IS_MULTI_PORT_GROUPS_DEVICE_MAC(devNum) == 0) ?
                  SIP5_SINGLE_PORT_GROUP_TXQ_DQ_PORTS_NUM_CNS :
                  SIP5_MULTI_PORT_GROUP_TXQ_DQ_PORTS_NUM_CNS;

    /* txq per port per queue token buckets */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_LION_TABLE_TXQ_SHAPER_PER_PORT_PER_PRIO_TOKEN_BUCKET_CONFIG_E];
    tableInfoPtr->maxNumOfEntries =
                (PRV_CPSS_IS_MULTI_PORT_GROUPS_DEVICE_MAC(devNum) == 0) ?
                  SIP5_SINGLE_PORT_GROUP_TXQ_DQ_PORTS_NUM_CNS :
                  SIP5_MULTI_PORT_GROUP_TXQ_DQ_PORTS_NUM_CNS;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_PRIO_TOKEN_BUCKET_CONFIGURATION_BITS_SIZE_CNS);

    /* txq per port token buckets */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_LION_TABLE_TXQ_SHAPER_PER_PORT_TOKEN_BUCKET_CONFIG_E];
    tableInfoPtr->maxNumOfEntries =
                (PRV_CPSS_IS_MULTI_PORT_GROUPS_DEVICE_MAC(devNum) == 0) ?
                  SIP5_SINGLE_PORT_GROUP_TXQ_DQ_PORTS_NUM_CNS :
                  SIP5_MULTI_PORT_GROUP_TXQ_DQ_PORTS_NUM_CNS;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_PORT_TOKEN_BUCKET_CONFIGURATION_BITS_SIZE_CNS);

    /* Update Multicast Table */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_TABLE_MULTICAST_E];
    tableInfoPtr->maxNumOfEntries = _4K;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(BMP_256_PORTS_CNS);

    /* ingress STG */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_LION_TABLE_STG_INGRESS_E];
    tableInfoPtr->maxNumOfEntries = PRV_CPSS_DXCH_PP_HW_MAX_VALUE_OF_STG_ID_MAC(devNum)+1;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_L2I_INGRESS_STP_BITS_SIZE_CNS);

     /* egress STG */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_LION_TABLE_STG_EGRESS_E];
    tableInfoPtr->maxNumOfEntries = _4K;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(BMP_256_PORTS_CNS);

    /* port isolation L2 */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_LION_TABLE_PORT_ISOLATION_L2_E];
    tableInfoPtr->maxNumOfEntries = 2176;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(BMP_256_PORTS_CNS);

    /* port isolation L3 */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_LION_TABLE_PORT_ISOLATION_L3_E];
    tableInfoPtr->maxNumOfEntries = 2176;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(BMP_256_PORTS_CNS);

    /* HA- Egress VLAN Table */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH3_TABLE_EGRESS_VLAN_TRANSLATION_E];
    tableInfoPtr->maxNumOfEntries = _64K;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_HA_EGRESS_VLAN_BITS_SIZE_CNS);

    /* HA- Egress VLAN MAC SA Table */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_TABLE_ROUTE_HA_MAC_SA_E];
    tableInfoPtr->maxNumOfEntries = _4K;
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_HA_EGRESS_VLAN_MAC_SA_SIZE_CNS);


    /* TTI Port Protocol eVLAN and QoS Assignment Table */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_TABLE_VLAN_PORT_PROTOCOL_E];
    tableInfoPtr->maxNumOfEntries = PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.tti.numDefaultEports * 16;/*512 * 16 = _8K (16 protocols * 512 default ePorts)*/
    tableInfoPtr->entrySize = 1;/*each line is single word. */

    /* PCL User Defined Bytes Configuration Memory */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_XCAT_TABLE_INGRESS_PCL_UDB_CONFIG_E];
    tableInfoPtr->maxNumOfEntries = 16;
    /*NOTE: must update PCL_UDB_CONFIG_NUM_WORDS_CNS too !!! */
    tableInfoPtr->entrySize = BITS_TO_WORDS_MAC(LION3_TTI_PCL_UDB_BITS_SIZE_CNS);/* changed from 8 words to 18 words */

    /* mac to me registers (in TTI unit) */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH3_TABLE_MAC2ME_E];
    tableInfoPtr->entrySize = 6;/* support 6 words */
    tableInfoPtr->maxNumOfEntries = 128;

    /* QOS profiles table */
    tableInfoPtr = &lion3TablesInfo[PRV_CPSS_DXCH_TABLE_QOS_PROFILE_E];
    tableInfoPtr->maxNumOfEntries = _1K;

    /* NEXT tables are 'DIRECT' (no indirect registers!) */
    for(ii = 0 ; forceDirectAccessTablesDb[ii].tableType != 0xFFFFFFFF ; ii++)
    {
        tableInfoPtr = &lion3TablesInfo[forceDirectAccessTablesDb[ii].tableType];
        tableInfoPtr->readAccessType  = PRV_CPSS_DXCH_DIRECT_ACCESS_E;
        tableInfoPtr->writeAccessType = PRV_CPSS_DXCH_DIRECT_ACCESS_E;
    }

    /****************************/
    /* set new tables for Bobcat2; Caelum; Bobcat3 */
    /****************************/

     /* Physical Port Attribute Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_TTI_PHYSICAL_PORT_ATTRIBUTE_E;
    lion3TablesInfo[ii].maxNumOfEntries = PRV_CPSS_DXCH_PP_HW_MAX_VALUE_OF_PHY_PORT_MAC(devNum)+1;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TTI_PHYSICAL_PORT_BITS_SIZE_CNS);

    /* Pre-TTI Lookup Ingress ePort Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_PRE_TTI_LOOKUP_INGRESS_EPORT_E;
    lion3TablesInfo[ii].maxNumOfEntries = PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.tti.numDefaultEports;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TTI_DEFAULT_PORT_BITS_SIZE_CNS);

    /* Post-TTI Lookup Ingress ePort Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_POST_TTI_LOOKUP_INGRESS_EPORT_E;
    lion3TablesInfo[ii].maxNumOfEntries = PRV_CPSS_DXCH_PP_HW_MAX_VALUE_OF_E_PORT_MAC(devNum)+1;
    lion3TablesInfo[ii].entrySize = 1;

    /* Bridge Ingress ePort Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_BRIDGE_INGRESS_EPORT_E;
    lion3TablesInfo[ii].maxNumOfEntries = PRV_CPSS_DXCH_PP_HW_MAX_VALUE_OF_E_PORT_MAC(devNum)+1;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_L2I_EPORT_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_BRIDGE_INGRESS_EPORT_LEARN_PRIO_E;
    lion3TablesInfo[ii].maxNumOfEntries = (PRV_CPSS_DXCH_PP_HW_MAX_VALUE_OF_E_PORT_MAC(devNum)+1) / 8;/* 8 eports in entry */
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_L2I_EPORT_LEARN_PRIO_BITS_SIZE_CNS);

    /* Bridge Source Trunk Attribute Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_BRIDGE_SOURCE_TRUNK_ATTRIBUTE_E;
    lion3TablesInfo[ii].maxNumOfEntries = (PRV_CPSS_DXCH_PP_HW_MAX_VALUE_OF_TRUNK_ID_MAC(devNum)+1) / 8;/*8 trunks in entry*/
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_L2I_SOURCE_TRUNK_ATTRIBUTE_BITS_SIZE_CNS);

    /* Bridge Ingress physical Port Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_BRIDGE_PHYSICAL_PORT_E;
    lion3TablesInfo[ii].maxNumOfEntries = (PRV_CPSS_DXCH_PP_HW_MAX_VALUE_OF_PHY_PORT_MAC(devNum)+1);
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_L2I_PHYSICAL_PORT_BITS_SIZE_CNS);

    /* Bridge Ingress physical Port rate limit counters Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_BRIDGE_PHYSICAL_PORT_RATE_LIMIT_COUNTERS_E;
    lion3TablesInfo[ii].maxNumOfEntries = (PRV_CPSS_DXCH_PP_HW_MAX_VALUE_OF_PHY_PORT_MAC(devNum)+1);
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_L2I_PHYSICAL_PORT_RATE_LIMIT_COUNTERS_BITS_SIZE_CNS);

    /* ingress stc for physical ports Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_EQ_INGRESS_STC_PHYSICAL_PORT_E;
    lion3TablesInfo[ii].maxNumOfEntries = PRV_CPSS_DXCH_PP_HW_MAX_VALUE_OF_PHY_PORT_MAC(devNum)+1;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_EQ_INGRESS_STC_PHYSICAL_PORT_SIZE_CNS);

    /* ingress mirror for physical ports Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_EQ_INGRESS_MIRROR_PHYSICAL_PORT_E;
    lion3TablesInfo[ii].maxNumOfEntries = (PRV_CPSS_DXCH_PP_HW_MAX_VALUE_OF_PHY_PORT_MAC(devNum)+1) / 8;/* 8 physical ports in entry */
    lion3TablesInfo[ii].entrySize = 1;


    /* trunk LTT Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_EQ_TRUNK_LTT_E;
    lion3TablesInfo[ii].maxNumOfEntries = PRV_CPSS_DXCH_PP_HW_MAX_VALUE_OF_TRUNK_ID_MAC(devNum)+1;
    lion3TablesInfo[ii].entrySize = 1;

    /* EQ Ingress ePort Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_EQ_INGRESS_EPORT_E;
    lion3TablesInfo[ii].maxNumOfEntries = PRV_CPSS_DXCH_PP_HW_MAX_VALUE_OF_E_PORT_MAC(devNum)+1;
    lion3TablesInfo[ii].entrySize = 1;

    /* L2 ECMP LTT Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_EQ_L2_ECMP_LTT_E;
    lion3TablesInfo[ii].maxNumOfEntries = PRV_CPSS_DXCH_PP_HW_MAX_VALUE_OF_E_PORT_MAC(devNum)+1;
    lion3TablesInfo[ii].entrySize = 1;

     /* L2 ECMP Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_EQ_L2_ECMP_E;
    lion3TablesInfo[ii].maxNumOfEntries = _8K;
    lion3TablesInfo[ii].entrySize = 1;

    /* Eport to pysical port target mapping Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_EQ_EPORT_TO_PHYSICAL_PORT_TARGET_MAPPING_E;
    lion3TablesInfo[ii].maxNumOfEntries = PRV_CPSS_DXCH_PP_HW_MAX_VALUE_OF_E_PORT_MAC(devNum)+1;
    lion3TablesInfo[ii].entrySize = 1;

    /* TO_CPU _rate limiter config Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_EQ_TO_CPU_RATE_LIMITER_CONFIG_E;
    lion3TablesInfo[ii].maxNumOfEntries = 256;
    lion3TablesInfo[ii].entrySize = 1;

    /* TX Protection table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_EQ_TX_PROTECTION_E;
    lion3TablesInfo[ii].maxNumOfEntries = 256;
    lion3TablesInfo[ii].entrySize = 1;

    /* ePort to LOC Mapping table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_EQ_EPORT_TO_LOC_MAPPING_E;
    lion3TablesInfo[ii].maxNumOfEntries = _4KB;
    lion3TablesInfo[ii].entrySize = 1;

    /* Protection LOC table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_EQ_PROTECTION_LOC_E;
    lion3TablesInfo[ii].maxNumOfEntries = 64;
    lion3TablesInfo[ii].entrySize = 1;

    /* LPM MEM (RAM) Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_LPM_MEM_E;
    lion3TablesInfo[ii].maxNumOfEntries = 320*_1K;
    lion3TablesInfo[ii].entrySize = 1;

    /* IPv4 VRF Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_IPV4_VRF_E;
    lion3TablesInfo[ii].maxNumOfEntries = _4KB;
    lion3TablesInfo[ii].entrySize = 1;

    /* IPv6 VRF Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_IPV6_VRF_E;
    lion3TablesInfo[ii].maxNumOfEntries = _4KB;
    lion3TablesInfo[ii].entrySize = 1;

    /* FCoE VRF Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_FCOE_VRF_E;
    lion3TablesInfo[ii].maxNumOfEntries = _4KB;
    lion3TablesInfo[ii].entrySize = 1;

    /* ECMP Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_ECMP_E;
    lion3TablesInfo[ii].maxNumOfEntries = 12 * _1KB;
    lion3TablesInfo[ii].entrySize = 1;

    /*Fast Stack Failover Secondary Target Port Table*/
    ii = PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_EFT_FAST_STACK_FAILOVER_SECONDARY_TARGET_PORT_E;
    lion3TablesInfo[ii].maxNumOfEntries = 256;/*entry per src physical port (not mistake --> per src physical port)*/
    lion3TablesInfo[ii].entrySize = 1;

    /* EGF_QAG Egress eVlan Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_QAG_EGRESS_VLAN_E;
    lion3TablesInfo[ii].maxNumOfEntries = _8K;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_EGF_QAG_EGRESS_EVLAN_BITS_SIZE_CNS);

    /* EGF_QAG Egress ePort Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_QAG_EGRESS_EPORT_E;
    lion3TablesInfo[ii].maxNumOfEntries = _8K;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_EGF_QAG_EGRESS_EPORT_BITS_SIZE_CNS);

    /* EGF_QAG Target Port Mapper Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_QAG_TARGET_PORT_MAPPER_E;
    lion3TablesInfo[ii].maxNumOfEntries = 256;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_EGF_QAG_TARGET_PORT_MAPPER_BITS_SIZE_CNS);

    /* EGF_QAG CPU Code To Loopback Mapper Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_QAG_CPU_CODE_TO_LOOPBACK_MAPPER_E;
    lion3TablesInfo[ii].maxNumOfEntries = 256;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_EGF_QAG_CPU_CODE_TO_LOOPBACK_MAPPER_BITS_SIZE_CNS);

    /* EGF_QAG Forward from CPU To Loopback Mapper Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_QAG_FWD_FROM_CPU_TO_LOOPBACK_MAPPER_E;
    lion3TablesInfo[ii].maxNumOfEntries = 256;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_EGF_QAG_FWD_FROM_CPU_TO_LOOPBACK_MAPPER_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_SHT_EGRESS_EPORT_E;
    lion3TablesInfo[ii].maxNumOfEntries = _8K;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_EGF_SHT_EGRESS_EPORT_BITS_SIZE_CNS);

    /* EGF_SHT device map Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_EGRESS_EGF_SHT_DEVICE_MAP_TABLE_E;
    lion3TablesInfo[ii].maxNumOfEntries = _4K;
    lion3TablesInfo[ii].entrySize = 1;

    /* HA - egress ePort Table 1 */
    ii = PRV_CPSS_DXCH_LION3_TABLE_HA_EGRESS_EPORT_1_E;
    lion3TablesInfo[ii].maxNumOfEntries = PRV_CPSS_DXCH_PP_HW_MAX_VALUE_OF_E_PORT_MAC(devNum)+1;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_HA_EGRESS_EPORT_1_BITS_SIZE_CNS);

    /* HA - egress ePort Table 2 */
    ii = PRV_CPSS_DXCH_LION3_TABLE_HA_EGRESS_EPORT_2_E;
    lion3TablesInfo[ii].maxNumOfEntries = PRV_CPSS_DXCH_PP_HW_MAX_VALUE_OF_E_PORT_MAC(devNum)+1;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_HA_EGRESS_EPORT_2_BITS_SIZE_CNS);

    /* HA - Physical port Table 1 */
    ii = PRV_CPSS_DXCH_LION3_TABLE_HA_PHYSICAL_PORT_1_E;
    lion3TablesInfo[ii].maxNumOfEntries = 256;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_HA_EGRESS_PHYSICAL_PORT_1_BITS_SIZE_CNS);

    /* HA - Physical port Table 2 */
    ii = PRV_CPSS_DXCH_LION3_TABLE_HA_PHYSICAL_PORT_2_E;
    lion3TablesInfo[ii].maxNumOfEntries = 256;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_HA_EGRESS_PHYSICAL_PORT_2_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_HA_QOS_PROFILE_TO_EXP_E;
    lion3TablesInfo[ii].maxNumOfEntries = _1K;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_HA_QOS_PROFILE_TO_EXP_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_HA_EPCL_UDB_CONFIG_E;
    lion3TablesInfo[ii].maxNumOfEntries = 16;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_HA_EPCL_UDB_CONFIG_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_HA_PTP_DOMAIN_E;
    lion3TablesInfo[ii].maxNumOfEntries = 1280;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_HA_PTP_DOMAIN_BITS_SIZE_CNS);

    /* HA - Generic Tunnel Start Profile Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_HA_GENERIC_TS_PROFILE_E;
    lion3TablesInfo[ii].maxNumOfEntries = 8;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_HA_GEN_TS_PROFILE_BITS_SIZE_CNS);

    /* HA - Global MAC SA Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_HA_GLOBAL_MAC_SA_E;
    lion3TablesInfo[ii].maxNumOfEntries = 256;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_HA_GLOBAL_MAC_SA_BITS_SIZE_CNS);

    /* IP MLL Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_IP_MLL_E;
    lion3TablesInfo[ii].maxNumOfEntries = _16K;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_MLL_ENTRY_BITS_SIZE_CNS);

    /* L2 MLL Table --> 'the same' info as 'IP MLL'*/
    lion3TablesInfo[PRV_CPSS_DXCH_LION3_TABLE_L2_MLL_E] =
        lion3TablesInfo[PRV_CPSS_DXCH_LION3_TABLE_IP_MLL_E];

    /* L2 MLL LTT Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_L2_MLL_LTT_E;
    lion3TablesInfo[ii].maxNumOfEntries = _32K;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_L2_MLL_LTT_ENTRY_BITS_SIZE_CNS);

    /* ADJACENCY Table - each entry consists of pattern & mask */
    ii = PRV_CPSS_DXCH_LION3_TABLE_ADJACENCY_E;
    lion3TablesInfo[ii].maxNumOfEntries = PRV_CPSS_DXCH_MAX_NUM_ADJACENCY_CNS;
    lion3TablesInfo[ii].entrySize = 8;

    /* RBID Table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_RBID_E;
    lion3TablesInfo[ii].maxNumOfEntries = _64K;
    lion3TablesInfo[ii].entrySize = 1;

    /* Policer Tables */
    ii = PRV_CPSS_DXCH_LION3_TABLE_INGRESS_POLICER_0_E_ATTRIBUTES_E;
    lion3TablesInfo[ii].maxNumOfEntries = 8192;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_IPVX_POLICER_E_ATTRIBUTES_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_INGRESS_POLICER_0_REMARKING_E;
    lion3TablesInfo[ii].maxNumOfEntries = 1024;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_IPVX_POLICER_REMARKING_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_INGRESS_POLICER_0_HIERARCHICAL_E;
    lion3TablesInfo[ii].maxNumOfEntries = 8192;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_IPVX_POLICER_HIERARCHICAL_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_INGRESS_POLICER_0_METERING_E;
    lion3TablesInfo[ii].maxNumOfEntries = 8192;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_IPVX_POLICER_METERING_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_INGRESS_POLICER_1_E_ATTRIBUTES_E;
    lion3TablesInfo[ii].maxNumOfEntries = 8192;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_IPVX_POLICER_E_ATTRIBUTES_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_INGRESS_POLICER_1_REMARKING_E;
    lion3TablesInfo[ii].maxNumOfEntries = 1024;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_IPVX_POLICER_REMARKING_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_INGRESS_POLICER_1_METERING_E;
    lion3TablesInfo[ii].maxNumOfEntries = 8192;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_IPVX_POLICER_METERING_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_EGRESS_POLICER_E_ATTRIBUTES_E;
    lion3TablesInfo[ii].maxNumOfEntries = 8192;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_IPVX_POLICER_E_ATTRIBUTES_BITS_SIZE_CNS);
    ...
    ii = PRV_CPSS_DXCH_LION3_TABLE_EGRESS_POLICER_METERING_E;
    lion3TablesInfo[ii].maxNumOfEntries = 8192;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_IPVX_POLICER_METERING_BITS_SIZE_CNS);

    /* IPvX Tables */
    ii = PRV_CPSS_DXCH_LION3_TABLE_IPVX_INGRESS_EPORT_E;
    lion3TablesInfo[ii].maxNumOfEntries = 512;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_IPVX_ROUTER_EPORT_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_IPVX_EVLAN_E;
    lion3TablesInfo[ii].maxNumOfEntries = _8K;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_IPVX_ROUTER_EVLAN_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_IPVX_ROUTER_NEXTHOP_E;
    lion3TablesInfo[ii].maxNumOfEntries = _24K;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_IPVX_ROUTER_NEXTHOP_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_IPVX_ROUTER_NEXTHOP_AGE_BITS_E;
    lion3TablesInfo[ii].maxNumOfEntries = 768;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_IPVX_ROUTER_NEXTHOP_AGE_BITS_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_IPVX_ROUTER_ACCESS_MATRIX_E;
    lion3TablesInfo[ii].maxNumOfEntries = 192;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_IPVX_ROUTER_ACCESS_MATRIX_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_IPVX_ROUTER_QOS_PROFILE_OFFSETS_E;
    lion3TablesInfo[ii].maxNumOfEntries = 256;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_IPVX_ROUTER_QOS_PROFILE_OFFSETS_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_INGRESS_OAM_E;
    lion3TablesInfo[ii].maxNumOfEntries = _2K;
    lion3TablesInfo[ii].entrySize = 3;
    lion3TablesInfo[ii].writeAccessType = PRV_CPSS_DXCH_INDIRECT_ACCESS_E;
    lion3TablesInfo[ii].readAccessType = PRV_CPSS_DXCH_INDIRECT_ACCESS_E;
    lion3TablesInfo[ii].writeTablePtr =
    lion3TablesInfo[ii].readTablePtr =
        indirectAccessTableInfo + PRV_CPSS_LION3_IOAM_TABLE_INDIRECT_E;

    ii = PRV_CPSS_DXCH_LION3_TABLE_INGRESS_OAM_KEEPALIVE_AGING_E;
    lion3TablesInfo[ii].maxNumOfEntries = 64;
    lion3TablesInfo[ii].entrySize = 1;

    ii = PRV_CPSS_DXCH_LION3_TABLE_INGRESS_OAM_MEG_EXCEPTION_E;
    lion3TablesInfo[ii].maxNumOfEntries = 64;
    lion3TablesInfo[ii].entrySize = 1;

    ii = PRV_CPSS_DXCH_LION3_TABLE_INGRESS_OAM_SOURCE_INTERFACE_EXCEPTION_E;
    lion3TablesInfo[ii].maxNumOfEntries = 64;
    lion3TablesInfo[ii].entrySize = 1;

    ii = PRV_CPSS_DXCH_LION3_TABLE_INGRESS_OAM_INVALID_KEEPALIVE_HASH_E;
    lion3TablesInfo[ii].maxNumOfEntries = 64;
    lion3TablesInfo[ii].entrySize = 1;

    ii = PRV_CPSS_DXCH_LION3_TABLE_INGRESS_OAM_KEEPALIVE_EXCESS_E;
    lion3TablesInfo[ii].maxNumOfEntries = 64;
    lion3TablesInfo[ii].entrySize = 1;

    ii = PRV_CPSS_DXCH_LION3_TABLE_INGRESS_OAM_EXCEPTION_SUMMARY_E;
    lion3TablesInfo[ii].maxNumOfEntries = 64;
    lion3TablesInfo[ii].entrySize = 1;

    ii = PRV_CPSS_DXCH_LION3_TABLE_INGRESS_OAM_RDI_STATUS_CHANGE_EXCEPTION_E;
    lion3TablesInfo[ii].maxNumOfEntries = 64;
    lion3TablesInfo[ii].entrySize = 1;

    ii = PRV_CPSS_DXCH_LION3_TABLE_INGRESS_OAM_TX_PERIOD_EXCEPTION_E;
    lion3TablesInfo[ii].maxNumOfEntries = 64;
    lion3TablesInfo[ii].entrySize = 1;

    ii = PRV_CPSS_DXCH_LION3_TABLE_INGRESS_OAM_OPCODE_PACKET_COMMAND_E;
    lion3TablesInfo[ii].maxNumOfEntries = 256;
    lion3TablesInfo[ii].entrySize = 2;

    ii = PRV_CPSS_DXCH_LION3_TABLE_EGRESS_OAM_E;
    lion3TablesInfo[ii].maxNumOfEntries = _2K;
    lion3TablesInfo[ii].entrySize = 3;
    lion3TablesInfo[ii].writeAccessType = PRV_CPSS_DXCH_INDIRECT_ACCESS_E;
    lion3TablesInfo[ii].readAccessType = PRV_CPSS_DXCH_INDIRECT_ACCESS_E;
    ...
    ii = PRV_CPSS_DXCH_LION3_TABLE_EGRESS_OAM_KEEPALIVE_AGING_E;
    lion3TablesInfo[ii].maxNumOfEntries = 64;
    lion3TablesInfo[ii].entrySize = 1;

    ii = PRV_CPSS_DXCH_LION3_TABLE_EGRESS_OAM_MEG_EXCEPTION_E;
    lion3TablesInfo[ii].maxNumOfEntries = 64;
    lion3TablesInfo[ii].entrySize = 1;

    ii = PRV_CPSS_DXCH_LION3_TABLE_EGRESS_OAM_SOURCE_INTERFACE_EXCEPTION_E;
    lion3TablesInfo[ii].maxNumOfEntries = 64;
    lion3TablesInfo[ii].entrySize = 1;

    ii = PRV_CPSS_DXCH_LION3_TABLE_EGRESS_OAM_INVALID_KEEPALIVE_HASH_E;
    lion3TablesInfo[ii].maxNumOfEntries = 64;
    lion3TablesInfo[ii].entrySize = 1;

    ii = PRV_CPSS_DXCH_LION3_TABLE_EGRESS_OAM_KEEPALIVE_EXCESS_E;
    lion3TablesInfo[ii].maxNumOfEntries = 64;
    lion3TablesInfo[ii].entrySize = 1;

    ii = PRV_CPSS_DXCH_LION3_TABLE_EGRESS_OAM_EXCEPTION_SUMMARY_E;
    lion3TablesInfo[ii].maxNumOfEntries = 64;
    lion3TablesInfo[ii].entrySize = 1;

    ii = PRV_CPSS_DXCH_LION3_TABLE_EGRESS_OAM_RDI_STATUS_CHANGE_EXCEPTION_E;
    lion3TablesInfo[ii].maxNumOfEntries = 64;
    lion3TablesInfo[ii].entrySize = 1;

    ii = PRV_CPSS_DXCH_LION3_TABLE_EGRESS_OAM_TX_PERIOD_EXCEPTION_E;
    lion3TablesInfo[ii].maxNumOfEntries = 64;
    lion3TablesInfo[ii].entrySize = 1;

    ii = PRV_CPSS_DXCH_LION3_TABLE_EGRESS_OAM_OPCODE_PACKET_COMMAND_E;
    lion3TablesInfo[ii].maxNumOfEntries = 256;
    lion3TablesInfo[ii].entrySize = 2;

    ii = PRV_CPSS_DXCH_LION3_TABLE_OAM_LM_OFFSET_E;
    lion3TablesInfo[ii].maxNumOfEntries = 128;
    lion3TablesInfo[ii].entrySize = 1;

    ii = PRV_CPSS_DXCH_LION3_TABLE_TTI_QOS_MAP_DSCP_TO_QOS_PROFILE_E;
    lion3TablesInfo[ii].maxNumOfEntries = 12;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(640);

    ii = PRV_CPSS_DXCH_LION3_TABLE_TTI_QOS_MAP_UP_CFI_TO_QOS_PROFILE_E;
    lion3TablesInfo[ii].maxNumOfEntries = 12;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(160);

    ii = PRV_CPSS_DXCH_LION3_TABLE_TTI_QOS_MAP_EXP_TO_QOS_PROFILE_E;
    lion3TablesInfo[ii].maxNumOfEntries = 12;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(80);

    ii = PRV_CPSS_DXCH_LION3_TABLE_TTI_QOS_MAP_DSCP_TO_DSCP_E;
    lion3TablesInfo[ii].maxNumOfEntries = 12;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(384);

    /* TTI User Defined Bytes Configuration table */
    ii = PRV_CPSS_DXCH_LION3_TABLE_TTI_UDB_CONFIG_E;
    lion3TablesInfo[ii].maxNumOfEntries = 20;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(330);

    ii = PRV_CPSS_DXCH_LION3_TABLE_TTI_PTP_COMMAND_E;
    lion3TablesInfo[ii].maxNumOfEntries = 256;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TTI_PTP_COMMAND_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_IPCL0_UDB_SELECT_E;
    lion3TablesInfo[ii].maxNumOfEntries = 96;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_IPCL_UDB_SELECT_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_IPCL1_UDB_SELECT_E;
    lion3TablesInfo[ii].maxNumOfEntries = 96;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_IPCL_UDB_SELECT_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_IPCL2_UDB_SELECT_E;
    lion3TablesInfo[ii].maxNumOfEntries = 96;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_IPCL_UDB_SELECT_BITS_SIZE_CNS);


    ii = PRV_CPSS_DXCH_LION3_TABLE_TCAM_PCL_TTI_ACTION_E;
    lion3TablesInfo[ii].maxNumOfEntries = 49152;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TCAM_PCL_TTI_ACTION_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_ERMRK_TIMESTAMP_CFG_E;
    lion3TablesInfo[ii].maxNumOfEntries = 128;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_ERMRK_TIMESTAMP_CFG_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_ERMRK_PTP_LOCAL_ACTION_E;
    lion3TablesInfo[ii].maxNumOfEntries = 32768;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_ERMRK_PTP_LOCAL_ACTION_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_ERMRK_PTP_TARGET_PORT_E;
    lion3TablesInfo[ii].maxNumOfEntries = 16384;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_ERMRK_PTP_TARGET_PORT_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_ERMRK_PTP_SOURCE_PORT_E;
    lion3TablesInfo[ii].maxNumOfEntries = 16384;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_ERMRK_PTP_SOURCE_PORT_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_ERMRK_QOS_DSCP_MAP_E;
    lion3TablesInfo[ii].maxNumOfEntries = 192;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_ERMRK_QOS_DSCP_MAP_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_ERMRK_QOS_TC_DP_MAP_E;
    lion3TablesInfo[ii].maxNumOfEntries = 192;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_ERMRK_QOS_TC_DP_MAP_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_TCAM_E;
    lion3TablesInfo[ii].maxNumOfEntries = 98304;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TCAM_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_BMA_PORT_MAPPING_E;
    lion3TablesInfo[ii].maxNumOfEntries = 256;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_BMA_PORT_MAPPING_BIT_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_BMA_MULTICAST_COUNTERS_E;
    lion3TablesInfo[ii].maxNumOfEntries = 8192;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_BMA_MULTICAST_COUNTERS_BIT_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_TAIL_DROP_MAX_QUEUE_LIMITS_E;
    lion3TablesInfo[ii].maxNumOfEntries = 128;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TAIL_DROP_MAX_QUEUE_LIMITS_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_TAIL_DROP_EQ_QUEUE_LIMITS_DP0_E;
    lion3TablesInfo[ii].maxNumOfEntries = 128;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TAIL_DROP_EQ_QUEUE_LIMITS_DP0_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_TAIL_DROP_DQ_QUEUE_BUF_LIMITS_E;
    lion3TablesInfo[ii].maxNumOfEntries = 128;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TAIL_DROP_DQ_QUEUE_BUF_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_TAIL_DROP_DQ_QUEUE_DESC_LIMITS_E;
    lion3TablesInfo[ii].maxNumOfEntries = 128;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TAIL_DROP_DQ_QUEUE_DESC_LIMITS_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_TAIL_DROP_EQ_QUEUE_LIMITS_DP1_E;
    lion3TablesInfo[ii].maxNumOfEntries = 128;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TAIL_DROP_EQ_QUEUE_LIMITS_DP1_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_TAIL_DROP_EQ_QUEUE_LIMITS_DP2_E;
    lion3TablesInfo[ii].maxNumOfEntries = 128;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TAIL_DROP_EQ_QUEUE_LIMITS_DP2_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_TAIL_DROP_COUNTERS_Q_MAIN_BUFF_E;
    lion3TablesInfo[ii].maxNumOfEntries = 576;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TAIL_DROP_COUNTERS_MAIN_BUFF_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_TAIL_DROP_COUNTERS_Q_MAIN_MC_BUFF_E;
    lion3TablesInfo[ii].maxNumOfEntries = 576;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TAIL_DROP_COUNTERS_MAIN_MC_BUFF_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_TXQ_LINK_LIST_COUNTERS_Q_MAIN_DESC_E;
    lion3TablesInfo[ii].maxNumOfEntries = 576;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TXQ_LINK_LIST_COUNTERS_MAIN_DESC_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_PFC_MODE_PROFILE_TC_XOFF_THRESHOLDS_E;
    lion3TablesInfo[ii].maxNumOfEntries = 64;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_PFC_MODE_PROFILE_TC_XOFF_THRESHOLDS_BITS_SIZE_CNS);

    ii = PRV_CPSS_DXCH_LION3_TABLE_PFC_MODE_PROFILE_TC_XON_THRESHOLDS_E;
    lion3TablesInfo[ii].maxNumOfEntries = 64;
    lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_PFC_MODE_PROFILE_TC_XON_THRESHOLDS_BITS_SIZE_CNS);

    /* init the Bobcat2 only units */
    if (PRV_CPSS_DXCH_PP_MAC(devNum)->genInfo.devFamily
        != CPSS_PP_FAMILY_DXCH_LION3_E)
    {
        ii = PRV_CPSS_DXCH_LION3_TABLE_TM_DROP_DROP_MASKING_E;
        lion3TablesInfo[ii].maxNumOfEntries = 128;
        lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TM_DROP_DROP_MASKING_BITS_SIZE_CNS);

        ii = PRV_CPSS_DXCH_LION3_TABLE_TM_DROP_QUEUE_PROFILE_ID_E;
        lion3TablesInfo[ii].maxNumOfEntries = 1024;
        lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TM_DROP_QUEUE_PROFILE_ID_BITS_SIZE_CNS);

        ii = PRV_CPSS_DXCH_LION3_TABLE_TM_QMAP_CPU_CODE_TO_TC_E;
        lion3TablesInfo[ii].maxNumOfEntries = 256;
        lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TM_QMAP_CPU_CODE_TO_TC_BITS_SIZE_CNS);

        ii = PRV_CPSS_DXCH_LION3_TABLE_TM_QMAP_TARGET_DEV_TO_INDEX_E;
        lion3TablesInfo[ii].maxNumOfEntries = 1024;
        lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TM_QMAP_TARGET_DEV_TO_INDEX_BITS_SIZE_CNS);

        ii = PRV_CPSS_DXCH_LION3_TABLE_TM_QMAP_POLICING_ENABLE_E;
        lion3TablesInfo[ii].maxNumOfEntries = 1024;
        lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TM_QMAP_TM_QMAP_POLICING_ENABLE_BITS_SIZE_CNS);

        ii = PRV_CPSS_DXCH_LION3_TABLE_TM_QMAP_QUEUE_ID_SELECTOR_E;
        lion3TablesInfo[ii].maxNumOfEntries = 256;
        lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TM_QMAP_QUEUE_ID_SELECTOR_BITS_SIZE_CNS);

        ii = PRV_CPSS_DXCH_LION3_TABLE_TM_INGR_GLUE_L1_PKT_LEN_OFFSET_E;
        lion3TablesInfo[ii].maxNumOfEntries = 64;
        lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TM_INGR_GLUE_L1_PKT_LEN_OFFSET_SIZE_CNS);

        ii = PRV_CPSS_DXCH_LION3_TABLE_TM_EGR_GLUE_AGING_QUEUE_PROFILE_E;
        lion3TablesInfo[ii].maxNumOfEntries = 1024;
        lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TM_EGR_GLUE_AGING_QUEUE_PROFILE_SIZE_CNS);

        ii = PRV_CPSS_DXCH_LION3_TABLE_TM_EGR_GLUE_AGING_PROFILE_THESHOLDS_E;
        lion3TablesInfo[ii].maxNumOfEntries = 16;
        lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TM_EGR_GLUE_AGING_PROFILE_THESHOLDS_SIZE_CNS);

        ii = PRV_CPSS_DXCH_LION3_TABLE_TM_EGR_GLUE_TARGET_INTERFACE_E;
        lion3TablesInfo[ii].maxNumOfEntries = 64;
        lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TM_EGR_GLUE_TARGET_INTERFACE_SIZE_CNS);

        ii = PRV_CPSS_DXCH_LION3_TABLE_TM_FCU_ETH_DMA_TO_TM_PORT_MAPPING_E;
        lion3TablesInfo[ii].maxNumOfEntries = 32;
        lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TM_FCU_ETH_DMA_TO_TM_PORT_MAPPING_SIZE_CNS);

        ii = PRV_CPSS_DXCH_LION3_TABLE_TM_FCU_ILK_DMA_TO_TM_PORT_MAPPING_E;
        lion3TablesInfo[ii].maxNumOfEntries = 32;
        lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TM_FCU_ILK_DMA_TO_TM_PORT_MAPPING_SIZE_CNS);

        ii = PRV_CPSS_DXCH_LION3_TABLE_TM_FCU_TC_PORT_TO_CNODE_PORT_MAPPING_E;
        lion3TablesInfo[ii].maxNumOfEntries = 64;
        lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TM_FCU_TC_PORT_TO_CNODE_PORT_MAPPING_SIZE_CNS);

        ii = PRV_CPSS_DXCH_LION3_TABLE_TM_FCU_PORT_INGRESS_TIMERS_CONFIG_E;
        lion3TablesInfo[ii].maxNumOfEntries = 64;
        lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TM_FCU_PORT_INGRESS_TIMERS_CONFIG_SIZE_CNS);

        ii = PRV_CPSS_DXCH_LION3_TABLE_TM_FCU_INGRESS_TIMERS_E;
        lion3TablesInfo[ii].maxNumOfEntries = 64;
        lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TM_FCU_INGRESS_TIMERS_SIZE_CNS);

        ii = PRV_CPSS_DXCH_LION3_TABLE_TM_FCU_PORT_TO_PHYSICAL_PORT_MAPPING_E;
        lion3TablesInfo[ii].maxNumOfEntries = 64 / 4; /* 64 fcu pfc ports / 4 ports in Register */
        lion3TablesInfo[ii].entrySize = BITS_TO_WORDS_MAC(LION3_TM_FCU_PORT_TO_PHYSICAL_PORT_MAPPING_SIZE_CNS);
    }
    else
    {
        /*Lion3 - tables not present*/
        ii = PRV_CPSS_DXCH_LION3_TABLE_TM_DROP_DROP_MASKING_E;
        lion3TablesInfo[ii].maxNumOfEntries = 0;
        ...
        if(numOfEntries)/* check that the table is valid */
        {
            ...
            else
            {
                ...
                if(numEntriesInfo[ii].divider > 1)
                {
                    ...
                    numOfEntries /= numEntriesInfo[ii].divider;
                }
            }
...
)
{
    ...
    char *device[] = {"Lion3", "Bobcat2", "xCat3", "xCat","Bobcat3"};    /* Bobcat2, Caelum, Bobcat3, xCat3 or xCat device name */
    ...
    if (PRV_CPSS_PP_MAC(devNum)->devFamily == CPSS_PP_FAMILY_DXCH_LION3_E)
    {
        directAccessTableInfoPtr = directAccessLion3TableInfo;
        tableInfoPtr = lion3TablesInfo;
        ii = 0;
...
)
{
    ...
    if(numEntriesPerLine & FRACTION_INDICATION_CNS)
    {
        /* the entry from the caller is taking more that single line */
