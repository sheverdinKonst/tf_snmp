...
)
{
    ...
    {
        rc = prvCpssDrvHwPpSetRegField(devNum,regAddr ,0 ,15 ,ecmpIndexBaseEport);
    }
    else
    {
        rc = prvCpssDrvHwPpSetRegField(devNum,regAddr ,0 ,13 ,ecmpIndexBaseEport);
    }
...
)
{
    ...
    if(PRV_CPSS_SIP_5_10_CHECK_MAC(devNum))
    {
        rc = prvCpssDrvHwPpGetRegField(devNum,regAddr ,0 ,15 ,&hwData);
    }
    else
    {
