...
)
{
    ...
    else
    {
        ...
        rc = prvCpssDrvHwPpPortGroupSetRegField(devNum, portGroupId,regAddr, 12, 1, value);
    }
...
)
{
    ...
    if(PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_SUPPORTED_MAC(devNum) == GT_TRUE)
    {
        ...
        return prvCpssDrvHwPpSetRegField(devNum, regAddr, 6, 3, value);
    }
...
)
{
    ...
    if(PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_SUPPORTED_MAC(devNum) == GT_TRUE)
    {
        ...
        rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, 6, 3, &value);
        if(rc != GT_OK)
        {
            return rc;
        }
...
)
{
    ...
    if(PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_SUPPORTED_MAC(devNum) == GT_TRUE)
    {
        ...
        return prvCpssDrvHwPpSetRegField(devNum, regAddr, 9, 3, value);
    }
...
)
{
    ...
    /* Bridge Global Configuration Register0, field <DropNonIPMcEn> */
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, 26, 1, &value);
    if(GT_OK != rc)
    {
        return rc;
    }
...
)
{
    ...
    if(PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_SUPPORTED_MAC(devNum) == GT_TRUE)
    {
        ...
        rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, 0, 3, &value);
        if(rc != GT_OK)
        {
            return rc;
        }
...
)
{
    ...
    else
    {
        ...
        rc = prvCpssDrvHwPpPortGroupSetRegField(devNum, portGroupId,regAddr, 1, 1, value);
    }
...
)
{
    ...
    else
    {
        ...
        /* Ingress Port<n> Bridge Configuration Register0, field <UcLocalEn> */
        rc = prvCpssDrvHwPpPortGroupGetRegField(devNum, portGroupId,regAddr, 1, 1, &value);
    }
    if(rc != GT_OK)
    {
        return rc;
...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, offset, 2, value);
}
...
)
{
    ...
    /* Bridge Global Configuration Register0, <IGMPMode> */
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, offset, 2, &value);
    if(rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    if(PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_SUPPORTED_MAC(devNum) == GT_TRUE)
    {
        ...
        return prvCpssDrvHwPpSetRegField(devNum, regAddr, 15, 3, value);
...
)
{
    ...
    if(PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_SUPPORTED_MAC(devNum) == GT_TRUE)
    {
        ...
        rc =  prvCpssDrvHwPpGetRegField(devNum, regAddr, 15, 3, &value);
        if(GT_OK != rc)
        {
            return rc;
        }
...
)
{
    ...
    else
    {
        ...
        {
            CPSS_TBD_BOOKMARK_EARCH
            /* need to add support for 8 profiles */

            /* lion3; Bobcat2 devices supports only 8 profiles */
            if (profileIndex >= 8)
                return GT_BAD_PARAM;
        }
        else
...
)
{
    ...
    value = BOOL2BIT_MAC(enable);
        ...
        rc = prvCpssDrvHwPpPortGroupSetRegField(devNum, portGroupId,regAddr, 14, 1, value);
...
)
{
    ...
    if(PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_SUPPORTED_MAC(devNum) == GT_TRUE)
    {
        ...
        rc = prvCpssDrvHwPpSetRegField(devNum, regAddr, field, 3, value);
        if (rc != GT_OK)
        {
            return rc;
        }
...
)
{
    ...
    if(PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_SUPPORTED_MAC(devNum) == GT_TRUE)
    {
        ...
        /* IPv6 ICMP Command Register <ICMPCmd> */
        rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, field, 3, &value);
        if (rc != GT_OK)
        {
            return rc;
        }
    ...
    /* IPv6 ICMP Message Type Configuration Register<n> <ICMPMsgType<> */
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, field, 8, &value);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, field, bits, value);
}
...
)
{
    ...
    /* IPv4/6 Multicast Link-Local Configuration Register<n> <IPv4MulLinkLocalMirrorEn> */
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, field, bits, &value);
    if(GT_OK != rc)
    {
        return rc;
    }
    ...
    for(pipeId = 0 ; pipeId < numPipes; pipeId++)
    {
        for(regNum = 0; regNum < 4; regNum++)
        {
            ...
            /* IPv6 Solicited-Node Multicast Address Configuration Register
               field  <IPv6SNMCAddr> */
            rc = prvCpssDrvHwPpWriteRegister(devNum, regAddr1[pipeId], regData);
            if (rc != GT_OK)
            {
                return rc;
            }
            ...
            rc = prvCpssDrvHwPpWriteRegister(devNum, regAddr2[pipeId], regData);
            if (rc != GT_OK)
            {
                return rc;
            }
...
)
{
    ...
    for(regNum = 0; regNum < 4; regNum++)
    {
        ...
        /* IPv6 Solicited-Node Multicast Address Configuration Register
           field  <IPv6SNMCAddr> */
        rc = prvCpssDrvHwPpReadRegister(devNum, regAddr1, &regData);
        if (rc != GT_OK)
        {
            return rc;
        }
        ...
        /* IPv6 Solicited-Node Multicast Address Mask Register,
           field <IPv6SNMCAddrMask> */
        rc = prvCpssDrvHwPpReadRegister(devNum, regAddr2, &regData);
        if (rc != GT_OK)
        {
            return rc;
        }
...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, 0, numOfBits, value);
}
...
)
{
    ...
    /* Ingress Rate Limit Configuration Register1,
       fields <10GWindow>, <IngressRateLimitMode>, <IngressRateLimitDropMode> */
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, 0, numOfBits, &value);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, bitIndex, 1, value);
}
...
)
{
    ...
    /* Bridge Global Configuration Register0, field <CustomerBPDUTrapEn> */
    rc = prvCpssDrvHwPpGetRegField(devNum, regAddr, bitIndex, 1, &value);
    if(rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    else
    {
        ...
        rc = prvCpssDrvHwPpPortGroupSetRegField(devNum, portGroupId,regAddr, 13, 1, value);
    }
...
)
{
    ...
    if (profileIndex > 3)
    {
        ...
        rc = prvCpssDrvHwPpPortGroupSetRegField(devNum, portGroupId,regAddr, field, 2, profileIndex);
    }
...
)
{
    ...
    else
    {
        ...
        rc = prvCpssDrvHwPpPortGroupGetRegField(devNum, portGroupId,regAddr, field, 2, &value);
    }
...
)
{
    ...
    CPSS_TBD_BOOKMARK/* the lion3; Bobcat2 support 'per port' configuration and not 'global' configuration */
...
)
{
    ...
    if(PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_ENABLED_MAC(devNum) == GT_TRUE)
    {
        ...
        rc = prvCpssDrvHwPpSetRegField(devNum, regAddrGmii, bitOffset, 1, gmiiSpeed);
        if (rc != GT_OK)
        {
            return rc;
        }
        ...
        rc = prvCpssDrvHwPpSetRegField(devNum, regAddrXg, bitOffset, 1, xgSpeed);
        return rc;
    }
    ...
    {  /* stack port configuration */
        ...
        rc = prvCpssDrvHwPpSetRegField(devNum, regAddrXg, bitOffset, 3, stackValue);
    }
...
)
{
    ...
    if(PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_ENABLED_MAC(devNum) == GT_TRUE)
    {
        ...
        rc = prvCpssDrvHwPpGetRegField(devNum, regAddrXg, bitOffset, 1, &regValue);
        if (rc != GT_OK)
        {
            return rc;
        }
        ...
        rc = prvCpssDrvHwPpGetRegField(devNum, regAddrGmii, bitOffset, 1, &regValue);
        if (rc != GT_OK)
        {
            return rc;
        }
    ...
    {  /* stack port  */
        ...
        rc = prvCpssDrvHwPpGetRegField(devNum, regAddrXg, bitOffset, 3, &regValue);
        if (rc != GT_OK)
        {
            return rc;
        }
...
)
{
    ...
    regAddr = PRV_CPSS_DXCH_DEV_REGS_MAC(devNum)->bridgeRegs.portControl1[portNum];
...
)
{
    ...
    return prvCpssDrvHwPpPortGroupSetRegField(devNum, portGroupId,regAddr, 11, 1, value);
}
}
...
)
{
    ...
    /* Ingress Port<n> Bridge Configuration Register0, <RateLimitDropCount> */
    rc = prvCpssDrvHwPpPortGroupGetRegField(devNum, portGroupId,regAddr, 11, 1, &value);
    }
...
)
{
    ...
    if (!PRV_CPSS_IS_MULTI_PORT_GROUPS_DEVICE_MAC(devNum))
    {
        ...
        rc = prvCpssDrvHwPpWriteRegister(devNum, regAddr0, value.l[0]);
        if (rc != GT_OK)
        {
            return rc;
        }
        ...
        return prvCpssDrvHwPpSetRegField(devNum, regAddr1, 0, 8, value.l[1]);
    }
...
)
{
    ...
    rc = prvCpssDrvHwPpSetRegField(devNum, regAddr, 0, 13, hwData);
    return rc;
}
...
)
{
    ...
    return prvCpssDrvHwPpSetRegField(devNum, regAddr, 0, 14, mtuSize);
}
...
)
{
    ...
    return prvCpssDrvHwPpGetRegField(devNum, regAddr, 0, 14, mtuSizePtr);
}
