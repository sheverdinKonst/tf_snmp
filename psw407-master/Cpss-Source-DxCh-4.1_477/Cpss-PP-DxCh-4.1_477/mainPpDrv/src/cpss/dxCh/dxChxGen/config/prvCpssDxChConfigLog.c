...
)
{
    ...
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, maxNumOfVirtualRouters);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, maxNumOfIpNextHop);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, maxNumOfIpv4Prefixes);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, maxNumOfMll);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, maxNumOfIpv4McEntries);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, maxNumOfIpv6Prefixes);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, maxNumOfTunnelEntries);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, maxNumOfIpv4TunnelTerms);
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_CFG_HW_ACCESS_OBJ_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_CFG_GLOBAL_EPORT_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_CFG_DEV_INFO_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PP_CONFIG_INIT_STC_PTR(contextLib, logType, namePtr, paramVal);
}
