...
static GT_STATUS internal_cpssDxChPortDynamicPizzaArbiterIfWorkConservingModeSet
(
    IN GT_U8                 devNum,
...
)
{
    ...
    rc = internal_cpssDxChPortDynamicPizzaArbiterIfWorkConservingModeSet(devNum, unit, status);
