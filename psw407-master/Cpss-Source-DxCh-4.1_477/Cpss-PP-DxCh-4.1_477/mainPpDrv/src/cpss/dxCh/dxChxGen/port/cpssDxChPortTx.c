...
*                           DxCh3,xCat,xCat3,Lion,xCat2 0..16383; Bobcat2,Lion3 0..0xFFFFF)
...
*       Mode configuration in Bobcat2 and Lion3 performed per profile.
*
*******************************************************************************/
...
*                     (Not applicable for Bobcat2 and Lion3)
...
*
* APPLICABLE DEVICES:
*        xCat; xCat3; xCat2; Bobcat2.
*
* NOT APPLICABLE DEVICES:
*        DxCh1; DxCh1_Diamond; DxCh2; DxCh3; Lion; Lion2; Lion3.
*
* INPUTS:
*       devNum  - physical device number
*       portNum - physical or CPU port number
