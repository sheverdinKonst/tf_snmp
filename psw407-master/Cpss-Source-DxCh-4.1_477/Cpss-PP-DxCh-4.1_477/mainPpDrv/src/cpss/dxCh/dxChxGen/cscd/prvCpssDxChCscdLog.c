...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_CSCD_QOS_TC_DP_REMAP_INDEX_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_CSCD_QOS_TC_REMAP_STC_PTR(contextLib, logType, namePtr, paramVal);
}
