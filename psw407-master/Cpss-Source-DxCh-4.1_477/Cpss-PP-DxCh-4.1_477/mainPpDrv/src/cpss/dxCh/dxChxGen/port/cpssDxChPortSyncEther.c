...
)
{
    ...
    else /* GT_TRUE == enable */
    {
        ...
        {
            maxSerdesNumber = PRV_CPSS_BOBCAT2_SERDES_NUM_CNS;
        }
        else if(CPSS_PP_FAMILY_DXCH_XCAT3_E == PRV_CPSS_PP_MAC(devNum)->devFamily)
        {
            maxSerdesNumber = PRV_CPSS_XCAT3_SERDES_NUM_CNS;
        }
        else
        {
        ...
        for( serdes = 0 ; serdes < maxSerdesNumber ; serdes++ )
        {
            ...
            {
                if((serdes < 20) || (serdes > 21 && (serdes < 24)))
                {
                    continue;
                }
            }
            ...
            {
                if((serdes < 20 && serdes > 11) || (serdes > 21 && (serdes < 24)))
                {
                    continue;
                }
            }
