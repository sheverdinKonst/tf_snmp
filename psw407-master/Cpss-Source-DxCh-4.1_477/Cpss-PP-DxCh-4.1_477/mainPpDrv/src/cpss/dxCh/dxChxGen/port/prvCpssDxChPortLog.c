...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_SERDES_CONFIG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_PORT_TX_TAIL_DROP_WRTD_ENABLERS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_PORT_TX_MC_FIFO_ARBITER_WEIGHTS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_PORT_CNM_GENERATION_CONFIG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_PFC_PROFILE_CONFIG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_EOM_MATRIX_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_PORT_CN_PROFILE_CONFIG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_MAP_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_PIZZA_PORTGROUP_SPEED_TO_SLICENUM_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_TX_SHAPER_CONFIG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_ECN_ENABLERS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_ALIGN90_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_SERDES_TUNE_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_AP_STATUS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_COMBO_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_SERDES_OPERATION_CFG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_STAT_TX_DROP_COUNTERS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_DEV_PIZZA_ARBITER_STATE_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PIZZA_PROFILE_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_PORT_TX_WRTD_MASK_LSB_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_PFC_LOSSY_DROP_CONFIG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_EEE_LPI_STATUS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_SERDES_RX_CONFIG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_MAC_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_AP_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_SERDES_TX_CONFIG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_PORT_CN_SAMPLE_INTERVAL_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_PIP_MAC_DA_CLASSIFICATION_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_PORT_CN_FB_CALCULATION_CONFIG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
PRV_CPSS_LOG_FUNC_PARAM_STC IN_GT_U8_maxDelay = {
     "maxDelay", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U8)
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPortIlknChannelEnableSet_PARAMS[] =  {
    &IN_GT_U8_devNum,
    &IN_GT_PHYSICAL_PORT_NUM_portNum,
    &IN_CPSS_PORT_DIRECTION_ENT_direction,
    &IN_GT_BOOL_enable
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPortSpeedGet_PARAMS[] =  {
    &IN_GT_U8_devNum,
    &IN_GT_PHYSICAL_PORT_NUM_portNum,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPortIlknChannelEnableGet_PARAMS[] =  {
    &IN_GT_U8_devNum,
    &IN_GT_PHYSICAL_PORT_NUM_portNum,
    &IN_CPSS_PORT_DIRECTION_ENT_direction,
    &OUT_GT_BOOL_PTR_enablePtr
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChPortLogLibDb[] = {
    ...
    {"cpssDxChPortIlknChannelEnableSet", 4, cpssDxChPortIlknChannelEnableSet_PARAMS, NULL},
    {"cpssDxChPortIlknChannelEnableGet", 4, cpssDxChPortIlknChannelEnableGet_PARAMS, NULL},
    ...
    {"cpssDxChPortPipGlobalDropCounterGet", 3, cpssDxChPortPipGlobalDropCounterGet_PARAMS, NULL},
    ...
    {"cpssDxChPortSerdesEnhancedAutoTune", 3, cpssDxChPortSerdesEnhancedAutoTune_PARAMS, NULL},
    {"cpssDxChPortSpeedSet", 3, prvCpssLogGenDevNumPortNumSpeed_PARAMS, NULL},
    {"cpssDxChPortSpeedGet", 3, cpssDxChPortSpeedGet_PARAMS, NULL},
