...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_LPM_LEAF_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_LPM_NODE_RANGE_SELECTION_UNT_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_LPM_NODE_NEXT_POINTER_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChLpmLogLibDb[] = {
    {"cpssDxChLpmNodeWrite", 6, cpssDxChLpmNodeWrite_PARAMS, NULL},
    {"cpssDxChLpmNodeRead", 6, cpssDxChLpmNodeRead_PARAMS, NULL},
    {"cpssDxChLpmNodeNextPointersWrite", 4, cpssDxChLpmNodeNextPointersWrite_PARAMS, NULL},
