...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TTI_MAC_TO_ME_SRC_INTERFACE_INFO_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TTI_MAC_VLAN_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TTI_TRILL_ADJACENCY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TTI_RULE_UNT_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TTI_ACTION_UNT_PTR(contextLib, logType, namePtr, paramVal);
}
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChTtiLogLibDb[] = {
    ...
    {"cpssDxChTtiRuleSet", 7, cpssDxChTtiRuleSet_PARAMS, NULL},
    {"cpssDxChTtiRuleGet", 7, cpssDxChTtiRuleGet_PARAMS, NULL},
    {"cpssDxChTtiRuleActionUpdate", 4, cpssDxChTtiRuleActionUpdate_PARAMS, NULL},
    ...
    {"cpssDxChTtiPortGroupRuleSet", 8, cpssDxChTtiPortGroupRuleSet_PARAMS, NULL},
    {"cpssDxChTtiPortGroupRuleGet", 8, cpssDxChTtiPortGroupRuleGet_PARAMS, NULL},
    {"cpssDxChTtiPortGroupRuleActionUpdate", 5, cpssDxChTtiPortGroupRuleActionUpdate_PARAMS, NULL},
