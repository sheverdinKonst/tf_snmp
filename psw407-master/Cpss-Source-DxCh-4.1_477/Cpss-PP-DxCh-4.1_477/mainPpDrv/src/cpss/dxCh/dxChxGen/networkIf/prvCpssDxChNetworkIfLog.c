...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_NET_TX_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_NET_CPU_CODE_TABLE_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_NET_DSA_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_NET_SDMA_RX_COUNTERS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_NET_RX_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_NETIF_MII_INIT_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChNetIfMiiRxPacketGet_PARAMS[] =  {
    ...
    &OUT_GT_U8_PTR_PTR_packetBuffsArrPtr,
    &OUT_GT_U32_PTR_buffLenArr,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChNetIfSdmaTxPacketSend_PARAMS[] =  {
    ...
    &IN_GT_U8_PTR_PTR_buffList,
    &IN_GT_U32_PTR_buffLenList,
    &IN_GT_U32_numOfBufs
};
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChNetIfMiiTxPacketSend_PARAMS[] =  {
    &IN_GT_U8_devNum,
    &IN_CPSS_DXCH_NET_TX_PARAMS_STC_PTR_pcktParamsPtr,
    &IN_GT_U8_PTR_PTR_packetBuffsArrPtr,
    &IN_GT_U32_PTR_buffLenArr,
    &IN_GT_U32_numOfBufs
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChNetIfRxBufFreeWithSize_PARAMS[] =  {
    &IN_GT_U8_devNum,
    &IN_GT_U8_rxQueue,
    &IN_GT_U8_PTR_PTR_rxBuffList,
    &IN_GT_U32_PTR_rxBuffSizeList,
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChNetworkIfLogLibDb[] = {
    ...
    {"cpssDxChNetIfMiiTxPacketSend", 5, cpssDxChNetIfMiiTxPacketSend_PARAMS, NULL},
    {"cpssDxChNetIfMiiSyncTxPacketSend", 5, cpssDxChNetIfMiiTxPacketSend_PARAMS, NULL},
    {"cpssDxChNetIfMiiTxBufferQueueGet", 5, cpssDxChNetIfMiiTxBufferQueueGet_PARAMS, NULL},
    {"cpssDxChNetIfMiiRxPacketGet", 6, cpssDxChNetIfMiiRxPacketGet_PARAMS, NULL},
    {"cpssDxChNetIfMiiRxBufFree", 4, cpssDxChNetIfMiiRxBufFree_PARAMS, NULL},
    {"cpssDxChNetIfMiiInit", 2, cpssDxChNetIfMiiInit_PARAMS, NULL},
    {"cpssDxChNetIfRxBufFree", 4, cpssDxChNetIfMiiRxBufFree_PARAMS, NULL},
    {"cpssDxChNetIfRxBufFreeWithSize", 5, cpssDxChNetIfRxBufFreeWithSize_PARAMS, NULL},
    {"cpssDxChNetIfSdmaRxPacketGet", 6, cpssDxChNetIfMiiRxPacketGet_PARAMS, NULL},
    ...
    {"cpssDxChNetIfSdmaTxPacketSend", 5, cpssDxChNetIfSdmaTxPacketSend_PARAMS, NULL},
    {"cpssDxChNetIfSdmaSyncTxPacketSend", 5, cpssDxChNetIfSdmaTxPacketSend_PARAMS, NULL},
    ...
    {"cpssDxChNetIfSdmaTxGeneratorPacketAdd", 6, cpssDxChNetIfSdmaTxGeneratorPacketAdd_PARAMS, NULL},
    {"cpssDxChNetIfSdmaTxGeneratorPacketUpdate", 6, cpssDxChNetIfSdmaTxGeneratorPacketUpdate_PARAMS, NULL},
