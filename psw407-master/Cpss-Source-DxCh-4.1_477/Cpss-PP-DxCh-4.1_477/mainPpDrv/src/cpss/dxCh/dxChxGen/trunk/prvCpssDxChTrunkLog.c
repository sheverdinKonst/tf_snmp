...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TRUNK_LBH_INPUT_DATA_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TRUNK_LBH_CRC_MASK_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_MULTI_PORT_GROUP_SRC_PORT_HASH_PAIR_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChTrunkLogLibDb[] = {
    ...
    {"cpssDxChTrunkTableEntrySet", 4, cpssDxChTrunkTableEntrySet_PARAMS, NULL},
    {"cpssDxChTrunkTableEntryGet", 4, cpssDxChTrunkTableEntryGet_PARAMS, NULL},
    ...
    {"cpssDxChTrunkDbEnabledMembersGet", 4, cpssDxChTrunkDbEnabledMembersGet_PARAMS, NULL},
    {"cpssDxChTrunkDbDisabledMembersGet", 4, cpssDxChTrunkDbDisabledMembersGet_PARAMS, NULL},
    ...
    {"cpssDxChTrunkMembersSet", 6, cpssDxChTrunkMembersSet_PARAMS, NULL},
    ...
    {"cpssDxChTrunkCascadeTrunkWithWeightedPortsSet", 4, cpssDxChTrunkCascadeTrunkWithWeightedPortsSet_PARAMS, NULL},
    {"cpssDxChTrunkCascadeTrunkWithWeightedPortsGet", 4, cpssDxChTrunkCascadeTrunkWithWeightedPortsGet_PARAMS, NULL},
