...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_L2_MLL_PAIR_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_L2_MLL_LTT_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_L2MLL_COUNTER_SET_INTERFACE_CFG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_L2_MLL_EXCEPTION_COUNTERS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
