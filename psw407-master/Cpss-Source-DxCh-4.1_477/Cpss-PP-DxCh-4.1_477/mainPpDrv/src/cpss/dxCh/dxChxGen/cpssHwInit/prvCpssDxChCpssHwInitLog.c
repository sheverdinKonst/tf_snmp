...
)
{
    ...
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, enableEarchSupport);
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_LED_CLASS_CONF_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_LED_GROUP_CONF_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_ADDR_DECODE_WINDOW_CONFIG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PP_PHASE2_INIT_INFO_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_PP_PHASE1_INIT_INFO_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChHwPpImplementWaInit_PARAMS[] =  {
    ...
    &IN_GT_U32_PTR_additionalInfoBmpArr
};
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChCpssHwInitLogLibDb[] = {
    ...
    {"cpssDxChHwPpStartInit", 4, cpssDxChHwPpStartInit_PARAMS, NULL},
    {"cpssDxChHwPpImplementWaInit", 4, cpssDxChHwPpImplementWaInit_PARAMS, NULL},
