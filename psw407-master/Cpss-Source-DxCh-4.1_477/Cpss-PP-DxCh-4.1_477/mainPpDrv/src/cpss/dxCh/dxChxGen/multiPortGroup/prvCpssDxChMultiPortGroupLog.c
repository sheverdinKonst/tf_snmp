...
)
{
    ...
    PRV_CPSS_LOG_STC_PTR_MAC(valPtr, ringPortsPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, trunkIdNum);
    PRV_CPSS_LOG_STC_PTR_MAC(valPtr, trunkIdPtr);
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_MULTI_PORT_GROUP_LOOKUP_NOT_FOUND_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_MULTI_PORT_GROUP_RING_INFO_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChMultiPortGroupConfigSet_PARAMS[] =  {
    ...
    &IN_GT_PORT_NUM_PTR_uplinkPortsArr,
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChMultiPortGroupLogLibDb[] = {
    {"cpssDxChMultiPortGroupConfigSet", 5, cpssDxChMultiPortGroupConfigSet_PARAMS, NULL},
    {"cpssDxChMultiPortGroupTrunkSrcPortHashMappingSet", 5, cpssDxChMultiPortGroupTrunkSrcPortHashMappingSet_PARAMS, NULL},
