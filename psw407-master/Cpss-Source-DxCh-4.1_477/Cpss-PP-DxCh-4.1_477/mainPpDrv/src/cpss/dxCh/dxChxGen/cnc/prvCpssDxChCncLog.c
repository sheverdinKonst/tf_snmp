...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_CNC_COUNTER_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_CNC_COUNTER_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChCncPortGroupCounterWraparoundIndexesGet_PARAMS[] =  {
    ...
    &OUT_GT_U32_PTR_portGroupIdArr,
    &OUT_GT_U32_PTR_indexesArr
};
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChCncLogLibDb[] = {
    ...
    {"cpssDxChCncCounterWraparoundIndexesGet", 4, cpssDxChCncCounterWraparoundIndexesGet_PARAMS, NULL},
    ...
    {"cpssDxChCncUploadedBlockGet", 4, cpssDxChCncUploadedBlockGet_PARAMS, NULL},
    ...
    {"cpssDxChCncPortGroupCounterWraparoundIndexesGet", 6, cpssDxChCncPortGroupCounterWraparoundIndexesGet_PARAMS, NULL},
    ...
    {"cpssDxChCncPortGroupUploadedBlockGet", 5, cpssDxChCncPortGroupUploadedBlockGet_PARAMS, NULL},
