...
/*Lion3 : compare ingress to egress*/
...
/*Lion3 : convert ingress to egress*/
...
)
{
    ...
    CPSS_PORTS_BMP_STC egressPortsMembers;/* LION3; Bobcat2 : bmp of ports for egress */
    GT_U32  i;
    ...
    if(PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_ENABLED_MAC(dev) == GT_TRUE)
    {
        ...
        for(/* continue port */ ; port < 256 ; port++)
        {
