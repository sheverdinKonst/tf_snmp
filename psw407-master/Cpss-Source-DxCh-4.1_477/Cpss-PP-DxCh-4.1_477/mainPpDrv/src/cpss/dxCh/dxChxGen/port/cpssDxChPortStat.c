...
#define IS_MIB_API_SW_EMULATED_MAC(_devNum,_portNum)                              \
     (((PRV_CPSS_PP_MAC(_devNum)->devFamily == CPSS_PP_FAMILY_DXCH_LION_E) &&     \
      ...
      (((PRV_CPSS_PP_MAC(_devNum)->devFamily == CPSS_PP_FAMILY_DXCH_LION2_E) ||   \
        (PRV_CPSS_PP_MAC(_devNum)->devFamily == CPSS_PP_FAMILY_DXCH_LION3_E) ||   \
...
)
{
    ...
    GT_U32                      portGroupId; /*the port group Id - support multi-port-groups device */
    PRV_CPSS_DXCH_PORT_MAP_SHADOW_STC *portMapShadowPtr; /* pointer to mapping shadow DB */
...
)
{
    ...
    CPSS_TBD_BOOKMARK_EARCH /* Lion3 support should be added - loop on all TXQ units*/
