...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_BRG_VLAN_INFO_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_BRG_GEN_RATE_LIMIT_PORT_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_BRG_L2_ECMP_LTT_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_BRIDGE_HOST_CNTR_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_BRG_FDB_HASH_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_BRG_VLAN_PROT_CLASS_CFG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_BRG_L2_ECMP_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_BRG_VLAN_PORTS_TAG_CMD_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_BRG_GEN_RATE_LIMIT_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_BRG_EGRESS_PORT_INFO_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_BRG_QOS_PROT_CLASS_CFG_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChBrgFdbHashCrcMultiResultsByParamsCalc_PARAMS[] =  {
    ...
    &OUT_GT_U32_PTR_crcMultiHashArr
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChBrgStpEntryGet_PARAMS[] =  {
    &IN_GT_U8_dev,
    &IN_GT_U16_stpId,
    &OUT_GT_U32_PTR_stpEntryWordArr
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChBrgMcIpv6BytesSelectGet_PARAMS[] =  {
    &IN_GT_U8_devNum,
    &OUT_GT_U8_PTR_dipBytesSelectMapArr,
    &OUT_GT_U8_PTR_sipBytesSelectMapArr
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChBrgMcIpv6BytesSelectSet_PARAMS[] =  {
    &IN_GT_U8_devNum,
    &IN_GT_U8_PTR_dipBytesSelectMapArr,
    &IN_GT_U8_PTR_sipBytesSelectMapArr
};
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChBridgeLogLibDb[] = {
    ...
    {"cpssDxChBrgFdbFuMsgBlockGet", 3, cpssDxChBrgFdbFuMsgBlockGet_PARAMS, NULL},
    {"cpssDxChBrgFdbAuMsgBlockGet", 3, cpssDxChBrgFdbAuMsgBlockGet_PARAMS, NULL},
    {"cpssDxChBrgFdbAuqFuqMessagesNumberGet", 4, cpssDxChBrgFdbAuqFuqMessagesNumberGet_PARAMS, NULL},
    {"cpssDxChBrgFdbSecondaryAuMsgBlockGet", 3, cpssDxChBrgFdbAuMsgBlockGet_PARAMS, NULL},
    ...
    {"cpssDxChBrgMcIpv6BytesSelectSet", 3, cpssDxChBrgMcIpv6BytesSelectSet_PARAMS, NULL},
    {"cpssDxChBrgMcIpv6BytesSelectGet", 3, cpssDxChBrgMcIpv6BytesSelectGet_PARAMS, NULL},
    ...
    {"cpssDxChBrgStpEntryGet", 3, cpssDxChBrgStpEntryGet_PARAMS, NULL},
    {"cpssDxChBrgStpEntryWrite", 3, cpssDxChBrgStpEntryWrite_PARAMS, NULL},
    ...
    {"cpssDxChBrgVlanPortEgressVlanFilteringEnableSet", 3, prvCpssLogGenDevNumPortNumEnable_PARAMS, NULL},
    {"cpssDxChBrgVlanPortEgressVlanFilteringEnableGet", 3, prvCpssLogGenDevNumPortNumEnablePtr_PARAMS, NULL},
    ...
    {"cpssDxChBrgFdbHashCrcMultiResultsCalc", 5, cpssDxChBrgFdbHashCrcMultiResultsCalc_PARAMS, NULL},
    {"cpssDxChBrgFdbHashCrcMultiResultsByParamsCalc", 5, cpssDxChBrgFdbHashCrcMultiResultsByParamsCalc_PARAMS, NULL},
    {"cpssDxChBrgFdbHashRequestSend", 2, cpssDxChBrgFdbHashRequestSend_PARAMS, NULL},
    {"cpssDxChBrgFdbHashResultsGet", 6, cpssDxChBrgFdbHashResultsGet_PARAMS, NULL},
};
