...
*        DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; xCat3; Lion; Lion2; xCat2; Lion3.
*
* INPUTS:
...
)
{
    ...
    for( inf = 1 ; inf < cpssDramCfgPtr->activeInterfaceNum ; inf++ )
    {
...
)
{
    ...
    /* Caelum and Cetus do not support TM yet */
