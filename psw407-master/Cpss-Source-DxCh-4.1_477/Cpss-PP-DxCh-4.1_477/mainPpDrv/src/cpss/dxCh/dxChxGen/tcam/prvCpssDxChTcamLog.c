...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_DXCH_TCAM_BLOCK_INFO_STC_PTR(contextLib, logType, namePtr, paramVal);
}
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChTcamPortGroupRuleWrite_PARAMS[] =  {
    ...
    &IN_GT_U32_PTR_tcamPatternPtr,
    &IN_GT_U32_PTR_tcamMaskPtr
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChTcamPortGroupRuleRead_PARAMS[] =  {
    ...
    &OUT_GT_BOOL_PTR_validPtr,
    &OUT_CPSS_DXCH_TCAM_RULE_SIZE_ENT_PTR_ruleSizePtr,
    &OUT_GT_U32_PTR_tcamPatternPtr,
    &OUT_GT_U32_PTR_tcamMaskPtr
};
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChTcamLogLibDb[] = {
    {"cpssDxChTcamPortGroupRuleWrite", 7, cpssDxChTcamPortGroupRuleWrite_PARAMS, NULL},
    {"cpssDxChTcamPortGroupRuleRead", 7, cpssDxChTcamPortGroupRuleRead_PARAMS, NULL},
    ...
    {"cpssDxChTcamIndexRangeHitNumAndGroupSet", 3, cpssDxChTcamIndexRangeHitNumAndGroupSet_PARAMS, NULL},
    {"cpssDxChTcamIndexRangeHitNumAndGroupGet", 3, cpssDxChTcamIndexRangeHitNumAndGroupGet_PARAMS, NULL},
    ...
    {"cpssDxChTcamPortGroupCpuLookupTriggerSet", 5, cpssDxChTcamPortGroupCpuLookupTriggerSet_PARAMS, NULL},
    {"cpssDxChTcamPortGroupCpuLookupTriggerGet", 5, cpssDxChTcamPortGroupCpuLookupTriggerGet_PARAMS, NULL},
