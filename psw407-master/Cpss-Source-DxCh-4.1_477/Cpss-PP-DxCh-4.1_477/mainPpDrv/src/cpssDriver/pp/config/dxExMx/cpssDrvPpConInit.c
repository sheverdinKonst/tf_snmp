...
#define PORTS_BMP_0_TO_24_56_TO_59_64_TO_71                 \
    {{PORT_RANGE_MAC(0,24),                                 \
      PORT_RANGE_MAC(56,4),                                 \
      PORT_RANGE_MAC(64,8) , 0 }}
...
/* lion3 with port groups 0,1,2,3 */
static const  CPSS_PP_DEVICE_TYPE lion3_port_groups01234567legalDevTypes[] = {CPSS_LION3_PORT_GROUPS_01234567_CNS , END_OF_TABLE };
...
static const PORT_GROUPS_INFO_STC lion3PortGroups =
{
    8 /*numOfPortGroups*/ ,
    PORT_RANGE_MAC(0,12) /*portsBmp*/   ,
    16 /*maxNumPorts*/
...
#define LION3_CNS           CPSS_PP_FAMILY_DXCH_LION3_E
...
}cpssSupportedTypes[] =
{
    ...
    /* Bobcat2; Caelum; Bobcat3 devices */                                             /* active port groups */
    {LION3_CNS ,LION_NUM_PORTS_FROM_LAST_PORT_GROUP_MAC(7) ,lion3_port_groups01234567legalDevTypes, NULL ,&lion3PortGroups,&portGroups01234567bmp},
    ...
    {BOBCAT2_CNS ,72 ,bobkCaelum_legalDevTypes, &portsBmp0to47_56to59_64to71,NULL,NULL},

    /* bobk Cetus : */
    /* actual macs are in : 56..59 (XLG) , 64..71 (XLG) */
    /* there are also 2 TX DMA : 72(cpu),73(TM) */
    /* there is  also 1 RX DMA : 72(cpu) */
    {BOBCAT2_CNS ,72 ,bobkCetus_legalDevTypes,  &portsBmp56to59_64to71      ,NULL,NULL},
...
}cpssSpecialDevicesBmp[] =
{
    ...
    {CPSS_98DX4220_CNS , PORTS_BMP_0_TO_24_56_TO_59_64_TO_71},
    ...
    {CPSS_98DX8208_CNS , {{0, 0, PORT_RANGE_MAC(64,8) , 0 }}},

    /* Caelum MACs : 0..23 , 56..59 , 64..71 */
    {CPSS_98DX4204_CNS , PORTS_BMP_0_TO_24_56_TO_59_64_TO_71},

    /* Caelum MACs : 0..23 , 56..59 , 64..71 */
    {CPSS_98DX4210_CNS , PORTS_BMP_0_TO_24_56_TO_59_64_TO_71},
...
)
{
    ...
    prvCpssDrvPortsFullMaskGet(cpssSupportedTypes[ii].numOfPorts,&fullPortsBmp);
    ...
    */
    ...
    switch(ppOutInfoPtr->devFamily)
    {
        ...
        case CPSS_PP_FAMILY_DXCH_LION3_E:
            ...
            #ifdef CHX_FAMILY
                /* Interrupts initialization for the Lion3 devices */
                prvCpssDrvPpIntDefDxChLion2Init(devNum); /* same as lion2 */
