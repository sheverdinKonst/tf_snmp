...
REGISTER_COVERED_CNS            GT_U32    bridgeAccessMatrixDefault;
    ...
    struct /*EQ*/{
        ...
        struct /*logicalTargetMapTable*/{
            ...
            GT_U32    logicalTargetDeviceMapConfig;
    ...
    struct /*EGF_eft*/{
        ...
        struct /*egrFilterConfigs*/{
            ...
            GT_U32    virtual2PhysicalPortRemap[256]/*offset*/;
            GT_U32    physicalPortLinkStatusMask[32]/*reg offset*/;
        ...
        struct /*deviceMapConfigs*/{
            ...
            GT_U32    localSrcPortMapOwnDevEn[8]/*Port div 32*/;
            GT_U32    localTrgPortMapOwnDevEn[8]/*Port div 32*/;
...
#define SIP_5_DQ_NUM_PORTS_CNS      72/* 96 ports per DQ (BC2,bobk with single DQ) */
            ...
            struct /*shaper*/
            {
                ...
                GT_U32    portTokenBucketMode[MAX_DQ_NUM_PORTS_CNS*6]/*Port*/;
                GT_U32    portDequeueEnable[MAX_DQ_NUM_PORTS_CNS*6]/*Port*/;
            ...
            struct /*scheduler*/
            {
                ...
                struct /*schedulerConfig*/
                {
                    ...
                    GT_U32    conditionalMaskForPort[MAX_DQ_NUM_PORTS_CNS*6]/*Port*/;
                ...
                struct /*priorityArbiterWeights*/
                {
                    ...
                    GT_U32    portSchedulerProfile[MAX_DQ_NUM_PORTS_CNS*6]/*Port*/;
                ...
                struct /*portShaper*/
                {
                    ...
                    GT_U32    portRequestMaskSelector[MAX_DQ_NUM_PORTS_CNS*6]/*Port*/;
                ...
                struct /*portArbiterConfig*/
                {
                    ...
                    GT_U32    portsArbiterPortWorkConservingEnable[MAX_DQ_NUM_PORTS_CNS*6]/*port*/;
            ...
            struct /*global*/
            {
                ...
                struct /*globalDQConfig*/
                {
                    ...
                    GT_U32    portToDMAMapTable[MAX_DQ_NUM_PORTS_CNS*6]/*Port*/;
                    GT_U32    profileByteCountModification[16]/*Profile*/;
                    GT_U32    portBCConstantValue[MAX_DQ_NUM_PORTS_CNS*6]/*Port*/;
                ...
                struct /*flushTrig*/
                {
                    ...
                    GT_U32    portTxQFlushTrigger[MAX_DQ_NUM_PORTS_CNS*6]/*Port*/;
