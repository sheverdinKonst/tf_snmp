 ...
 *                          (for legacy devices : 4 , for lion3; Bobcat2 is 8 )
 *
...
/*
 * Typedef: struct PRV_CPSS_DXCH_DETAILED_PORT_MAP_STC
 *
 ...
 *                    (APPLICABLE RANGES: Bobcat2 0..71, Lion3 0..31)
...
typedef struct
{
    ...
    GT_U32                          ilknChannel;
    GT_U32                          tmPortIdx;
}PRV_CPSS_DXCH_DETAILED_PORT_MAP_STC;


/*
 * Typedef: struct PRV_CPSS_DXCH_PORT_MAP_SHADOW_STC
 *
...
{
    GT_BOOL                                 valid;
    PRV_CPSS_DXCH_DETAILED_PORT_MAP_STC     portMap;
}PRV_CPSS_DXCH_PORT_MAP_SHADOW_STC;
...
typedef struct{
    ...
    PRV_CPSS_DXCH_PORT_MAP_SHADOW_STC          portsMapInfoShadowArr[PRV_CPSS_MAX_PP_PORTS_NUM_CNS];
