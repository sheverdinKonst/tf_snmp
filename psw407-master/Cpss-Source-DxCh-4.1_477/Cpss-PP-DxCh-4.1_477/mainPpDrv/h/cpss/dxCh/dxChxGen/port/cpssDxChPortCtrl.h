...
*
* NOT APPLICABLE DEVICES:
*       DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; Lion; xCat2,xCat3; Lion2; Lion3.
*
* INPUTS:
*       devNum - physical device number
*       portNum - physical port number
...
*
* DESCRIPTION:
*       Set the number of iterations needed for Rx training process using the enhance tuning,
*       and starts the auto tune process.
*
* APPLICABLE DEVICES:
*       Caelum; Bobcat3.
*
...
*       devNum   - physical device number
*       portNum  - physical port number
*       maxDelay - max iteration  Range: 0..15  
*
* OUTPUTS:
*       serdesTunePtr  - serdes Tune parameters
*
