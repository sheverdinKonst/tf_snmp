 ...
 *   enableEarchSupport     - GT_TRUE  - enable eArch support
 *                            GT_FALSE - disable eArch support
 ...
 *                            used by CPSS API.
 *                            (APPLICABLE DEVICES: Bobcat2, Caelum, Bobcat3)
 *                            Lion3 and Bobcat2 PPs that have 8 address completion regions.
