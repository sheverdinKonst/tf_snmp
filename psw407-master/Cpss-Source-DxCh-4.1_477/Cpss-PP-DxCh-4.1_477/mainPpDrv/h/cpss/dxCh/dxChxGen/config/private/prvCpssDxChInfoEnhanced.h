...
/* macro to get the last valid index in physical port table.
    NOTE: it may be lower then the number returned by
        PRV_CPSS_DXCH_PP_HW_MAX_VALUE_OF_PHY_PORT_MAC(devNum)
*/
#define PRV_CPSS_DXCH_PP_HW_INFO_LAST_INDEX_IN_TABLE_PHY_PORT_MAC(devNum)  \
    PRV_CPSS_DXCH_PP_HW_INFO_RESOURCE_MAX_VALUE_GET_MAC(devNum,phyPort)
