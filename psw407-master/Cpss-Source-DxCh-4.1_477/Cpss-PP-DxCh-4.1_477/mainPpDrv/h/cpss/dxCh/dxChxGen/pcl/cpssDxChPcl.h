 ...
 *                      (relevant only if tunnelStart == GT_FALSE)
 *                      (APPLICABLE DEVICES: Lion, xCat2, Lion2, Bobcat2, Caelum, Bobcat3).
 *       data.routerLttIndex  - For Lion3 and Bobcat2 this is a pointer to a leaf in
 ...
 *    (APPLICABLE DEVICES: Bobcat2; Caelum; Bobcat3)
 *    CPSS_DXCH_PCL_UDB_OVERRIDE_TYPE_FLOW_ID_E     - 16-bits flow Id -
 *                                                  relevant for ingress key that uses UDBs[41,42]
 *    (APPLICABLE DEVICES: Bobcat2; Caelum; Bobcat3)
...
typedef enum
{
    ...
    CPSS_DXCH_PCL_UDB_OVERRIDE_TYPE_FLOW_ID_E,
