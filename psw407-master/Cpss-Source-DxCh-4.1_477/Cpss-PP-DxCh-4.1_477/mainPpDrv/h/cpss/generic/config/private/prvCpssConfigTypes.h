...
#define PRV_TEMPORARY_NOT_SUPPORTING_DEVICE_MAC(_devNum, _unitName , _unSupportedFamBmp)  \
   if (PRV_CPSS_PP_MAC(_devNum)->appDevFamily & (_unSupportedFamBmp))       \
        return GT_NOT_IMPLEMENTED /* ; in caller */
 ...
 *      CPSS_LION3_E        - (DXCH) Bobcat2; Caelum; Bobcat3 family devices
...
#define PRV_CPSS_DXCH_PORT_NUM_CNS 256
 ...
 *
 * Fields:
 *      isInitilized   - is the TM library initialized per device.
