...
int tm_traverse_port_tree_hw(tm_handle hndl, unsigned int port_index, TM_PORT_TRAVERSE_TREE_FUN dump_fun, void * vpEnv,  void* vpUserData)
{
	...
	int portChildLo,portChildHi, portEf;
	int cnodeChildLo,cnodeChildHi, cnodeParent, cnodeEf;
	int bnodeChildLo,bnodeChildHi, bnodeParent, bnodeEf;
	int anodeChildLo,anodeChildHi, anodeParent, anodeEf;
	int queueParent, queueEf;
