...
)
{
    ...
    prvCpssLogParamFuncStc_GT_U64_PTR(contextLib, logType, namePtr, &paramVal);
}
...
)
{
    ...
    prvCpssLogParamFuncStc_CPSS_INTERRUPT_SCAN_STC_PTR(contextLib, logType, namePtr, *paramVal);
}
