...
)
{
    ...
    return appDemoAuMsgHandle(devNum,bufferArr,numOfAu,errorCounterPtr,isFirstMissDonePtr,isFirstReorderDonePtr);
}
...
)
{
    ...
    while(rc != GT_NO_MORE)
    {
        ...
        /*********************************/
        rc1 = appDemoAuMsgHandle(devNum,bufferArr,numOfAu,&error,&dummy1,&dummy2);
        if(rc1 != GT_OK)
        {
            return rc1;
        }
