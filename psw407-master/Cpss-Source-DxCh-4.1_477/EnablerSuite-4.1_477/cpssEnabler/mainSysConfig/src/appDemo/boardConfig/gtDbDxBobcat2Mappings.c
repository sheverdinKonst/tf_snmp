...
static CPSS_DXCH_REVID_2_PORT_MAP_STC prv_revId2PortMapList[] =
{
   ...
   ,{   4, &bc2defaultMap[0],                 sizeof(bc2defaultMap)/sizeof(bc2defaultMap[0])   }
 ...
 *  bobcat3 72 port XG               *
 *-----------------------------------*/
static PortInitList_STC portInitlist_bc3_72x10G_KR[] =
{
     { PORT_LIST_TYPE_INTERVAL,  { 0,71,1,    APP_INV_PORT_CNS }, CPSS_PORT_SPEED_10000_E,  CPSS_PORT_INTERFACE_MODE_SR_LR_E      }
    ,{ PORT_LIST_TYPE_EMPTY,     {              APP_INV_PORT_CNS }, CPSS_PORT_SPEED_NA_E,     CPSS_PORT_INTERFACE_MODE_NA_E         }
};
...
{                                 /* allow physical port to be 0..99 */
    /* use 'QSGMII' on all ports because we use 'BOBK HWS' and the ports that we use are mapped to MACs 0..11 that are all 'QSGMII' in bobk. */
     { PORT_LIST_TYPE_INTERVAL,  { 0 ,99,1,    APP_INV_PORT_CNS }, CPSS_PORT_SPEED_1000_E,  CPSS_PORT_INTERFACE_MODE_QSGMII_E      }
    ,{ PORT_LIST_TYPE_EMPTY,     {              APP_INV_PORT_CNS }, CPSS_PORT_SPEED_NA_E,     CPSS_PORT_INTERFACE_MODE_NA_E         }
};
...
/*dummy*/,{362,1,  CPSS_PP_SUB_FAMILY_NONE_E,     (BIT_6-1),  &portInitlist_bc3_72x10G_KR[0] }
    ,{    0,   0,        CPSS_BAD_SUB_FAMILY,       0x0,  NULL                               }   /* default port init */
};
...
)
{
    ...
    *portInitListPtrPtr  = revId2portInitListPtr->portsInitListPtr;
    ...
    revId2PortInitListPtr[listSize-1].coreClock  = 0; /* retore default value */
