...
#define ROM_TEXT_ADRS   0xffe00000                 /* with PC & SP            */
#define ROM_SIZE        0x001f0004              /* 2MB ROM space         */
#else
#define ROM_BASE_ADRS   0xfff80000              /* base address of ROM     */
#define ROM_TEXT_ADRS   0xfff80000                 /* with PC & SP            */
#define ROM_SIZE        0x00070004              /* 512KB ROM space         */
#endif

#define ROM_RESET        0xFFFF0000
...
#define USER_I_CACHE_ENABLE                /* Enable DATA CACHE               */
...
#if defined(MV_VXWORKS_ST) /*	not for bootrom */
...
#endif  /* MV_VXWORKS_ST) not for bootrom */
...
#endif/* defined(MV_VXWORKS_ST) 	not for bootrom */
