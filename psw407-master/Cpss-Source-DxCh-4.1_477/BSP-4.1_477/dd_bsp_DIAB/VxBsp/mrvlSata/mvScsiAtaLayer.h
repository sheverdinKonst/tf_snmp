...
/* Scsi opcodes*/
/* 6 - bytes commands*/
#ifdef SCSI_OPCODE_TEST_UNIT_READY 
#undef SCSI_OPCODE_TEST_UNIT_READY
#endif
#ifdef SCSI_OPCODE_REASSIGN_BLOCKS
#undef SCSI_OPCODE_REASSIGN_BLOCKS
#endif
#ifdef SCSI_OPCODE_INQUIRY
#undef SCSI_OPCODE_INQUIRY
#endif
