...
LOCAL MV_ISR_ENTRY_TABLE pexCauseArray_TABLE[]=
{
...
LOCAL void pexErrShow(UINT32 pexIf, UINT32 causeBit);
...
void vxPexIntCtrlInit(void)
{
...
#elif defined (MV88F6XXX) || defined (MV88F6XXX)
	pci0IsQuadby1 = FALSE;
#endif
    ...
    for (pexIf = 0; pexIf < mvCtrlPexMaxIfGet(); pexIf++)
    {
        ...
        CHK_STAT_VX_VOID(vxPexIntConnect(pexIf, PEX_M_DIS            , pexErrShow, PEX_M_DIS            , 5));
        CHK_STAT_VX_VOID(vxPexIntConnect(pexIf, PEX_ERR_WR_TO_REG    , pexErrShow, PEX_ERR_WR_TO_REG    , 5));
        CHK_STAT_VX_VOID(vxPexIntConnect(pexIf, PEX_HIT_DFLT_WIN_ERR , pexErrShow, PEX_HIT_DFLT_WIN_ERR , 5));
        CHK_STAT_VX_VOID(vxPexIntConnect(pexIf, PEX_COR_ERR_DET      , pexErrShow, PEX_COR_ERR_DET      , 5));
        CHK_STAT_VX_VOID(vxPexIntConnect(pexIf, PEX_N_F_ERR_DET      , pexErrShow, PEX_N_F_ERR_DET      , 5));
        CHK_STAT_VX_VOID(vxPexIntConnect(pexIf, PEX_F_ERR_DET        , pexErrShow, PEX_F_ERR_DET        , 5));
        CHK_STAT_VX_VOID(vxPexIntConnect(pexIf, PEX_D_STATE_CHANGE   , pexErrShow, PEX_D_STATE_CHANGE   , 5));
        CHK_STAT_VX_VOID(vxPexIntConnect(pexIf, PEX_BIST             , pexErrShow, PEX_BIST             , 5));
        CHK_STAT_VX_VOID(vxPexIntConnect(pexIf, PEX_RCV_ERR_FATAL    , pexErrShow, PEX_RCV_ERR_FATAL    , 5));
        CHK_STAT_VX_VOID(vxPexIntConnect(pexIf, PEX_RCV_ERR_NON_FATAL, pexErrShow, PEX_RCV_ERR_NON_FATAL, 5));
        CHK_STAT_VX_VOID(vxPexIntConnect(pexIf, PEX_RCV_ERR_COR      , pexErrShow, PEX_RCV_ERR_COR      , 5));
        CHK_STAT_VX_VOID(vxPexIntConnect(pexIf, PEX_RCV_CRS          , pexErrShow, PEX_RCV_CRS          , 5));
        CHK_STAT_VX_VOID(vxPexIntConnect(pexIf, PEX_PEX_SLV_HOT_RESET, pexErrShow, PEX_PEX_SLV_HOT_RESET, 5));
        CHK_STAT_VX_VOID(vxPexIntConnect(pexIf, PEX_PEX_SLV_DIS_LINK , pexErrShow, PEX_PEX_SLV_DIS_LINK , 5));
        CHK_STAT_VX_VOID(vxPexIntConnect(pexIf, PEX_PEX_SLV_LB       , pexErrShow, PEX_PEX_SLV_LB       , 5));
        CHK_STAT_VX_VOID(vxPexIntConnect(pexIf, PEX_PEX_LINK_FAIL    , pexErrShow, PEX_PEX_LINK_FAIL    , 5));

        /* Enable those interrupts */
        CHK_STAT_VX_VOID(vxPexIntEnable(pexIf, PEX_M_DIS            ));
        CHK_STAT_VX_VOID(vxPexIntEnable(pexIf, PEX_ERR_WR_TO_REG    ));
        CHK_STAT_VX_VOID(vxPexIntEnable(pexIf, PEX_HIT_DFLT_WIN_ERR ));
        CHK_STAT_VX_VOID(vxPexIntEnable(pexIf, PEX_COR_ERR_DET      ));
        CHK_STAT_VX_VOID(vxPexIntEnable(pexIf, PEX_N_F_ERR_DET      ));
        CHK_STAT_VX_VOID(vxPexIntEnable(pexIf, PEX_F_ERR_DET        ));
        CHK_STAT_VX_VOID(vxPexIntEnable(pexIf, PEX_D_STATE_CHANGE   ));
        CHK_STAT_VX_VOID(vxPexIntEnable(pexIf, PEX_BIST             ));
        CHK_STAT_VX_VOID(vxPexIntEnable(pexIf, PEX_RCV_ERR_FATAL    ));
        CHK_STAT_VX_VOID(vxPexIntEnable(pexIf, PEX_RCV_ERR_NON_FATAL));
        CHK_STAT_VX_VOID(vxPexIntEnable(pexIf, PEX_RCV_ERR_COR      ));
        CHK_STAT_VX_VOID(vxPexIntEnable(pexIf, PEX_RCV_CRS          ));
        CHK_STAT_VX_VOID(vxPexIntEnable(pexIf, PEX_PEX_SLV_HOT_RESET));
        CHK_STAT_VX_VOID(vxPexIntEnable(pexIf, PEX_PEX_SLV_DIS_LINK ));
        CHK_STAT_VX_VOID(vxPexIntEnable(pexIf, PEX_PEX_SLV_LB       ));
        CHK_STAT_VX_VOID(vxPexIntEnable(pexIf, PEX_PEX_LINK_FAIL    ));
    }
                         ...
                         int parameter, int prio)
{
	...
	if (PEX_INT_ABCD_CAUSE(cause))
	{
		...
		pIntConnectCount = &pexCauseArray_TABLE[pexIf].pexCauseCoun;
	}
...
LOCAL void pexErrShow(UINT32 pexIf, UINT32 causeBit)
{
	...
	case(PEX_RCV_Turn_Off):
		...
		logMsg("PEX %d ERR. Ready4TurnOff: RC notifies the Host that the TurnOff\n", pexIf,0,0,0,0,0);break;
	case(PEX_RCV_MSI):
