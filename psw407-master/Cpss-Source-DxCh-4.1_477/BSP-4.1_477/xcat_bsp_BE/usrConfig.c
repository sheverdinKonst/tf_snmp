...
19i,08jun00,csi  Merging usrConfig.c for vxfusion
...
17n,02may94,ms   added VxSim hack to usrClock().
...
# endif	/* INCLUDE_LOGGING && INCLUDE_LOG_STARTUP */
    ...
    /* add default gateway from the o= command line parameter */
    if (sysBootParams.other && (strlen(sysBootParams.other) > 0))
    {
      printf("adding Default gateway %s\n", sysBootParams.other);
      routeAdd("0.0.0.0", sysBootParams.other); 
    }  
...
#endif /* MV_BSP_BOOT_PRINTS_ENABLE */
#endif /*INCLUDE_SHELL*/
