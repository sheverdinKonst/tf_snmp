...
extern MV_BOOL mgiStatsPolling;
...
#define MV_ETH_RX_READY_ISR_MASK                                      \
            ...
            (((1<<MV_ETH_RX_Q_NUM)-1)<<ETH_CAUSE_RX_ERROR_OFFSET)   | \
            (1<<ETH_CAUSE_RX_ERROR_SUM_BIT))
...
volatile MV_U8   mgiTrace[MGI_TRACE_ARRAY_SIZE];
volatile int     mgiTraceIdx = 0;
...
extern MV_VOID mvInitPresteraCpuPort(MV_U8* macAddr);
/*############################################################################*/
