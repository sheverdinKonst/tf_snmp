...
#ifndef ETH_RXBUFNB
 #define ETH_RXBUFNB             5//20     /*  5 Rx buffers of size ETH_RX_BUF_SIZE */
#endif
...
/* PHY1 speed and duplex register */

#define PHY1_HALF_10M   ((uint16_t)0x0001)
#define PHY1_HALF_100M  ((uint16_t)0x0002)
#define PHY1_FULL_10M   ((uint16_t)0x0005)
#define PHY1_FULL_100M  ((uint16_t)0x0006)

#define IS_PHY1_REG(CMD) (((CMD) == PHY1_HALF_10M) || \
                          ((CMD) == PHY1_HALF_100M) || \
                          ((CMD) == PHY1_FULL_10M) || \
                          ((CMD) == PHY1_FULL_100M))
