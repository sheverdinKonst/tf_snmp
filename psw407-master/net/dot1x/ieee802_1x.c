...
#if 1
	conf.ctx = hapd;
	conf.eap_reauth_period = 10;//hapd->conf->eap_reauth_period;
	conf.wpa = 1;//hapd->conf->wpa;
	conf.individual_wep_key_len = 1;//hapd->conf->individual_wep_key_len;
	conf.eap_server = 0;//hapd->conf->eap_server;
	conf.ssl_ctx = hapd->ssl_ctx;
	conf.msg_ctx = hapd->msg_ctx;
	conf.eap_sim_db_priv = hapd->eap_sim_db_priv;
	conf.eap_req_id_text = 0;//hapd->conf->eap_req_id_text;
	conf.eap_req_id_text_len = 0;//hapd->conf->eap_req_id_text_len;
	conf.erp_send_reauth_start = 1;//hapd->conf->erp_send_reauth_start;
	conf.erp_domain = 0;//hapd->conf->erp_domain;
	conf.erp = 0;//hapd->conf->eap_server_erp;
	conf.tls_session_lifetime = 1;//hapd->conf->tls_session_lifetime;
	conf.pac_opaque_encr_key = 0;//hapd->conf->pac_opaque_encr_key;
	conf.eap_fast_a_id = 0;//hapd->conf->eap_fast_a_id;
	conf.eap_fast_a_id_len = 0;//hapd->conf->eap_fast_a_id_len;
	conf.eap_fast_a_id_info = 0;//hapd->conf->eap_fast_a_id_info;
	conf.eap_fast_prov = 0;//hapd->conf->eap_fast_prov;
	conf.pac_key_lifetime = 1;//hapd->conf->pac_key_lifetime;
	conf.pac_key_refresh_time = 1;//hapd->conf->pac_key_refresh_time;
	conf.eap_sim_aka_result_ind = 0;//hapd->conf->eap_sim_aka_result_ind;
	conf.tnc = 0;//hapd->conf->tnc;
	conf.wps = hapd->wps;
	conf.fragment_size = 0;//hapd->conf->fragment_size;
	conf.pwd_group = 0;//hapd->conf->pwd_group;
	conf.pbc_in_m1 = 0;//hapd->conf->pbc_in_m1;

	if (/*hapd->conf->server_id*/0) {
