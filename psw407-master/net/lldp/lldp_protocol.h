...
#define LLDP_CAP_OTHER 		0
#define LLDP_CAP_REPEATER	1
#define LLDP_CAP_BRIDGE		2
#define LLDP_CAP_WLAN_AP	3
#define LLDP_CAP_ROUTER		4
#define LLDP_CAP_TELEPHONE	5
#define LLDP_CAP_DOCSIS		6
#define LLDP_CAP_STATION	7
